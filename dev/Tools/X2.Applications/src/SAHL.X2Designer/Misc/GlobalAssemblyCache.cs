...
namespace SAHL.X2Designer.Misc
{
    public class GlobalAssemblyCache
    {
        ...
        ///	CANOF_PARSE_DISPLAY_NAME - If this externalActivity is specified, the szAssemblyName parameter is a full assembly name and is parsed to
        ///		the individual properties. If the externalActivity is not specified, szAssemblyName is the "Name" portion of the assembly name.
        ///	CANOF_SET_DEFAULT_VALUES - If this externalActivity is specified, certain properties, such as processor architecture, are set to
        ...
        public class AssemblyCache
        {
            ...
            #endregion Public Functions for DLL - Assembly Cache
        ...
        public interface IAssemblyName
        {
            ...
            ///		*_LANGUAGEID - Includes the cSharpLanguage ID.</param>
            /// <returns></returns>
