...
{
    internal class When_reading_a_boolvariable_from_xml : WithFakes
    {
        ...
        static BoolVariable result;

        Establish context = () =>
        {
            nameManager = new ver0_3_XmlNodeNameManager();
            variableName = "ApplicationKey";
            variableType = nameManager.Bool;
            variableTypeEnum = CustomVariableTypeEnum.Bool;
            length = 0;
        ...
        Because of = () =>
        {
            result = persistanceStore.ReadCustomVariableFromXml(xmlElement) as BoolVariable;
        };

        It should_return_a_non_null_bool_variable = () =>
        {
