...
{
    internal class When_reading_a_integervariable_from_xml : WithFakes
    {
        ...
        static IntegerVariable result;

        Establish context = () =>
        {
            nameManager = new ver0_3_XmlNodeNameManager();
            variableName = "ApplicationKey";
            variableType = nameManager.Integer;
            variableTypeEnum = CustomVariableTypeEnum.Integer;
            length = 0;
        ...
        Because of = () =>
        {
            result = persistanceStore.ReadCustomVariableFromXml(xmlElement) as IntegerVariable;
        };

        It should_return_a_non_null_integer_variable = () =>
        {
