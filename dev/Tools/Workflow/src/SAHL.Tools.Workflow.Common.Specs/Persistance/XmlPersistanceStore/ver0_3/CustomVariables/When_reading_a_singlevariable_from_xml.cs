...
{
    internal class When_reading_a_singlevariable_from_xml : WithFakes
    {
        ...
        Establish context = () =>
        {
            ...
            variableType = nameManager.Single;
            variableTypeEnum = CustomVariableTypeEnum.Single;
            length = 0;
        ...
        Because of = () =>
        {
            result = persistanceStore.ReadCustomVariableFromXml(xmlElement) as SingleVariable;
        };

        It should_return_a_non_null_single_variable = () =>
        {
