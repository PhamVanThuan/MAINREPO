...
{
    internal class When_reading_a_textvariable_from_xml : WithFakes
    {
        ...
        Establish context = () =>
        {
            ...
            variableType = nameManager.Text;
            variableTypeEnum = CustomVariableTypeEnum.Text;
            length = 10;
        ...
        Because of = () =>
        {
            result = persistanceStore.ReadCustomVariableFromXml(xmlElement) as TextVariable;
        };

        It should_return_a_non_null_text_variable = () =>
        {
