...
{
    internal class When_reading_a_decimalvariable_from_xml : WithFakes
    {
        ...
        static DecimalVariable result;

        Establish context = () =>
        {
            nameManager = new ver0_3_XmlNodeNameManager();
            variableName = "ApplicationKey";
            variableType = nameManager.Decimal;
            variableTypeEnum = CustomVariableTypeEnum.Decimal;
            length = 0;
        ...
        Because of = () =>
        {
            result = persistanceStore.ReadCustomVariableFromXml(xmlElement) as DecimalVariable;
        };

        It should_return_a_non_null_decimal_variable = () =>
        {
