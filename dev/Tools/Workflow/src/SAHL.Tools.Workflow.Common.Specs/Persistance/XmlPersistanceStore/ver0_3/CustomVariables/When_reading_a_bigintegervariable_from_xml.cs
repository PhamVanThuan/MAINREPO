...
{
    internal class When_reading_a_bigintegervariable_from_xml : WithFakes
    {
        ...
        static BigIntegerVariable result;

        Establish context = () =>
        {
            nameManager = new ver0_3_XmlNodeNameManager();
            variableName = "ApplicationKey";
            variableType = nameManager.BigInteger;
            variableTypeEnum = CustomVariableTypeEnum.BigInteger;
            length = 0;
        ...
        Because of = () =>
        {
            result = persistanceStore.ReadCustomVariableFromXml(xmlElement) as BigIntegerVariable;
        };

        It should_return_a_non_null_biginteger_variable = () =>
        {
