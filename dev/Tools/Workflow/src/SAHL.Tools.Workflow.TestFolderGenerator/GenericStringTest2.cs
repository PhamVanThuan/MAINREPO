...
{
    public partial class GenericStringTest
    {
        ...
        public GenericStringTest(string safeName, string sectionName, string sectionNamePrefix, string workflowName, string parentFolderName, string parentFolderType)
        {
