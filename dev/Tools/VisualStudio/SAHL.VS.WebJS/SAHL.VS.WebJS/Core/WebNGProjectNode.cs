...
{
    [System.Runtime.InteropServices.Guid(GuidList.WebNGProjectNode)]
    public class WebNGProjectNode : ProjectNode
    {
        #region constants

        internal const string ProjectTypeName = "WebNG";
        ...
        {
            get { return typeof(WebNGProjectFactory).GUID; }
        }
        ...
        static WebNGProjectNode()
        {
            imageList = Microsoft.VisualStudio.Project.Utilities.GetImageList(typeof(WebNGProjectNode).Assembly.GetManifestResourceStream("SAHomeloans.SAHL_VS_WebJS.Resources.webng.bmp"));
        }

        public WebNGProjectNode(WebNGPackage package)
        {
        ...
        {
            WebNGProjectFileNode node = new WebNGProjectFileNode(this, item);
        ...
        {
            return new OAWebNGProject(this);
        }
        ...
        public override void AddFileFromTemplate(string source, string target)
        {
            ...
            string namespce = this.FileTemplateProcessor.GetFileNamespace(target, this).Split(new char[]{'.'}).Select(x=>StringHelpers.ToCamelCase(x)).Aggregate((x,y)=>x+"."+y);
