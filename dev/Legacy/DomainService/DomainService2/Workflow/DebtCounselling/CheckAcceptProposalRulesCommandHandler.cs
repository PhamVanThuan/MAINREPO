...
{
    public class CheckAcceptProposalRulesCommandHandler : RuleSetDomainServiceCommandHandler<CheckAcceptProposalRulesCommand>
    {
        private IDebtCounsellingRepository debtCounsellingRepository;

        public CheckAcceptProposalRulesCommandHandler(ICommandHandler commandHandler, IDebtCounsellingRepository debtCounsellingRepository)
            : base(commandHandler)
        {
