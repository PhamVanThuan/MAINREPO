namespace DomainService2.Specs.Workflow.DebtCounselling.CancelDebtCounsellingCommandHandlerSpecs
{
    ...
    public class When_cancel_debt_counselling_ework_action_fail : DomainServiceSpec<CancelDebtCounsellingCommand, CancelDebtCounsellingCommandHandler>
    {
        ...
        Establish context = () =>
        {
            ...
            commonWorkflowService.WhenToldTo(x => x.PerformEWorkAction(Param<IDomainMessageCollection>.IsAnything, Param<string>.IsAnything, Param<string>.IsAnything, Param<int>.IsAnything, Param<string>.IsAnything, Param<string>.IsAnything)).Return(false);
