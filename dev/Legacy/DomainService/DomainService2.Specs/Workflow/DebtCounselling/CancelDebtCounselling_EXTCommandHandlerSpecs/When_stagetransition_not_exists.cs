...
namespace DomainService2.Specs.Workflow.DebtCounselling.CancelDebtCounselling_EXTCommandHandlerSpecs
{
    ...
    public class When_stagetransition_not_exists : DomainServiceSpec<CancelDebtCounselling_EXTCommand, CancelDebtCounselling_EXTCommandHandler>
    {
        ...
        Establish context = () =>
        {
            ...
            le.WhenToldTo(x => x.EmailAddress).Return(Param.IsAny<string>());
            ...
            organisationStructureRepository.WhenToldTo(x => x.GetADUserByKey(Param.IsAny<int>())).Return(adUser);
