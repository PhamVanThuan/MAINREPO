...
namespace DomainService2.Specs.Workflow.DebtCounselling.CancelDebtCounselling_EXTCommandHandlerSpecs
{
    ...
    public class When_notification_not_succeed : DomainServiceSpec<CancelDebtCounselling_EXTCommand, CancelDebtCounselling_EXTCommandHandler>
    {
        ...
        Establish context = () =>
        {
            ...
            messageService.WhenToldTo(x => x.SendEmailExternal(Param.IsAny<int>(), Param.IsAny<string>(), Param.IsAny<string>(),
                                                               ...
                                                               Param.IsAny<string>(), Param.IsAny<string>())).Return(false);
        ...
        It should_not_send_notification = () =>
        {
