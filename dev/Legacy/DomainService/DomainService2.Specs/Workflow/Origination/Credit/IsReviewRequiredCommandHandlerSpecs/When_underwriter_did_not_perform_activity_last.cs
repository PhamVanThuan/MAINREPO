...
namespace DomainService2.Specs.Workflow.Origination.Credit.IsReviewRequiredCommandHandlerSpecs
{
    ...
    public class When_underwriter_did_not_perform_activity_last : WithFakes
    {
        ...
        protected static String userNamerole = "TestUserRole";
        ...
        Establish context = () =>
        {
            ...
            aduser.WhenToldTo(x => x.ADUserName).Return(userNamerole);
        };
