...
namespace DomainService2.Specs.Workflow.Origination.Credit.CreditResubCommandHandlerSpecs
{
    ...
    public class When_credit_exceptions_role_exists : WithFakes
    {
        ...
        Establish context = () =>
        {
            ...
            role.WhenToldTo(x => x.ApplicationRoleType).Return(exceptionsRoleType);
        ...
        {
            applicationRepo.WasToldTo(x => x.CreateAndSaveApplicationRole_WithoutRules(1, exceptionsRoleType.Key, 1));
        };
    }
}