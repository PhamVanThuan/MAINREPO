...
namespace DomainService2.Specs.Workflow.Origination.Credit.CreditResubCommandHandlerSpecs
{
    ...
    public class When_highest_role_type_is_supervisor : WithFakes
    {
        ...
        Establish context = () =>
        {
            ...
            supervisorRole.WhenToldTo(x => x.LegalEntityKey).Return(2);
        ...
        It should_create_a_supervisor_role = () =>
        {
            applicationRepo.WasToldTo(x => x.CreateAndSaveApplicationRole_WithoutRules(1, supervisorRoleType.Key, 2));
        };
    }
}