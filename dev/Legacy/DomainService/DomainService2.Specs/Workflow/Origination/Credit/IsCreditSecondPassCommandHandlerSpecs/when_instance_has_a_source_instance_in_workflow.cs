...
namespace DomainService2.Specs.Workflow.Origination.Credit.IsCreditSecondPassCommandHandlerSpecs
{
    ...
    public class when_instance_has_a_source_instance_in_workflow : WithFakes
    {
        ...
        Establish context = () =>
        {
            ...
            x2Repo.WhenToldTo(x => x.HasRelatedSourceInstancesInWorkflow(Param<long>.IsAnything, Param<string>.IsAnything)).Return(false);
