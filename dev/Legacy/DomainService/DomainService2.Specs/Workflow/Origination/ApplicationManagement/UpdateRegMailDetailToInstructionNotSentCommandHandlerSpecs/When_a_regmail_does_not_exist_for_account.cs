...
namespace DomainService2.Specs.Workflow.Origination.ApplicationManagement.UpdateRegMailDetailToInstructionNotSentCommandHandlerSpecs
{
    ...
    public class When_a_regmail_does_not_exist_for_account : WithFakes
    {
        ...
        It should_not_update_and_save_the_regmail_record = () =>
        {
            registrationRepository.WasNotToldTo(x => x.SaveRegmail(Param<IRegMail>.IsAnything));
        };
    }
}