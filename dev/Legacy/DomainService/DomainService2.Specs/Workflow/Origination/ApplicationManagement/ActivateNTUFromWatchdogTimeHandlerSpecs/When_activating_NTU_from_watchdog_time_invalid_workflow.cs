...
namespace DomainService2.Specs.Workflow.Origination.ApplicationManagement
{
    ...
    public class When_activating_NTU_from_watchdog_time_invalid_workflow : WithFakes
    {
        ...
        Establish context = () =>
        {
            ...
            x2Repository.WhenToldTo(x => x.CreateAndSaveActiveExternalActivity(Param<string>.IsAnything, Param<long>.IsAnything, Param<string>.IsAnything, Param<string>.IsAnything, Param<string>.IsAnything)).Throw(new Exception());
