...
namespace DomainService2.Specs.Workflow.Origination.ApplicationManagement.SendAlphaHousingSurveyEmailCommandHandlerSpecs
{
    ...
    public class when_application_is_alpha_housing_with_mailing_address : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            medium.WhenToldTo(x => x.Key).Return((int)SAHL.Common.Globals.CorrespondenceMediums.Email);
