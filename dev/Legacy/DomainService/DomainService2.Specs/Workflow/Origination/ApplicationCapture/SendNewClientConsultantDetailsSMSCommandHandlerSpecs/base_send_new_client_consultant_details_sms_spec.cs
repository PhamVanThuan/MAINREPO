...
{
	public class base_send_new_client_consultant_details_sms_spec : DomainServiceSpec<SendNewClientConsultantDetailsSMSCommand, SendNewClientConsultantDetailsSMSCommandHandler>
	{
		...
		public base_send_new_client_consultant_details_sms_spec()
		{
