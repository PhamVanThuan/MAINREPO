...
namespace DomainService2.Specs.Workflow.Origination.ApplicationCapture.CreateNetApplicationCommandHandlerSpecs
{
    ...
    internal class when_the_internet_application_is_invalid : DomainServiceSpec<CreateInternetApplicationCommand,CreateInternetApplicationCommandHandler>
    {
        ...
        Establish context = () =>
        {
            ...
            applicationRepo.WhenToldTo(x => x.GenerateApplicationFromWeb(i, leadInput)).Return(false);
