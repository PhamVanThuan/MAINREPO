...
namespace DomainService2.Specs.Workflow.Origination.ApplicationCapture.CheckManagerSubmitApplicationRulesCommandHandlerSpecs
{
    ...
    public class When_there_is_an_application : RuleSetDomainServiceSpec<CheckManagerSubmitApplicationRulesCommand, CheckManagerSubmitApplicationRulesCommandHandler>
    {
        ...
        It should_set_the_rule_set_to_application_capture_manager_submit_application = () =>
        {
            command.WorkflowRuleSetName.ShouldBeEqualIgnoringCase(SAHL.Common.RuleSets.ApplicationCaptureManagerSubmitApplication);
        };
    }
}