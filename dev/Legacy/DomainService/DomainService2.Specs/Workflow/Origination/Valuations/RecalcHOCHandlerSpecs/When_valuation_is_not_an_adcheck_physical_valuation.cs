...
namespace DomainService2.Specs.Workflow.Origination.Valuations.RecalcHOC
{
    ...
    public class When_valuation_is_not_an_adcheck_physical_valuation : RecalcHOCCommandHandlerBase
    {
        ...
        Establish context = () =>
        {
            ...
            valuation.WhenToldTo(v => v.ValuationDataProviderDataService.DataProviderDataService.Key)
                     .Return((int)SAHL.Common.Globals.DataProviderDataServices.LightstoneAutomatedValuation);
        ...
        It should_not_update_adcheck_hoc_valuation = () =>
        {
            propertyRepository.WasNotToldTo(x => x.AdcheckValuationUpdateHOC(Param.IsAny<int>(), Param.IsAny<int>()));
        };

        It should_update_hoc_valuation = () =>
        {
			propertyRepository.WasToldTo(x => x.ValuationUpdateHOC(Param.IsAny<int>(), Param.Is<SAHL.Common.Globals.GenericKeyTypes>(SAHL.Common.Globals.GenericKeyTypes.Offer), Param.IsAny<int>()));
        };
    }
}