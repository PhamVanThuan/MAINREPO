...
namespace DomainService2.Specs.Workflow.Origination.FurtherLending.AddAccountMemoMessageOnReceiptOfApplicationCommandHandlerSpecs
{
    ...
    public class When_invalid_cellno : WithFakes
    {
        ...
        Establish context = () =>
            {
                ...
                ICastleTransactionsService service = An<ICastleTransactionsService>();
                ...
                legalEntity.WhenToldTo(x => x.CellPhoneNumber).Return(String.Empty);
        ...
        It should_save_memo = () =>
            {
                memoRepository.WasToldTo(x => x.SaveMemo(Param.IsAny<IMemo>()));
            };
    }
}