namespace DomainService2.Specs.Workflow.Origination.FurtherLending.CheckSuretyForReAdvanceRulesCommandHandlerSpecs
{
    ...
    public class When_an_application_does_not_exist : RuleSetDomainServiceSpec<CheckSuretyForReAdvanceRulesCommand, CheckSuretyForReAdvanceRulesCommandHandler>
    {
        // Arrange
        Establish context = () =>
        {
