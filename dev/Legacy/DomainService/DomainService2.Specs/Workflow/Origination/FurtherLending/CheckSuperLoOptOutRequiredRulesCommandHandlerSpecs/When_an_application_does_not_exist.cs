namespace DomainService2.Specs.Workflow.Origination.FurtherLending.CheckSuperLoOptOutRequiredRulesCommandHandlerSpecs
{
    ...
    public class When_an_application_does_not_exist : RuleSetDomainServiceSpec<CheckSuperLoOptOutRequiredRulesCommand, CheckSuperLoOptOutRequiredRulesCommandHandler>
    {
        // Arrange
        Establish context = () =>
        {
