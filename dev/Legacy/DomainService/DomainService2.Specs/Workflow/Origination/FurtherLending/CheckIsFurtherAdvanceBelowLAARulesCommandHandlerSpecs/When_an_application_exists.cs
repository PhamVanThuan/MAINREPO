namespace DomainService2.Specs.Workflow.Origination.FurtherLending.CheckIsFurtherAdvanceBelowLAARulesCommandHandlerSpecs
{
    ...
    public class When_an_application_exists : RuleSetDomainServiceSpec<CheckIsFurtherAdvanceBelowLAARulesCommand, CheckIsFurtherAdvanceBelowLAARulesCommandHandler>
    {
        // Arrange
        Establish context = () =>
        {
