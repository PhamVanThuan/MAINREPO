namespace DomainService2.Specs.Workflow.Origination.FurtherLending.CheckRapidShouldGotoCreditRulesCommandHandlerSpecs
{
    ...
    [Subject(typeof(CheckRapidShouldGotoCreditRulesCommandHandler))]
    public class When_an_application_does_not_exist : RuleSetDomainServiceSpec<CheckRapidShouldGotoCreditRulesCommand, CheckRapidShouldGotoCreditRulesCommandHandler>
    {
        // Arrange
        Establish context = () =>
        {
