...
namespace DomainService2.Specs.Workflow.Origination.FurtherLending.AddDetailTypesCommandHandlerSpecs
{
    ...
    public class When_furtherloan : AddDetailTypesCommandHandlerBase
    {
        Establish Context = () =>
            {
                ...
                appType.WhenToldTo(x => x.Key).Return((int)OfferTypes.FurtherLoan);
                ...
                detailtypes.ObjectDictionary.Add(Convert.ToString((int)DetailTypes.FurtherLoanInProgress), null);
