...
namespace DomainService2.Specs.Workflow.Origination.FurtherLending.RemoveDetailTypesCommandHandlerSpecs
{
    ...
    public class When_there_are_valid_detailtypes_to_remove_from_a_readvance : RemoveDetailTypesCommandHandlerBase
    {
        ...
        Establish context = () =>
        {
            ...
            appType.WhenToldTo(x => x.Key).
                Return((int)SAHL.Common.Globals.OfferTypes.ReAdvance);
