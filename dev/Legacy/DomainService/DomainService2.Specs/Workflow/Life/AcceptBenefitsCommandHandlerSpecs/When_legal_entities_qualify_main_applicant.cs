namespace DomainService2.Specs.Workflow.Life.AcceptBenefitsCommandHandlerSpecs
{
    ...
    public class When_legal_entities_qualify_main_applicant : DomainServiceSpec<AcceptBenefitsCommand, AcceptBenefitsCommandHandler>
    {
        ...
        Establish context = () =>
        {
            ...
            role.WhenToldTo(x => x.RoleType.Key).Return((int)RoleTypes.MainApplicant);
            ...
            lifeInsurableInterestTypes.ObjectDictionary.Add(Convert.ToString((int)LifeInsurableInterestTypes.Mortgagor), null);
