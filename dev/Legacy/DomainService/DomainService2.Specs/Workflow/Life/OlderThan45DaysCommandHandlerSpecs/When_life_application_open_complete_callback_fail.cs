namespace DomainService2.Specs.Workflow.Life.OlderThan45DaysCommandHandlerSpecs
{
    ...
    public class When_life_application_open_complete_callback_fail : DomainServiceSpec<OlderThan45DaysCommand, OlderThan45DaysCommandHandler>
    {
        ...
        Establish context = () =>
        {
            ...
            osp.WhenToldTo(x => x.Key).Return(Param<int>.IsAnything);
            ...
            applicationRepository.WhenToldTo(x => x.CompleteCallback(Param<int>.IsAnything, Param<DateTime>.IsAnything)).Return(false);
        ...
        It should_not_send_internal_email = () =>
        {
            lifeRepository.WasNotToldTo(x => x.LifeApplicationArchivedWithCallBacks_SendInternalEmail(Param<int>.IsAnything, Param<int>.IsAnything, Param<int>.IsAnything, Param<string>.IsAnything));
        };
