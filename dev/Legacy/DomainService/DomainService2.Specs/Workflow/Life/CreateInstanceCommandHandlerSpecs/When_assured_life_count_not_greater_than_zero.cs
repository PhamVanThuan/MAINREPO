namespace DomainService2.Specs.Workflow.Life.CreateInstanceCommandHandlerSpecs
{
    ...
    public class When_assured_life_count_not_greater_than_zero : DomainServiceSpec<CreateInstanceCommand, CreateInstanceCommandHandler>
    {
        ...
        Establish context = () =>
        {
            ...
            IReadOnlyEventList<ILegalEntityNaturalPerson> assuredLives = new StubReadOnlyEventList<ILegalEntityNaturalPerson>();
        ...
        {
            mortgageLoanAccount.SecuredMortgageLoan.Account.WasToldTo(x => x.GetLegalName(Param<LegalNameFormat>.IsAnything));
        };
    }
}