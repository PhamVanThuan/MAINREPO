...
namespace DomainService2.Specs.Workflow.PersonalLoan.UpdateOfferInformationTypeSpecs
{
    ...
    public class When_there_is_no_application : DomainServiceSpec<UpdateOfferInformationTypeCommand, UpdateOfferInformationTypeCommandHandler>
    {
        ...
        Establish context = () =>
        {
            ...
            applicationRepository.WhenToldTo(x => x.GetApplicationByKey(Param.IsAny<int>())).Return((IApplication)null);
