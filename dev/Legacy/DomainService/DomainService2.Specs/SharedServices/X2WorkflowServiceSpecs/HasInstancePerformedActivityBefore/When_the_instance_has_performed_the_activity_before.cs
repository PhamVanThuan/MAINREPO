...
namespace DomainService2.Specs.SharedServices.X2WorkflowServiceSpecs.HasInstancePerformedActivity
{
    ...
    public class When_the_instance_has_performed_the_activity_before : X2WorkflowServiceBase
    {
        static bool result;
        ...
        Establish context = () =>
        {
            ...
            IWorkFlowHistory workflowHistory = An<IWorkFlowHistory>();

            IEventList<IWorkFlowHistory> workflowHistoryList = new StubEventList<IWorkFlowHistory>();
            workflowHistoryList.Add(messages, workflowHistory);
