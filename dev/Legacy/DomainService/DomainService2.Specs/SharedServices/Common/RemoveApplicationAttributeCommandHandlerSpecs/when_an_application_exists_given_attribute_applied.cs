...
namespace DomainService2.Specs.SharedServices.Common.RemoveApplicationAttributeCommandHandlerSpecs
{
    ...
    public class when_an_application_exists_given_attribute_applied : DomainServiceSpec<RemoveApplicationAttributeCommand, RemoveApplicationAttributeCommandHandler>
    {
        ...
        Establish context = () =>
        {
            ...
            command = new RemoveApplicationAttributeCommand(appKey, attributeKey);
