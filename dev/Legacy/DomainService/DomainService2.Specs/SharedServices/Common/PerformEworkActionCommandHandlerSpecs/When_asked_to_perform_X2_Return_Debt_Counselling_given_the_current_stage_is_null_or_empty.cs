...
{
    public class When_asked_to_perform_X2_Return_Debt_Counselling_given_the_current_stage_is_null_or_empty : PerformEWorkActionCommandHandlerSpecBase
    {
        private Establish context = () =>
        {
            ...
            command = new PerformEWorkActionCommand(FOLDERID, Constants.EworkActionNames.X2ReturnDebtCounselling, GENERICKEY, ASSIGNEDUSER, String.Empty);
