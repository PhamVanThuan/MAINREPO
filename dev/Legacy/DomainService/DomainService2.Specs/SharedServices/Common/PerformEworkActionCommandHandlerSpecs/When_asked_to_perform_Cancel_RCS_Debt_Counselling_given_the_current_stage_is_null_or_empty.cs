...
{
    public class When_asked_to_perform_Cancel_RCS_Debt_Counselling_given_the_current_stage_is_null_or_empty : PerformEWorkActionCommandHandlerSpecBase
    {
        private Establish context = () =>
        {
            ...
            command = new PerformEWorkActionCommand(FOLDERID, Constants.EworkActionNames.CancelRCSDebtCounselling, GENERICKEY, ASSIGNEDUSER, String.Empty);
