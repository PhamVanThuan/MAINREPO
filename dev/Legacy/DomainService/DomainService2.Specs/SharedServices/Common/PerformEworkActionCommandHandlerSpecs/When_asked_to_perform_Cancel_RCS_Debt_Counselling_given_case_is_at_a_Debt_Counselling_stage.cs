...
{
    public class When_asked_to_perform_Cancel_RCS_Debt_Counselling_given_case_is_at_a_Debt_Counselling_stage : PerformEWorkActionCommandHandlerSpecBase
    {
        ...
        private Establish context = () =>
        {
            ...
            command = new PerformEWorkActionCommand(FOLDERID, Constants.EworkActionNames.CancelRCSDebtCounselling, GENERICKEY, ASSIGNEDUSER, currentStage);
        ...
        It should_ask_the_eWork_client_to_invoke_the_Cancel_RCS_Debt_Counselling_action_with_extra_parameter_UserToDo = () =>
        {
            eWorkEngine.WasToldTo(x => x.InvokeAndSubmitAction(Param.IsAny<string>(),
                                                               Param<string>.Matches(c => c == command.EFolderID),
                                                               Param.Is<string>(Constants.EworkActionNames.CancelRCSDebtCounselling),
