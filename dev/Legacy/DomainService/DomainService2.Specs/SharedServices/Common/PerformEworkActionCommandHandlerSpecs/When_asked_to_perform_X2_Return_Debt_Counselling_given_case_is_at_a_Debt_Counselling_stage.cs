...
{
    public class When_asked_to_perform_X2_Return_Debt_Counselling_given_case_is_at_a_Debt_Counselling_stage : PerformEWorkActionCommandHandlerSpecBase
    {
        ...
        It should_ask_the_eWork_client_to_invoke_the_X2_Debt_Counselling_action_with_extra_parameter_UserToDo = () =>
        {
            eWorkEngine.WasToldTo(x => x.InvokeAndSubmitAction(Param.IsAny<string>(),
                                                               ...
                                                               Param.Is<string>(Constants.EworkActionNames.X2ReturnDebtCounselling),
