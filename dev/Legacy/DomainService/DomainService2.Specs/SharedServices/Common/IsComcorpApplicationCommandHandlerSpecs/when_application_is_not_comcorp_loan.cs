...
namespace DomainService2.Specs.SharedServices.Common.IsComcorpApplicationCommandHandlerSpecs
{
    ...
    public class when_application_is_not_comcorp_loan : DomainServiceSpec<IsComcorpApplicationCommand, IsComcorpApplicationCommandHandler>
    {
        ...
        private It result_should_be_false = () =>
        {
            isComcorpLoan.ShouldBeFalse();
        };
    }
}