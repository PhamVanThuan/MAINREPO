...
namespace DomainService2.Specs.SharedServices.Common.ArchiveV3ITCForApplicationCommandHandlerSpecs
{
    ...
    public class When_appkey_not_zero : DomainServiceSpec<ArchiveV3ITCForApplicationCommand, ArchiveV3ITCForApplicationCommandHandler>
    {
        ...
        Establish context = () =>
            {
                ...
                command = new ArchiveV3ITCForApplicationCommand(1);
        ...
        It should_execute_statement = () =>
            {
                service.WasToldTo(x => x.ExecuteNonQueryOnCastleTran("", SAHL.Common.Globals.Databases.TwoAM, null));
            };
    }
}