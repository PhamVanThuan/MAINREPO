...
namespace DomainService2.Specs.SharedServices.Common.SendSMSToMainApplicantsCommandHandlerSpecs
{
    ...
    public class When_cellumber_null : DomainServiceSpec<SendSMSToMainApplicantsCommand, SendSMSToMainApplicantsCommandHandler>
    {
        ...
        Establish context = () =>
        {
            ...
            legalEntity.WhenToldTo(x => x.CellPhoneNumber).Return("");
