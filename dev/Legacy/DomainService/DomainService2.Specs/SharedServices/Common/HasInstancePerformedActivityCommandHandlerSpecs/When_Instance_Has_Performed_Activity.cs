...
namespace DomainService2.Specs.SharedServices.Common.HasInstancePerformedActivityCommandHandlerSpecs
{
    ...
    public class When_Instance_Has_Performed_Activity : WithFakes
    {
        ...
        Establish context = () =>
            {
                ...
                x2WorkflowService.WhenToldTo(x => x.HasInstancePerformedActivity(Param<Int64>.IsAnything, Param<String>.IsAnything)).Return(true);
