...
namespace DomainService2.Specs.SharedServices.Common.CheckUserInMandateCommandHandlerSpecs
{
    ...
    internal class When_CheckUserInMandateCommandHandled_Returns_True : DomainServiceSpec<CheckUserInMandateCommand, CheckUserInMandateCommandHandler>
    {
        ...
        Establish context = () =>
        {
            ...
            workflowAssignmentRepository.WhenToldTo(x => x.CheckUserInMandate(Param<int>.IsAnything, Param<string>.IsAnything, Param<string>.IsAnything)).Return(true);
