...
namespace SAHL.Test
{
    ...
    public abstract class TestBase
    {
        ...
        protected object TestFind<T>(object key)
        {
            ...
            Assert.IsInstanceOf<T>(entity, "Object retrieved does not match type " + type.FullName);
        ...
        public object ExecuteScalar(IDbConnection connection, string commandText)
        {
            return SAHL.Common.DataAccess.Helper.ExecuteScalar(connection, commandText);
        }

        public object ExecuteScalar(IDbConnection connection, string commandText, ParameterCollection parameters)
        {
            return SAHL.Common.DataAccess.Helper.ExecuteScalar(connection, commandText, parameters);
        }

        public int ExecuteNonQuery(IDbConnection connection, string commandText)
        {
            return SAHL.Common.DataAccess.Helper.ExecuteNonQuery(connection, commandText);
        }

        public int ExecuteNonQuery(IDbConnection connection, string commandText, ParameterCollection parameters)
        {
            return SAHL.Common.DataAccess.Helper.ExecuteNonQuery(connection, commandText, parameters);
        }

        public int ExecuteNonQuery(IDbConnection connection, string applicationName, string statementName, ParameterCollection parameters)
        {
            return SAHL.Common.DataAccess.Helper.ExecuteNonQuery(connection, applicationName, statementName, parameters);
        }
        ...
        {
            IEnumerator<T> enumerator = _mockery.StrictMock<IEnumerator<T>>();
        ...
        public ILookupRepository LookupRepository
        {
            get
            {
                if (_lookupRepository == null)
                {
                    ...
                    {
                        _lookupRepository = _mockery.StrictMock<ILookupRepository>();
