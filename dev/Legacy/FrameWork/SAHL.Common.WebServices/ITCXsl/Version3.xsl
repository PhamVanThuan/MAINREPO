                  ...
                  <table width="100%">
                    <tr>
                      <td class="Label9" align="center">
												Fraud Rating for <xsl:value-of select="$IDNumber" /><xsl:value-of select="' '" /><xsl:value-of select="$ITCName" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td class="Value8">
												Level <xsl:value-of select="BureauResponse/TUBureau:FraudScoreFS01/TUBureau:Rating" />: <xsl:value-of select="BureauResponse/TUBureau:FraudScoreFS01/TUBureau:RatingDescription" /></td>
                    </tr>
                    <tr>
              ...
              <tr>
                <td>
                  <table width="100%">
                    <tr>
                      <td class="Label9" align="center">
												Hawk ID Verification for <xsl:value-of select="$IDNumber" /><xsl:value-of select="' '" /><xsl:value-of select="$ITCName" /></td>
                    </tr>
                    <tr>
                      <td class="Value8">
												...
												Full Name is <xsl:value-of select="$ITCName" /></td>
                    </tr>
                  </table>
                </td>
              </tr>
                  ...
                  <table width="100%">
                    <tr>
                      <td class="Label9" align="center" colspan="4">
												Empirica Score for <xsl:value-of select="$IDNumber" /><xsl:value-of select="' '" /><xsl:value-of select="$ITCName" /></td>
                    </tr>
                    <tr>
                  ...
                  <table width="100%">
                    <tr>
                      <td class="Label9" align="center" colspan="5">
												Summary of Information for <xsl:value-of select="$IDNumber" /><xsl:value-of select="' '" /><xsl:value-of select="$ITCName" /></td>
                    </tr>
                    <tr>
                  ...
                  <table width="100%">
                    <tr>
                      <td class="Label9" align="center" colspan="8">
												Payment Profile for <xsl:value-of select="$IDNumber" /><xsl:value-of select="' '" /><xsl:value-of select="$ITCName" /></td>
                    </tr>
                    <tr>
                  ...
                  <td>
                    <table width="100%">
                      <xsl:for-each select="BureauResponse/TUBureau:DefaultsND07/TUBureau:DefaultsND07">
                        <tr>
                          <td class="Label9" align="center" colspan="7">
														Default data for <xsl:value-of select="$IDNumber" /><xsl:value-of select="' '" /><xsl:value-of select="$ITCName" /></td>
                        </tr>
                        <tr>
                          <td class="Value8">
                        ...
                        <tr>
                          ...
                          <td class="Value8" colspan="2">
                            <xsl:value-of select="TUBureau:TelephoneCode" />-<xsl:value-of select="TUBureau:TelephoneNo" /></td>
                        </tr>
                        <tr>
                      ...
                      <xsl:for-each select="BureauResponse/TUBureau:NoticesNN08/TUBureau:NoticesNN08">
                        <tr>
                          <td class="Label9" align="center" colspan="6">
														Consumer Notices for <xsl:value-of select="$IDNumber" /><xsl:value-of select="' '" /><xsl:value-of select="$ITCName" /></td>
                        </tr>
                        <tr>
                          <td class="Value8" colspan="6">
                ...
                <tr>
                  <td>
                    <table width="100%">
                      <tr>
                        <td class="Label9" align="center" colspan="6">
													Trace Alerts for <xsl:value-of select="$IDNumber" /><xsl:value-of select="' '" /><xsl:value-of select="$ITCName" /></td>
                      </tr>
                      <tr>
              ...
              <tr>
                <td>
                  <table width="100%">
                    <tr>
                      <td class="Label9" align="center" colspan="5">
												ITC Customer Information for <xsl:value-of select="$IDNumber" /><xsl:value-of select="' '" /><xsl:value-of select="$ITCName" /></td>
                    </tr>
                    <tr>
                    ...
                    <table width="100%">
                      <tr>
                        <td class="Label9" align="center" colspan="3">
													AKA Names for <xsl:value-of select="$IDNumber" /><xsl:value-of select="' '" /><xsl:value-of select="$ITCName" /></td>
                      </tr>
              ...
              <tr>
                <td>
                  <table width="100%">
                    <tr>
                      <td class="Label9" align="center" colspan="5">
												Address Information for <xsl:value-of select="$IDNumber" /><xsl:value-of select="' '" /><xsl:value-of select="$ITCName" /></td>
                    </tr>
                    <tr>
                      <td class="Label8">Date</td>
              ...
              <tr>
                <td>
                  <table width="100%">
                    <tr>
                      <td class="Label9" align="center" colspan="5">
												Employment History for <xsl:value-of select="$IDNumber" /><xsl:value-of select="' '" /><xsl:value-of select="$ITCName" /></td>
                    </tr>
                    <tr>
                      <td class="Label8">Date</td>
              ...
              <tr>
                <td>
                  <table width="100%">
                    <tr>
                      <td class="Label9" align="center" colspan="5">
												Enquiry History for <xsl:value-of select="$IDNumber" /><xsl:value-of select="' '" /><xsl:value-of select="$ITCName" /></td>
                    </tr>
                    <tr>
