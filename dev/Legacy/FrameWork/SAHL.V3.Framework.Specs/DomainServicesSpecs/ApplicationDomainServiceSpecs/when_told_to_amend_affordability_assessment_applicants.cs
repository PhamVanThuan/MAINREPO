...
{
    public class when_told_to_amend_affordability_assessment_applicants : WithFakes
    {
        ...
        Because of = () =>
        {
            actualResult = applicationDomainService.AmendAffordabilityAssessmentIncomeContributors(Param.IsAny<AffordabilityAssessmentModel>());
        };
