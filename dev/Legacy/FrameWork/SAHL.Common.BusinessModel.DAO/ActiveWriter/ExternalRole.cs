...
namespace SAHL.Common.BusinessModel {
    ...
    public partial class ExternalRole : ActiveRecordBase<ExternalRole> {
        
        private int _externalRoleKey;
        
        private int _genericKey;
        
        private ExternalRoleType _externalRoleType;
        ...
        public virtual int ExternalRoleKey {
            get {
                return this._externalRoleKey;
            }
            set {
                this._externalRoleKey = value;
            }
        }
        ...
        [BelongsTo("ExternalRoleTypeKey")]
        public virtual ExternalRoleType ExternalRoleType {
            get {
    ...
    public partial class ExternalRoleType : ActiveRecordBase<ExternalRoleType> {
        
        private int _externalRoleTypeKey;
        
        private string _description;
        
        private IList<ExternalRole> _externalRoles;
        
        [PrimaryKey(PrimaryKeyType.Native, "ExternalRoleTypeKey", ColumnType="Int32")]
        ...
        [HasMany(typeof(ExternalRole), ColumnKey="ExternalRoleTypeKey", Table="ExternalRole")]
        public virtual IList<ExternalRole> ExternalRoles {
            get {
                return this._externalRoles;
            }
            set {
                this._externalRoles = value;
            }
        }
    }
    ...
    public partial class GeneralStatus : ActiveRecordBase<GeneralStatus> {
        ...
        [HasMany(typeof(ExternalRole), ColumnKey="GeneralStatusKey", Table="ExternalRole")]
        public virtual IList<ExternalRole> ExternalRoles {
            get {
                return this._externalRoles;
            }
    ...
    public partial class LegalEntity : ActiveRecordBase<LegalEntity> {
        ...
        [HasMany(typeof(ExternalRole), ColumnKey="LegalEntityKey", Table="ExternalRole")]
        public virtual IList<ExternalRole> ExternalRoles {
            get {
                return this._externalRoles;
            }
    ...
    public partial class GenericKeyType : ActiveRecordBase<GenericKeyType> {
        ...
        [HasMany(typeof(ExternalRole), ColumnKey="GenericKeyTypeKey", Table="ExternalRole")]
        public virtual IList<ExternalRole> ExternalRoles {
            get {
                return this._externalRoles;
            }
    ...
    public class ExternalRoleHelper {
        
        public static Type[] GetTypes() {
            return new Type[] {
                    typeof(ExternalRole),
                    typeof(ExternalRoleType),
