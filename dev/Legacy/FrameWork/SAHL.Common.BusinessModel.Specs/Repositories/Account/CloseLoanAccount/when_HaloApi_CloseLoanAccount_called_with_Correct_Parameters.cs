...
namespace SAHL.Common.BusinessModel.Specs.Repositories.Account.CloseLoanAccount
{
    internal class when_HaloApi_CloseLoanAccount_called_with_Correct_Parameters : WithFakes
    {
        ...
        Establish context = () =>
        {
            ...
            statementName = "CloseLoanAccount";
        ...
        {
            accountRepository.CloseLoanAccount(accountKey, userId);
        };
