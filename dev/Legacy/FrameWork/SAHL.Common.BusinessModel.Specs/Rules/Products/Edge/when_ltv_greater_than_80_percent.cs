...
namespace SAHL.Common.BusinessModel.Specs.Rules.Products.Edge
{
    ...
    public class when_ltv_greater_than_80_percent : RulesBaseWithFakes<SAHL.Common.BusinessModel.Rules.Products.ApplicationProductEdgeLTV>
    {
        ...
        Establish Context = () =>
        {
            ...
            applicationInformationVariableLoan.WhenToldTo(x => x.LTV).Return(0.9);
        ...
        It should_contain_exact_message = () =>
        {
            messages[0].Message.ShouldEqual("Edge applications require an LTV of < 80%");
        };
    }
}
