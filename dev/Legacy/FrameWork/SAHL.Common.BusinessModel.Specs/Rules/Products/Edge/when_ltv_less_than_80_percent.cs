...
namespace SAHL.Common.BusinessModel.Specs.Rules.Products.Edge
{
    ...
    public class when_ltv_less_than_80_percent : RulesBaseWithFakes<SAHL.Common.BusinessModel.Rules.Products.ApplicationProductEdgeLTV>
    {
        ...
        Establish Context = () =>
        {
            ...
            applicationInformationVariableLoan.WhenToldTo(x => x.LTV).Return(0.7);
