...
namespace SAHL.Common.BusinessModel.Specs.Rules.HOC.HOCRoofDescriptionConventionalSpecs
{
	...
	public class when_conventional_amount_0_and_valuation_is_active : RulesBaseWithFakes<HOCRoofDescriptionConventional>
	{
		...
		Establish context = () =>
		{
			...
			hocInsurer.WhenToldTo(x => x.Key).Return((int)HOCInsurers.SAHLHOC);
