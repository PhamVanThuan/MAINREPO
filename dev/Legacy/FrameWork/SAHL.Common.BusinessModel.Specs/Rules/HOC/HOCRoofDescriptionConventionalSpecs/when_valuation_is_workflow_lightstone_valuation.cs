...
namespace SAHL.Common.BusinessModel.Specs.Rules.HOC.HOCRoofDescriptionConventionalSpecs
{
	...
	class when_valuation_is_workflow_lightstone_valuation : RulesBaseWithFakes<HOCRoofDescriptionConventional>
	{
		...
		Establish context = () =>
		{
			...
			valuation = An<IValuationDiscriminatedLightstoneAVM>();
