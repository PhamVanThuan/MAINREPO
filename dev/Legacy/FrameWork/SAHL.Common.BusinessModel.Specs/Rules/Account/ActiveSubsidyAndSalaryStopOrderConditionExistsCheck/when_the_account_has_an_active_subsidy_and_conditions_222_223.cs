...
namespace SAHL.Common.BusinessModel.Specs.Rules.Account.ActiveSubsidyAndSalaryStopOrderConditionExistsCheck
{
    ...
    public class when_the_account_has_an_active_subsidy_and_conditions_222_223 : RulesBaseWithFakes<ActiveSubsidyAndSalaryStopOrderConditionExistsError>
    {
        ...
        private Establish context = () =>
        {
            ...
            application.WhenToldTo(x => x.HasCondition("222")).Return(true);
