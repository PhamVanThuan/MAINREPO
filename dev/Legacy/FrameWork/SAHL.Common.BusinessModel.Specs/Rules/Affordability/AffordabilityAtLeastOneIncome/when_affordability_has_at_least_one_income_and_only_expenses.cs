...
namespace SAHL.Common.BusinessModel.Specs.Rules.Affordability.AffordabilityAtLeastOneIncome
{
    ...
    public class when_affordability_has_at_least_one_income_and_only_expenses : RulesBaseWithFakes<SAHL.Common.BusinessModel.Rules.Affordability.AffordabilityAtLeastOneIncome>
    {
        ...
        Establish Context = () =>
        {
            ...
            affordabilityType.WhenToldTo(x => x.IsExpense).Return(true);
