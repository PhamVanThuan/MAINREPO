...
namespace SAHL.Common.BusinessModel.Specs.Rules.Affordability.AffordabilityStatementMandatory
{
    ...
    public class when_affordability_statement_mandatory_and_LegalEntityAffordabilities_is_null_MainApplicant : RulesBaseWithFakes<SAHL.Common.BusinessModel.Rules.Affordability.AffordabilityStatementMandatory>
    {
        ...
        Establish Context = () =>
        {
            ...
            roleType.WhenToldTo(x => x.Key).Return(11);
