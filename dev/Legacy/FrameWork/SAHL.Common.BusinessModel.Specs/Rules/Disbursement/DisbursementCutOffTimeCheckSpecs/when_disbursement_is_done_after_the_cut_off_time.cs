...
namespace SAHL.Common.BusinessModel.Specs.Rules.Disbursement.DisbursementCutOffTimeCheckSpecs
{
    ...
    public class when_disbursement_is_done_after_the_cut_off_time : RulesBaseWithFakes<DisbursementCutOffTimeCheck>
    {
        ...
        Establish context = () =>
        {
            ...
            DateTime dt = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, 12, 45, 0);
        ...
        {
            messages.Count.ShouldEqual<int>(1);
        };
    }
}
