...
namespace SAHL.Common.BusinessModel.Specs.Rules.LegalEntity.AddressActiveLegalEntityDomiciliumCanNotBeDeleted
{
 [Subject(typeof(SAHL.Common.BusinessModel.Rules.LegalEntityAddress.LegalEntityAddressCanNotBeDeletedIfItIsTheActiveLegalEntityDomicilium))]
    public class when_trying_to_delete_legalentityaddress_that_is_the_active_legalentitydomicilium : RulesBaseWithFakes<SAHL.Common.BusinessModel.Rules.LegalEntityAddress.LegalEntityAddressCanNotBeDeletedIfItIsTheActiveLegalEntityDomicilium>
    {
        ...
        Establish context = () =>
        {
            ...
            legalEntityAddress.WhenToldTo(x => x.Key).Return(2);
