...
{
    [Subject(typeof(SAHL.Common.BusinessModel.Rules.LegalEntity.ActiveDomiciliumAddressIsUsedOnOpenApplications))]
    public class when_active_domicilium_is_used_on_open_application : RulesBaseWithFakes<SAHL.Common.BusinessModel.Rules.LegalEntity.ActiveDomiciliumAddressIsUsedOnOpenApplications>
    {
        ...
        Establish context = () =>
        {
            ...
            applicationStatus.WhenToldTo(x => x.Key).Return((int)OfferStatuses.Open);
