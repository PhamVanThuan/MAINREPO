...
namespace SAHL.Common.BusinessModel.Specs.Rules.FixedDebitOrder.FinancialServiceBankAccount.FinancialServiceBankAccountUpdateDebitOrderAmount
{
    ...
    public class when_finservice_bank_acc_update_debit_order_amt_fail : RulesBaseWithFakes<SAHL.Common.BusinessModel.Rules.FixedDebitOrder.FinancialServiceBankAccountUpdateDebitOrderAmount>
    {
        ...
        It rule_should_fail_because_fixedpayment_less_than_than_totalamt = () =>
            {
