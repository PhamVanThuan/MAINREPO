...
namespace SAHL.Common.BusinessModel.Specs.Rules.Application.FurtherLending.PreventPayingwithHOCPaidUpwithNoHOCSpecs
{
    ...
    public class when_the_hoc_status_is_set_to_paid_up_with_no_hoc : RulesBaseWithFakes<ApplicationFurtherLendingPreventPayingwithHOCPaidUpwithNoHOC>
    {
        ...
        Establish context = () =>
        {
            ...
            hocStatus.WhenToldTo(x => x.Key)
                .Return((int)SAHL.Common.Globals.HocStatuses.PaidUpwithnoHOC);
