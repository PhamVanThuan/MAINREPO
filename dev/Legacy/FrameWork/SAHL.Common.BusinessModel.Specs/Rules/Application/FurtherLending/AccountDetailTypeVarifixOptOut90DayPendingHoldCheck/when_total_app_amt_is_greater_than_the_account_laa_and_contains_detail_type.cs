...
namespace SAHL.Common.BusinessModel.Specs.Rules.Application.FurtherLending.AccountDetailTypeVarifixOptOut90DayPendingHoldCheck
{
    ...
    public class when_total_app_amt_is_greater_than_the_account_laa_and_contains_detail_type : RulesBaseWithFakes<SAHL.Common.BusinessModel.Rules.Application.FurtherLending.AccountDetailTypeVarifixOptOut90DayPendingHoldCheck>
    {
        ...
        Establish context = () =>
        {
            ...
            dt.Rows.Add(new object[] { "VariFix Opt-Out 90 Day Pending" });
