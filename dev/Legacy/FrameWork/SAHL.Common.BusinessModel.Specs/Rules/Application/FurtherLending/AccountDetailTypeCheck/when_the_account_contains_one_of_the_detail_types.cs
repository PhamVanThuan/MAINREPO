...
namespace SAHL.Common.BusinessModel.Specs.Rules.Application.FurtherLending.AccountDetailTypeCheck
{
    ...
    public class when_the_account_contains_one_of_the_detail_types : RulesBaseWithFakes<SAHL.Common.BusinessModel.Rules.Application.FurtherLending.AccountDetailTypeCheck>
    {
        ...
        Establish context = () =>
        {
            ...
            dt.Rows.Add(new object[]{"Estate Late - Unsecured"});
