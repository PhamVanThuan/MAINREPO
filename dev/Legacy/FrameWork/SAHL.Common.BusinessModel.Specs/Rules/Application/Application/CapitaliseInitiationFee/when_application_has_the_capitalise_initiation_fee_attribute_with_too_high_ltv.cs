...
namespace SAHL.Common.BusinessModel.Specs.Rules.Application.Application.CapitaliseInitiationFee
{
    ...
    public class when_application_has_the_capitalise_initiation_fee_attribute_with_too_high_ltv : RulesBaseWithFakes<SAHL.Common.BusinessModel.Rules.Application.CapitaliseInitiationFeeLTV>
    {
        ...
        protected static double? ltv = 0.8;
