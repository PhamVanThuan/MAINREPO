...
namespace SAHL.Common.BusinessModel.Specs.Rules.Application.EnsureAllHouseHoldIncomesHaveBeenConfirmed
{
    [Subject(typeof(SAHL.Common.BusinessModel.Rules.LegalEntity.LegalEntityNaturalPersonHouseholdContributorConfirmedIncome))]
    public class when_application_has_a_multiple_income_contributor_with_at_least_one_unconfirmed_income : RulesBaseWithFakes<SAHL.Common.BusinessModel.Rules.LegalEntity.LegalEntityNaturalPersonHouseholdContributorConfirmedIncome>
    {
        ...
        Establish context = () =>
        {
            ...
            employmentWithNonConfirmedIncome.WhenToldTo(x => x.ConfirmedBasicIncome).Return(0.0d);
