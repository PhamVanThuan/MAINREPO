...
namespace SAHL.Common.BusinessModel.Specs.Rules.DebtCounselling.DomiciliumAddress.LegalEntitiesAllHaveDomiciliumOnDebtCounsellingCase
{
    ...
    public class when_all_clients_do_not_have_an_active_domicilium_on_a_debt_counselling_case : RulesBaseWithFakes<SAHL.Common.BusinessModel.Rules.DebtCounselling.LegalEntitiesAllHaveDomiciliumOnDebtCounsellingCase>
    {
        ...
        Establish context = () =>
        {
            ...
            // set up 2 clients but only one with an active domicilium
