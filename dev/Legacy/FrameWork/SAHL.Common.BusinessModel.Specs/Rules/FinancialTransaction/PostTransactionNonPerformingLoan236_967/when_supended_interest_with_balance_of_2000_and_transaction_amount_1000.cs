...
{
	public class when_supended_interest_with_balance_of_2000_and_transaction_amount_1000 : RulesBaseWithFakes<SAHL.Common.BusinessModel.Rules.FinancialTransaction.PostTransactionNonPerformingLoan236_967>
	{
		...
		Establish context = () =>
		{
			...
			double suspdendedInterestAmount = 2000d;
			loanTransactionAmount = 1000d;
