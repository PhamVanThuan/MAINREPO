...
namespace SAHL.Common.BusinessModel.Specs.Rules.Valuations.CheckActiveValuation12MonthsWarning
{
    ...
    public class when_there_is_an_active_valuation_within_12months : RulesBaseWithFakes<SAHL.Common.BusinessModel.Rules.Valuations.CheckActiveValuation12MonthsWarning>
    {
        ...
        Establish context = () =>
        {
            ...
            valuation1.WhenToldTo(x => x.ValuationDate).Return(DateTime.Now.AddMonths(-6));
