...
{
    [Serializable]
    public class X2CreateWorkFlowInstanceWithCompleteRequest : X2RequestBase
    {
        ...
        public X2CreateWorkFlowInstanceWithCompleteRequest(string p_SessionId, string p_ProcessName, string p_ProcessVersion, string p_WorkFlowName, string p_ActivityName, bool IgnoreWarnings, object Data)
            :
        ...
        public X2CreateWorkFlowInstanceWithCompleteRequest(string p_SessionId, string p_ProcessName, string p_ProcessVersion, string p_WorkFlowName, string p_ActivityName, Dictionary<string, string> FieldInputs, bool IgnoreWarnings, object Data)
            :
            base(IgnoreWarnings, Data)
        {
        ...
        public X2CreateWorkFlowInstanceWithCompleteRequest(string p_SessionId, string p_ProcessName, string p_ProcessVersion, string p_WorkFlowName, string p_ActivityName, Int64? SourceInstanceID, Int32? ReturnActivityID, bool IgnoreWarnings, object Data)
            : base(IgnoreWarnings, Data)
        {
