...
{
    [Serializable]
    public class X2ActivityCompleteRequest : X2RequestBase
    {
        ...
        public X2ActivityCompleteRequest(string p_SessionId, Int64 p_InstanceId, string p_ActivityName, bool IgnoreWarnings, object Data)
            : base(IgnoreWarnings, Data)
        {
            m_RequestType = RequestType.ActivityCompleteRequest;
