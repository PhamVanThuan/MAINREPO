...
{
    public class SAHLPanel : Panel, ISAHLSecurityControl
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            this.PreRender += new EventHandler(SAHLPanel_PreRender);
        }

        private void SAHLPanel_PreRender(object sender, EventArgs e)
        {
