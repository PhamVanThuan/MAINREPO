...
<script language=""{0}"" src=""{1}{2}""></script>";
        ...
        protected void RegisterValidatorCommonScript()
        {
            ...
            if (!Page.ClientScript.IsClientScriptBlockRegistered(ValidatorIncludeScriptKey))
            {
                ...
                Page.ClientScript.RegisterClientScriptBlock(this.GetType(), ValidatorIncludeScriptKey, includeScript);
            }

            if (!Page.ClientScript.IsStartupScriptRegistered(ValidatorIncludeScriptKey))
            {
                ...
                Page.ClientScript.RegisterStartupScript(this.GetType(), ValidatorIncludeScriptKey, startupScript);
            }

            Page.ClientScript.RegisterOnSubmitStatement(this.GetType(), "ValidatorOnSubmit", "return ValidatorOnSubmit();");
        }

        protected virtual void RegisterValidatorDeclaration()
        {
            string element = "document.getElementById(\"" + ClientID + "\")";
            Page.ClientScript.RegisterArrayDeclaration("Page_Validators", element);
        }
