...
namespace SAHL.Common.Web.UI.Controls
{
    ...
    /// </summary>
    [ToolboxBitmap(typeof(SAHLCheckboxList), "Resources.SAHLCheckboxList.bmp")]
    [ToolboxData("<{0}:SAHLCheckboxList runat=server></{0}:SAHLCheckboxList>")]
    public class SAHLCheckboxList : CheckBoxList, ISAHLSecurityControl
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            this.PreRender += new EventHandler(SAHLCheckboxList_PreRender);
        }

        private void SAHLCheckboxList_PreRender(object sender, EventArgs e)
        {
