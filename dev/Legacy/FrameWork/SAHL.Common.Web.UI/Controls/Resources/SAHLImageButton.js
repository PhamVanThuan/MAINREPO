// function for use on the client - enables/disables an SAHLImageButton
function SAHLImageButton_setEnabled(id, enabled)
{
...
function SAHLImageButton_updateEventTarget(button) 
{
