...
{
    public class DXListBox : ASPxListBox, ISAHLSecurityControl
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            this.PreRender += new EventHandler(DXListBox_PreRender);
        }

        private void DXListBox_PreRender(object sender, EventArgs e)
        {
