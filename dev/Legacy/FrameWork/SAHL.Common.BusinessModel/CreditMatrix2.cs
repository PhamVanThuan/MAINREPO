...
namespace SAHL.Common.BusinessModel
{
	...
	public partial class CreditMatrix : BusinessModelBase<SAHL.Common.BusinessModel.DAO.CreditMatrix_DAO>, ICreditMatrix
	{
		...
		protected void OnCreditCriterias_BeforeAdd(ICancelDomainArgs args, object Item)
		{
		...
		/// <param name="args"><see cref="ICancelDomainArgs"/></param>
		/// <param name="Item"></param>
		protected void OnCreditCriterias_BeforeRemove(ICancelDomainArgs args, object Item)
		{
        ...
        /// <param name="args"><see cref="ICancelDomainArgs"/></param>
        /// <param name="Item"></param>
        protected void OnCreditCriterias_AfterAdd(ICancelDomainArgs args, object Item)
        {
        ...
        /// <param name="args"><see cref="ICancelDomainArgs"/></param>
        /// <param name="Item"></param>
        protected void OnCreditCriterias_AfterRemove(ICancelDomainArgs args, object Item)
        {
