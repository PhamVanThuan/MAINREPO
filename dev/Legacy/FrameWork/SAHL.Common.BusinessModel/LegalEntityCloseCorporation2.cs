...
namespace SAHL.Common.BusinessModel
{
    ...
    public partial class LegalEntityCloseCorporation : LegalEntity, ILegalEntityCloseCorporation
    {
        ...
        public String RegistrationNumber
        {
            ...
            set
            {
                //if (!CheckUpdateOpenAccount() && value != _DAO.RegistrationNumber)
        ...
        public String RegisteredName
        {
            ...
            set
            {
                //if (!CheckUpdateOpenAccount() && value != _DAO.RegisteredName)
        ...
        /// <summary>
        /// Overridden to return the registration number of the close corporation.
        /// </summary>
