...
namespace SAHL.Common.BusinessModel
{
	...
	/// </summary>
	public partial class EmploymentConfirmationSource : BusinessModelBase<SAHL.Common.BusinessModel.DAO.EmploymentConfirmationSource_DAO>, IEmploymentConfirmationSource
	{
				public EmploymentConfirmationSource(SAHL.Common.BusinessModel.DAO.EmploymentConfirmationSource_DAO EmploymentConfirmationSource) : base(EmploymentConfirmationSource)
		{
			this._DAO = EmploymentConfirmationSource;
		}
		/// <summary>
