...
namespace SAHL.Common.BusinessModel
{
	...
	/// </summary>
	public partial class Suburb : BusinessModelBase<SAHL.Common.BusinessModel.DAO.Suburb_DAO>, ISuburb
	{
				public Suburb(SAHL.Common.BusinessModel.DAO.Suburb_DAO Suburb) : base(Suburb)
		{
			this._DAO = Suburb;
		}
		/// <summary>
