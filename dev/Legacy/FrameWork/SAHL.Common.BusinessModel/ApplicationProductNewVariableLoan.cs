...
{
    public class ApplicationProductNewVariableLoan : ApplicationProductMortgageLoan, IApplicationProductNewVariableLoan
    {
        public ApplicationProductNewVariableLoan(IApplication Application, bool CreateNew)
            : base(Application, CreateNew)
        {
            if (CreateNew)
            {
                ...
                if (clone)
                {
                    ...
                    if ((int)Application.CurrentProduct.ProductType == (int)Products.NewVariableLoan)
                    {
        ...
        public ApplicationProductNewVariableLoan(IApplicationInformation ApplicationInformation)
        ...
        #region IApplicationProductNewVariableLoan Members
        ...
        #endregion IApplicationProductNewVariableLoan Members
