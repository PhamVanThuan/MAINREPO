...
namespace SAHL.Common.BusinessModel.Repositories
{
    ...
    //    {
    //        string hql = string.Format("select r from RuleItem_DAO r where r.Name like '{0}%'", PartialRuleName);
    ...
    //    {
    //        string hql = string.Format("select r from RuleParameter_DAO r where r.RuleItemKey ={0}", RuleItemKey);
    ...
    //    /// <param name="RuleItemKey"></param>
    //    /// <returns></returns>
    //    public IRuleItem FindRuleByKey( int RuleItemKey)
    //    {
    //        RuleItem_DAO DAO = RuleItem_DAO.Find(RuleItemKey);
    //        IRuleItem rule = new RuleItem(DAO);
    //        return rule;
    //    }

    //    public IRuleItem CreateEmptyRuleItem()
    //    {
    //        return new RuleItem(new RuleItem_DAO());
    //    }

    //    public void SaveRuleItem( IRuleItem RuleToSave)
    //    {
    //        IDAOObject dao = RuleToSave as IDAOObject;
    //        RuleItem_DAO o = (RuleItem_DAO)dao.GetDAOObject();
    //        o.SaveAndFlush();
    //    }

    //    public IRuleParameter FindParameterByKey( int Key)
    //    {
    //        RuleParameter_DAO DAO = RuleParameter_DAO.Find(Key);
    //        IRuleParameter prm = new RuleParameter(DAO);
    //        return prm;
    //    }

    //    public IRuleParameter CreateEmptyRuleParameter()
    //    {
    //        return new RuleParameter(new RuleParameter_DAO());
    //    }

    //    public void SaveRuleParameter( IRuleParameter Param)
    //    {
    //        IDAOObject dao = Param as IDAOObject;
    //        RuleParameter_DAO o = (RuleParameter_DAO)dao.GetDAOObject();
    //        o.SaveAndFlush();
    //    }
