...
namespace SAHL.Common.BusinessModel
{
	...
	{
				public ApplicationInformationFinancialAdjustmentTypeSource(SAHL.Common.BusinessModel.DAO.ApplicationInformationFinancialAdjustmentTypeSource_DAO ApplicationInformationFinancialAdjustmentTypeSource) : base(ApplicationInformationFinancialAdjustmentTypeSource)
		{
			this._DAO = ApplicationInformationFinancialAdjustmentTypeSource;
		}
		/// <summary>
