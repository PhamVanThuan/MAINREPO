...
namespace SAHL.Common.BusinessModel
{
	...
	/// </summary>
	public partial class ClientSurvey : BusinessModelBase<SAHL.Common.BusinessModel.DAO.ClientSurvey_DAO>, IClientSurvey
	{
				public ClientSurvey(SAHL.Common.BusinessModel.DAO.ClientSurvey_DAO ClientSurvey) : base(ClientSurvey)
		{
			this._DAO = ClientSurvey;
		}
		/// <summary>
