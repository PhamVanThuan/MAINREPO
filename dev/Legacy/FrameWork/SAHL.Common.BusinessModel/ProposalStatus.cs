...
namespace SAHL.Common.BusinessModel
{
	...
	{
				public ProposalStatus(SAHL.Common.BusinessModel.DAO.ProposalStatus_DAO ProposalStatus) : base(ProposalStatus)
		{
			this._DAO = ProposalStatus;
		}
		/// <summary>
		...
		/// <summary>
		/// SAHL.Common.BusinessModel.DAO.ProposalStatus_DAO.Proposals
		/// </summary>
