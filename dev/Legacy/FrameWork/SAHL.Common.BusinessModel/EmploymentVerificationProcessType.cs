...
namespace SAHL.Common.BusinessModel
{
	...
	/// </summary>
	public partial class EmploymentVerificationProcessType : BusinessModelBase<SAHL.Common.BusinessModel.DAO.EmploymentVerificationProcessType_DAO>, IEmploymentVerificationProcessType
	{
				public EmploymentVerificationProcessType(SAHL.Common.BusinessModel.DAO.EmploymentVerificationProcessType_DAO EmploymentVerificationProcessType) : base(EmploymentVerificationProcessType)
		{
			this._DAO = EmploymentVerificationProcessType;
		}
		/// <summary>
