...
{
    public class ApplicationProductVariableLoan : ApplicationProductMortgageLoan, IApplicationProductVariableLoan
    {
        public ApplicationProductVariableLoan(IApplication Application, bool CreateNew)
            : base(Application, CreateNew)
        {
            if (CreateNew)
            {
                ...
                if (clone)
                {
                    ...
                    if ((int)Application.CurrentProduct.ProductType == (int)Products.VariableLoan)
                    {
        ...
        public ApplicationProductVariableLoan(IApplicationInformation ApplicationInformation)
            : base(ApplicationInformation)
        {
        }

        #region IApplicationProductVariableLoan Members
        ...
        #endregion IApplicationProductVariableLoan Members
        ...
        public override void SetManualDiscount(IDomainMessageCollection Messages, double? discount, FinancialAdjustmentTypeSources fats)
        {
            ApplicationProductMortgageLoanHelper.SetManualDiscount(this, discount, fats, Messages);
        }
