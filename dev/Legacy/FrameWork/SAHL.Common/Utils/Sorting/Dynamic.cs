...
namespace SAHL.Common.Utilities.Sorting
{
    ...
    #endregion Explicit arguments (up to 9, consider passing an object if you think you need more!)
    ...
    #endregion Procedures (methods that return nothing)
    ...
    #endregion Functions (methods that return a TRet)
