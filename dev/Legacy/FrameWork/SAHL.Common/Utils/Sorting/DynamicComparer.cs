...
{
    /// <summary>
    /// Provides functionality for sorting objects by property names.  This is available for download from:
    /// http://www.iamari.com/MarcBrooks/DynamicSorter.zip
    /// </summary>
    ...
    public sealed class DynamicComparer<T> : System.Collections.Generic.IComparer<T>
    {
        ...
        private DynamicMethod CreateDynamicCompareMethod(SortProperty[] sortProperties)
        {
            ...
            #endregion Generate IL for dynamic method
