...
namespace PDFDocumentWriter.DataAccess
{
    public partial class DBHelper
    {
        ...
        public DBHelper(string Procedure, CommandType type, string DBConnectionString)
        {
        ...
        public DBHelper(string Procedure, string DBConnectionString)
        {
            con = new SqlConnection(DBConnectionString);
            adap = new SqlDataAdapter(Procedure, con);
        ...
        public void AddBitParameter(string Name, object value)
        {
            AddParameter(Name, SqlDbType.Bit, ParameterDirection.Input, value);
        }
