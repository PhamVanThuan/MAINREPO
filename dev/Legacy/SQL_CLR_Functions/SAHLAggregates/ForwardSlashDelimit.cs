...
[Serializable]
public struct ForwardSlashDelimit : IBinarySerialize
{
	...
	public void Merge(ForwardSlashDelimit other)
	{
	...
	public SqlString Terminate()
	{
		...
		{
			data = this.intermediateResult.ToString(0, this.intermediateResult.Length - 3);
		}
