...
<%@ Page Language="C#" CodeFile="BarclayCardJointApp_Old.aspx.cs" Inherits="BarclayCardJointApp_Old_aspx" %>
...
<body style="text-align: left">
    <form id="Form1" runat="server">
        ...
        <table id="tDetails" class="SAHLTable" width="1100">
                    ...
                    <asp:Panel ID="pnlDetails1" runat="server" Width="100%">
                        <table>
                            ...
                            <tr>
                                ...
                                <td style="width: 310px; text-align: left;">
                                    <asp:TextBox ID="txtCreditLimit" runat="server" Width="103px"></asp:TextBox><input
                                        id="btnViewLimitMatrix" onclick="minmax(tlimitmatrix,btnViewLimitMatrix,btnViewLimitMatrix2);"
                                        type="button" value="View Limit Matrix" style="cursor: hand;display:none" size="20"/><br />
                                    <asp:Label ID="lblRefusalMessage" runat="server" ForeColor="Red" Visible="False"></asp:Label>
                                    <asp:RequiredFieldValidator ID="valCreditLimit" runat="server" ControlToValidate="txtCreditLimit"
                                        Display="Dynamic" Enabled="False" ErrorMessage="<< Must enter a Credit Limit"
                            ...
                            <tr>
                                ...
                                <td style="width: 310px; text-align: left;">
                                    <asp:Button ID="btnOverrideApplication" runat="server" OnClick="btnOverrideApplication_Click"
                                        Text="Override Application" Width="128px" Visible="False" /><asp:TextBox ID="txtOverrideReason" runat="server"
                                            TextMode="MultiLine" Width="269px"></asp:TextBox><asp:RequiredFieldValidator
                                                ID="oRVOverrideReason" runat="server" ControlToValidate="txtOverrideReason" ErrorMessage="Must Enter a Reason for Overriding the Application"
                                                Width="301px" Enabled="False"></asp:RequiredFieldValidator></td>
                            </tr>
                        </table>
                    </asp:Panel>
                </td>
                        ...
                        <table>
                            ...
                            <tr>
                                <td style="width: 190px; text-align: right;">
                                    Qualified Credit Limit</td>
                                <td style="width: 310px; text-align: left;">
                                    <asp:TextBox ID="txtCreditLimit2" runat="server" Width="103px"></asp:TextBox><input
                                        id="btnViewLimitMatrix2" onclick="minmax(tlimitmatrix,btnViewLimitMatrix,btnViewLimitMatrix2);"
                                        type="button" value="View Limit Matrix" style="cursor: hand;display:none" size="20"/><br />
                                    <asp:Label ID="lblRefusalMessage2" runat="server" ForeColor="Red" Visible="False"></asp:Label>
                                    <asp:RequiredFieldValidator ID="valCreditLimit2" runat="server" ControlToValidate="txtCreditLimit2"
                                        Display="Dynamic" Enabled="False" ErrorMessage="<< Must enter a Credit Limit"
                                        InitialValue="0"></asp:RequiredFieldValidator></td>
                            </tr>
                            <tr>
                                <td style="width: 190px; text-align: right;">
                                    <asp:Label ID="lblOverrideReason2" runat="server" Text="Override Reason" Visible="False"></asp:Label></td>
                                <td style="width: 310px; text-align: left;">
                                    <asp:Button ID="btnOverrideApplication2" runat="server" OnClick="btnOverrideApplication2_Click"
                                        Text="Override Application" Width="128px" Visible="False" /><asp:TextBox ID="txtOverrideReason2"
                                            runat="server" TextMode="MultiLine" Width="269px"></asp:TextBox><asp:RequiredFieldValidator
                                                ID="oRVOverrideReason2" runat="server" ControlToValidate="txtOverrideReason2"
                                                EnableClientScript="False" ErrorMessage="Must Enter a Reason for Overriding the Application"
                                                Width="301px" Enabled="False"></asp:RequiredFieldValidator></td>
                            </tr>
                        </table>
                    </asp:Panel>
            ...
            <tr>
                <td colspan="2">
                    <table id="tlimitmatrix" style="display: none">
                        <tr>
                            <td style="text-align: center;">
                                <asp:GridView ID="gvMatrix" runat="server" ForeColor="Black" HorizontalAlign="Center"
                                    DataSourceID="oSqlDSMatrix" BorderWidth="1px" BackColor="White" GridLines="Vertical"
                                    CellPadding="4" BorderColor="#DEDFDE" BorderStyle="None" Font-Size="X-Small"
                                    Width="100%">
                                    <FooterStyle BackColor="#CCCC99"></FooterStyle>
                                    <RowStyle BackColor="#F7F7DE" Font-Size="X-Small" />
                                    <SelectedRowStyle BackColor="#CE5D5A" Font-Bold="True" ForeColor="White" />
                                    <PagerStyle BackColor="#F7F7DE" ForeColor="Black" HorizontalAlign="Right" />
                                    <HeaderStyle BackColor="White" Font-Bold="True" Font-Size="X-Small" ForeColor="White"
                                        Wrap="False" />
                            ...
                            <tr>
                                ...
                                <td style="width: 310px; text-align: left">
                                    <asp:TextBox ID="txtAPOAmount" runat="server" Width="103px"></asp:TextBox><asp:RequiredFieldValidator
                                        ...
                                        Enabled="False" ControlToValidate="txtAPOAmount">
                                    </asp:RequiredFieldValidator><asp:CompareValidator ID="oRVAPOAmount" runat="server"
                            ...
                            <tr>
                                ...
                                <td style="width: 310px; text-align: left">
                                    <asp:TextBox ID="txtAPOAmount2" runat="server" Width="103px"></asp:TextBox><asp:RequiredFieldValidator
                                        ...
                                        Enabled="False" ControlToValidate="txtAPOAmount2">
                                    </asp:RequiredFieldValidator><asp:CompareValidator ID="oRVAPOAmount2" runat="server"
                            ...
                            <tr>
                                ...
                                <td style="width: 310px; text-align: left">
                                    <asp:TextBox ID="txtAPODay2" runat="server" Width="103px"></asp:TextBox><asp:RangeValidator
                                        ...
                                        MinimumValue="1" ControlToValidate="txtAPODay2" MaximumValue="31" Type="Integer">
                                    </asp:RangeValidator><asp:RequiredFieldValidator ID="oRfvAPODay2" runat="server"
                                        Display="Dynamic" ControlToValidate="txtAPODay2" ErrorMessage="<< Required" Enabled="False">
                                    </asp:RequiredFieldValidator></td>
                            </tr>
                            <tr>
                                <td style="text-align: right; width: 190px;">
