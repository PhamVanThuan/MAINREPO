...
<%@ Page Language="C#" CodeFile="BarclayCardApp.aspx.cs" Inherits="BarclayCardApp_aspx" %>
                    ...
                    <asp:Panel ID="pnlDetails" runat="server" Width="100%">
                        <table style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td style="width: 60%; text-align: left">
                                    <asp:TextBox ID="txtCreditLimit" runat="server" Width="103px"></asp:TextBox>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtCreditLimit"
                            ...
                            <tr>
                                ...
                                <td style="width: 60%; text-align: left">
                                    <asp:TextBox ID="txtReasonOveride" runat="server" TextMode="MultiLine" Width="384px" ></asp:TextBox></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="width: 60%; text-align: left">
                                    ...
                                    <asp:TextBox ID="txtBarclayCardKey" runat="server" Visible="False" Width="29px"></asp:TextBox></td>
                            </tr>
                            <tr>
