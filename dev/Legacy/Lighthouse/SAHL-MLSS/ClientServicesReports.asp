...
if rs_open <> true then
	...
	sDSN = "Provider=SQLOLEDB.1;Application Name='SAHL-MLSS [ClientServicesReports.asp 1]';Data Source=<%= Session("SQLDatabase") %>;uid=<%= Session("UserID") %>"
	conn.Open sDSN
	rs_open = false
...
Sub GetProspectReportData()
   ...
   document.body.style.cursor = "wait"
    ...
    sSQL = "c_GetClientServicesReports"
...
Sub btn_RunReport_onclick
 ...
 if rs_Grid.Fields("ReportDescription").value = "S2K Report" then
	...
	location.href = ReportPath & "/Loans/" & rs_Grid.Fields("ReportFileName").Value
else
...
'Get the report path from the Control File
 ...
 CrystalCtrl1.ReportFileName = ReportPath & "Loans\" & rs_Grid.Fields("ReportFileName")
...
Sub TrueDBGridCtrl1_MouseMove(m,s,x,y)
 ...
 window.btn_RunReport.value = "Run Client Services Report"
End Sub
