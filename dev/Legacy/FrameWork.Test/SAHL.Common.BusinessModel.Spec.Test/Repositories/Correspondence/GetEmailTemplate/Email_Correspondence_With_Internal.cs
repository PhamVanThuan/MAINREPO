...
{
    [Subject("Email_Correspondence_With_Internal")]
    internal class Email_Correspondence_With_Internal : WithFakes
    {
        ...
        internal Establish context = () =>
        {
            ...
            _expectedResult = string.Format(_testBase.GetActualTemplate(CorrespondenceTemplates.EmailCorrespondenceInternal).Template, "", "", "");
        };

        internal Because of = () =>
        {
            _testBase.GetEmailTemplate(_legalEntity, "", "", _accountKey, CorrespondenceTemplates.EmailCorrespondenceInternal, out _subject, out _body);
        };
