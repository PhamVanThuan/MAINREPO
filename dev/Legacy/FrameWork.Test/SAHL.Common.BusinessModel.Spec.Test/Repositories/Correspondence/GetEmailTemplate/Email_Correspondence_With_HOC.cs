...
{
    [Subject("Email_Correspondence_With_HOC")]
    internal class Email_Correspondence_With_HOC : WithFakes
    {
        ...
        internal Establish context = () =>
        {
            ...
            _expectedResult = string.Format(_testBase.GetActualTemplate(CorrespondenceTemplates.EmailCorrespondenceHOC).Template, "", "", "");
        };

        internal Because of = () =>
        {
            _testBase.GetEmailTemplate(_legalEntity, "", "", _accountKey, CorrespondenceTemplates.EmailCorrespondenceHOC, out _subject, out _body);
        };
