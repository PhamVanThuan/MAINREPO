...
{
    [Subject("Email_Correspondence_With_Debtcounselling")]
    internal class Email_Correspondence_With_Debtcounselling : WithFakes
    {
        ...
        internal Establish context = () =>
        {
            ...
            _expectedResult = string.Format(_testBase.GetActualTemplate(CorrespondenceTemplates.EmailCorrespondenceDebtcounselling).Template, "", "", "");
        };

        internal Because of = () =>
        {
            _testBase.GetEmailTemplate(_legalEntity, "", "", _accountKey, CorrespondenceTemplates.EmailCorrespondenceDebtcounselling, out _subject, out _body);
        };
