...
{
    [Subject("Email_Correspondence_With_PersonalLoan")]
    internal class Email_Correspondence_With_PersonalLoan : WithFakes
    {
        ...
        internal Establish context = () =>
        {
            ...
            _expectedResult = string.Format(_testBase.GetActualTemplate(CorrespondenceTemplates.EmailCorrespondencePersonalLoan).Template, "", "", "");
        };

        internal Because of = () =>
        {
            _testBase.GetEmailTemplate(_legalEntity, "", "", _accountKey, CorrespondenceTemplates.EmailCorrespondencePersonalLoan, out _subject, out _body);
        };
