...
{
    [Subject("Email_Correspondence_With_Life")]
    internal class Email_Correspondence_With_Life : WithFakes
    {
        ...
        internal Establish context = () =>
        {
            ...
            _expectedResult = string.Format(_testBase.GetActualTemplate(CorrespondenceTemplates.EmailCorrespondenceLife).Template, "", "", "");
        };

        internal Because of = () =>
        {
            _testBase.GetEmailTemplate(_legalEntity, "", "", _accountKey, CorrespondenceTemplates.EmailCorrespondenceLife, out _subject, out _body);
        };
