...
{
	public class category_99_when_salaried_and_new_purchase : CreditCriteriaTestBase
	{	
        ...
        Establish context = () =>
        {
            ...
            CreditCriteriaDetermineTest test_salaried_ltv_98_income_20000_loan_amt_7000000_mil = new CreditCriteriaDetermineTest
            {
                EmploymentTypeKey = 1,
            ...
            creditCriteriaTestPacks.Add(test_salaried_ltv_98_income_20000_loan_amt_7000000_mil);
				};
