...
{
	public class category_11_when_salaried_and_new_purchase : CreditCriteriaTestBase
	{	
        ...
        Establish context = () =>
        {
            ...
            CreditCriteriaDetermineTest test_salaried_ltv_100_income_20000_loan_amt_2000000_mil = new CreditCriteriaDetermineTest
            {
                EmploymentTypeKey = 1,
                ...
                LTV = 100,
                Income = 20000,
                ExpectedCategoryKey = 11,
                MortgageLoanPurposeKey = 3,
				CreditCriteriaAttributeTypeKey = 1
            };
            creditCriteriaTestPacks.Add(test_salaried_ltv_100_income_20000_loan_amt_2000000_mil);
				};
