...
{
	public class category_3_when_self_employed_and_new_purchase : CreditCriteriaTestBase
	{	
        ...
        Establish context = () =>
        {
            ...
            CreditCriteriaDetermineTest test_self_employed_ltv_85_income_20000_loan_amt_1800000_mil = new CreditCriteriaDetermineTest
            {
                EmploymentTypeKey = 2,
                ...
                LTV = 85,
                Income = 20000,
                ExpectedCategoryKey = 3,
                MortgageLoanPurposeKey = 3,
				CreditCriteriaAttributeTypeKey = 1
            };
            creditCriteriaTestPacks.Add(test_self_employed_ltv_85_income_20000_loan_amt_1800000_mil);
					
            CreditCriteriaDetermineTest test_self_employed_ltv_85_income_20000_loan_amt_2750000_mil = new CreditCriteriaDetermineTest
            {
                EmploymentTypeKey = 2,
                OriginationSourceKey = (int)SAHL.Common.Globals.OriginationSources.SAHomeLoans,
                ProductKey = (int)SAHL.Common.Globals.Products.NewVariableLoan,
            ...
            creditCriteriaTestPacks.Add(test_self_employed_ltv_85_income_20000_loan_amt_2750000_mil);
				};
