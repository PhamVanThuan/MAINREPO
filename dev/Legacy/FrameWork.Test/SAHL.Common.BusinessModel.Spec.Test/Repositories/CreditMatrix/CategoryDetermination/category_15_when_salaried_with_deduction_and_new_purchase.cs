...
{
	public class category_15_when_salaried_with_deduction_and_new_purchase : CreditCriteriaTestBase
	{	
        ...
        Establish context = () =>
        {
            ...
            CreditCriteriaDetermineTest test_salaried_with_deduction_ltv_90_income_20000_loan_amt_1800000_mil = new CreditCriteriaDetermineTest
            {
                EmploymentTypeKey = 3,
                ...
                LTV = 90,
                Income = 20000,
                ExpectedCategoryKey = 15,
                MortgageLoanPurposeKey = 3,
				CreditCriteriaAttributeTypeKey = 4
            };
            creditCriteriaTestPacks.Add(test_salaried_with_deduction_ltv_90_income_20000_loan_amt_1800000_mil);
					
            CreditCriteriaDetermineTest test_salaried_with_deduction_ltv_90_income_20000_loan_amt_2750000_mil = new CreditCriteriaDetermineTest
            {
                EmploymentTypeKey = 3,
                OriginationSourceKey = (int)SAHL.Common.Globals.OriginationSources.SAHomeLoans,
                ProductKey = (int)SAHL.Common.Globals.Products.NewVariableLoan,
            ...
            creditCriteriaTestPacks.Add(test_salaried_with_deduction_ltv_90_income_20000_loan_amt_2750000_mil);
				};
