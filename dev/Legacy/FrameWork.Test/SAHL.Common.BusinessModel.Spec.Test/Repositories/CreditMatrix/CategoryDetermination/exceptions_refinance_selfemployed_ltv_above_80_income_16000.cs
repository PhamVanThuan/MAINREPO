...
namespace SAHL.Common.BusinessModel.Spec.Test.Repositories.CreditMatrix.CategoryDetermination
{
    ...
    public class exceptions_refinance_selfemployed_ltv_above_80_income_16000 : CreditCriteriaTestBase
    {
        ...
        Establish context = () =>
        {
            ...
            CreditCriteriaDetermineTest test_Refinance_SelfEmployed_ltv_above_80_income_16000 = new CreditCriteriaDetermineTest
            {
            ...
            creditCriteriaTestPacks.Add(test_Refinance_SelfEmployed_ltv_above_80_income_16000);
        };
