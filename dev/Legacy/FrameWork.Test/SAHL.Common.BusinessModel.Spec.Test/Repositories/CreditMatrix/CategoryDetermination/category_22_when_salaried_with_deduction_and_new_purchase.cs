...
{
	public class category_22_when_salaried_with_deduction_and_new_purchase : CreditCriteriaTestBase
	{	
        ...
        Establish context = () =>
        {
            ...
            CreditCriteriaDetermineTest test_salaried_with_deduction_ltv_100_income_8000_loan_amt_1600000_mil = new CreditCriteriaDetermineTest
            {
                EmploymentTypeKey = 3,
                ...
                LTV = 100,
                Income = 10000,
                ExpectedCategoryKey = 22,
                MortgageLoanPurposeKey = 3,
				CreditCriteriaAttributeTypeKey = 4
            };
            creditCriteriaTestPacks.Add(test_salaried_with_deduction_ltv_100_income_8000_loan_amt_1600000_mil);
				};
