...
{
	public class category_2_when_salaried_and_new_purchase : CreditCriteriaTestBase
	{	
        ...
        Establish context = () =>
        {
            ...
            CreditCriteriaDetermineTest test_salaried_ltv_80_income_8000_loan_amt_1800000_mil = new CreditCriteriaDetermineTest
            {
                EmploymentTypeKey = 1,
                ...
                LTV = 80,
                Income = 8000,
                ExpectedCategoryKey = 2,
                MortgageLoanPurposeKey = 3,
				CreditCriteriaAttributeTypeKey = 1
            };
            creditCriteriaTestPacks.Add(test_salaried_ltv_80_income_8000_loan_amt_1800000_mil);
				};
