...
{
	public class category_3_when_salaried_and_new_purchase : CreditCriteriaTestBase
	{	
        ...
        Establish context = () =>
        {
            ...
            CreditCriteriaDetermineTest test_salaried_ltv_85_income_20000_loan_amt_1800000_mil = new CreditCriteriaDetermineTest
            {
                EmploymentTypeKey = 1,
            ...
            creditCriteriaTestPacks.Add(test_salaried_ltv_85_income_20000_loan_amt_1800000_mil);
					
            CreditCriteriaDetermineTest test_salaried_ltv_85_income_20000_loan_amt_2750000_mil = new CreditCriteriaDetermineTest
            {
                EmploymentTypeKey = 1,
                OriginationSourceKey = (int)SAHL.Common.Globals.OriginationSources.SAHomeLoans,
                ProductKey = (int)SAHL.Common.Globals.Products.NewVariableLoan,
            ...
            creditCriteriaTestPacks.Add(test_salaried_ltv_85_income_20000_loan_amt_2750000_mil);
				};
