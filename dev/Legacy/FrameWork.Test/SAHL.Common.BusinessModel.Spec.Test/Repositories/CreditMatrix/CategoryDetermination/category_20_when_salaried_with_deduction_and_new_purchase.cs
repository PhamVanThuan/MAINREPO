...
{
	public class category_20_when_salaried_with_deduction_and_new_purchase : CreditCriteriaTestBase
	{	
        ...
        Establish context = () =>
        {
            ...
            CreditCriteriaDetermineTest test_salaried_with_deduction_ltv_90_income_8000_loan_amt_1600000_mil = new CreditCriteriaDetermineTest
            {
                EmploymentTypeKey = 3,
                ...
                LTV = 90,
                Income = 8000,
                ExpectedCategoryKey = 20,
                MortgageLoanPurposeKey = 3,
				CreditCriteriaAttributeTypeKey = 4
            };
            creditCriteriaTestPacks.Add(test_salaried_with_deduction_ltv_90_income_8000_loan_amt_1600000_mil);
				};
