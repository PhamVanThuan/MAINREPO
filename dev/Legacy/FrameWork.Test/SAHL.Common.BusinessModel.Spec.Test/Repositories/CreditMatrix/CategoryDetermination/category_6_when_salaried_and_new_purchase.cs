...
{
	public class category_6_when_salaried_and_new_purchase : CreditCriteriaTestBase
	{	
        ...
        Establish context = () =>
        {
            ...
            CreditCriteriaDetermineTest test_salaried_ltv_85_income_8000_loan_amt_1600000_mil = new CreditCriteriaDetermineTest
            {
                EmploymentTypeKey = 1,
            ...
            creditCriteriaTestPacks.Add(test_salaried_ltv_85_income_8000_loan_amt_1600000_mil);
				};
