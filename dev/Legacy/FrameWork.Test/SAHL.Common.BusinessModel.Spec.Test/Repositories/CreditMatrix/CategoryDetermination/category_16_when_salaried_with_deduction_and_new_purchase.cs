...
{
	public class category_16_when_salaried_with_deduction_and_new_purchase : CreditCriteriaTestBase
	{	
        ...
        Establish context = () =>
        {
            ...
            CreditCriteriaDetermineTest test_salaried_with_deduction_ltv_95_income_20000_loan_amt_1800000_mil = new CreditCriteriaDetermineTest
            {
                EmploymentTypeKey = 3,
                ...
                LTV = 95,
                Income = 20000,
                ExpectedCategoryKey = 16,
                MortgageLoanPurposeKey = 3,
				CreditCriteriaAttributeTypeKey = 4
            };
            creditCriteriaTestPacks.Add(test_salaried_with_deduction_ltv_95_income_20000_loan_amt_1800000_mil);
				};
