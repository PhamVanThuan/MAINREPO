...
{
    public class category_0_when_salaried : CreditCriteriaTestBase
    {
        ...
        private Establish context = () =>
        {
            ...
            //Cat 0 - salaried - new purchase - 5 million
            CreditCriteriaAssertTest test_Newpurchase_loan_amt_5_mil_salaried = new CreditCriteriaAssertTest
            {
                EmploymentTypeKey = (int)SAHL.Common.Globals.EmploymentTypes.Salaried,
                OriginationSourceKey = (int)SAHL.Common.Globals.OriginationSources.SAHomeLoans,
                ProductKey = (int)SAHL.Common.Globals.Products.NewVariableLoan,
                TotalLoanAmount = 5000000D,
                CategoryKey = (int)SAHL.Common.Globals.Categories.Category0,
                MortgageLoanPurposeKey = (int)SAHL.Common.Globals.MortgageLoanPurposes.Newpurchase,
                ExpectedPTI = 25
            };
            creditCriteriaTestPacks.Add(test_Newpurchase_loan_amt_5_mil_salaried);

            //Cat 0 - salaried - switch - 5 million
            CreditCriteriaAssertTest test_switch_loan_amt_5_mil_salaried = new CreditCriteriaAssertTest
            {
                EmploymentTypeKey = (int)SAHL.Common.Globals.EmploymentTypes.Salaried,
                OriginationSourceKey = (int)SAHL.Common.Globals.OriginationSources.SAHomeLoans,
                ProductKey = (int)SAHL.Common.Globals.Products.NewVariableLoan,
            ...
            creditCriteriaTestPacks.Add(test_switch_loan_amt_5_mil_salaried);

            //Cat 0 - salaried - refinance - 5 million
            CreditCriteriaAssertTest test_refinance_loan_amt_5_mil_salaried = new CreditCriteriaAssertTest
            {
                EmploymentTypeKey = (int)SAHL.Common.Globals.EmploymentTypes.Salaried,
                OriginationSourceKey = (int)SAHL.Common.Globals.OriginationSources.SAHomeLoans,
                ProductKey = (int)SAHL.Common.Globals.Products.NewVariableLoan,
            ...
            creditCriteriaTestPacks.Add(test_refinance_loan_amt_5_mil_salaried);
        };
