...
{
    public class category_8_when_salaried : CreditCriteriaTestBase
    {
        ...
        private Establish context = () =>
        {
            ...
            CreditCriteriaAssertTest test_Newpurchase_loan_amt_1p6_mil_salaried = new CreditCriteriaAssertTest
            {
                ...
                CategoryKey = (int)SAHL.Common.Globals.Categories.Category8,
        ...
        private It should_return_expected_PTI_for_category_8 = () =>
        {
