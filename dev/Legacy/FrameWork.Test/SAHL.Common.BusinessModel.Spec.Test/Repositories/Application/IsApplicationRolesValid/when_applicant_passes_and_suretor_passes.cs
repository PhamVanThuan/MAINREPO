...
{
    [Subject("when_applicant_and_suretor_fail")]
    public class when_applicant_passes_and_suretor_passes : WithFakes
    {
        ...
        Establish context = () =>
        {
            ...
            applicant.WhenToldTo(x => x.ValidateEntity()).Return(true);
            suretor.WhenToldTo(x => x.ValidateEntity()).Return(true);
