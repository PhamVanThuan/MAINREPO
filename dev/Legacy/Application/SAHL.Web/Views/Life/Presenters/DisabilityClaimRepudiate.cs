...
{
    public class DisabilityClaimRepudiate : CommonReasonBase
    {
        private IV3ServiceManager v3ServiceManager;
        private ILifeDomainService lifeDomainService;

        public DisabilityClaimRepudiate(ICommonReason view, SAHLCommonBaseController controller)
        ...
        protected override void _view_OnSubmitButtonClicked(object sender, SAHL.Common.Web.UI.Events.KeyChangedEventArgs e)
        {
            ...
            {                
                ...
                RepudiateDisabilityClaimCommand repudiateDisabilityClaimCommand = new RepudiateDisabilityClaimCommand(base.GenericKey, base.InsertedReasonKeys);
                systemMessageCollection = lifeDomainService.PerformCommand(repudiateDisabilityClaimCommand);
