<%@ Page Language="C#" MasterPageFile="~/MasterPages/Blank.Master" AutoEventWireup="true" CodeBehind="LoanCalculator.aspx.cs" Inherits="SAHL.Web.Views.Origination.LoanCalculator" Title="Untitled Page" %>
...
function setupLoanPurpose()
{
    ...
    var chkCapitaliseFees = document.getElementById('<%=chkCapitaliseFees.ClientID%>');
    ...
    switch(purposeType)
    {
        ...
        case "3": //New purchase
            ...
            chkCapitaliseFees.checked = false;
            break;
        case "4": //Refinance
            rMarketValue.style.display = "inline";
            rCapitaliseFees.style.display = "inline";
...
function setupProduct()
{
    ...
    //var rInterestOnly = document.getElementById('< %=rowInterestOnly.ClientID%>');
    ...
    switch(productType)
    {
        case "2": //VariFix
            ...
            //rInterestOnly.style.display = "none";
            tbLoanTerm.value = 240;
            tbLoanTerm.disabled = false;
            break;
//        case "5": //SuperLo
//            rInterestOnly.style.display = "inline";
//            rVarifix.style.display = "none";
//            break;
        case "11": //Edge
            //rInterestOnly.style.display = "none";
...
function updateVal(control)
{
    ...
    var val = SAHLCurrencyBox_getValue(control);
    
    if(control == tbCashOut || control == tbCashRequired)
    {
        SAHLCurrencyBox_setValue('<%=tbCashOut.ClientID%>', val);
        SAHLCurrencyBox_setValue('<%=tbCashRequired.ClientID%>', val);
    }
    
    if (control == tbPurchasePrice || control == tbMarketValue)
    {
        SAHLCurrencyBox_setValue('<%=tbPurchasePrice.ClientID%>', val);
        SAHLCurrencyBox_setValue('<%=tbMarketValue.ClientID%>', val);
    }
...
function SetCreateApplication(enabled, calcReset)
{
    ...
    var btnCreateApplication = document.getElementById('<%=btnCreateApplication.ClientID%>');
    if (btnCreateApplication != null)
    ...
    <table style="width: 98%" class="tableStandard">
                ...
                <asp:Panel ID="pnlInput" runat="server" GroupingText="Calculator" Width="380px">
                    <table>
                        <tr>
                            ...
                            <td>
                                <SAHL:SAHLDropDownList ID="ddlMarketingSource" runat="server" 
									CssClass="mandatory" />
                            </td>
                            <td>
								<img alt="" title="Where did this person get to hear about us." src="../../Images/help.gif" align="middle" />
							</td>
                        </tr>
                        <tr>
							<td align="right">
							...
							<td style="width:10px;">
								&nbsp;</td>
							<td>
								<SAHL:SAHLDropDownList ID="ddlPurpose" runat="server" CssClass="mandatory" 
									OnChange="setupLoanPurpose();">
                        ...
                        <tr>
                            ...
                            <td style="width:10px;">&nbsp;</td>
                            <td>
                                <SAHL:SAHLDropDownList ID="ddlProduct" runat="server" OnChange="setupProduct();" CssClass="mandatory"/>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr id="rowCashOut" runat="server">
                            ...
                            <td style="width:10px;">&nbsp;</td>
                            <td><SAHL:SAHLCurrencyBox ID="tbCashOut" runat="server" Width="80px" ></SAHL:SAHLCurrencyBox></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td style="width:10px;">&nbsp;</td>
                            <td>
                            <SAHL:SAHLTextBox ID="tbLoanTerm" runat="server" MaxLength="3" Width="30px" CssClass="mandatory" OnChange="SetCreateApplication(false, true);" DisplayInputType="Number" >240</SAHL:SAHLTextBox>
                            </td>
                            <td>
                        ...
                        <tr id="rowCapitaliseFees" runat="server">
                            <td align="right">Capitalise Fees:</td>
                            <td style="width:10px;">&nbsp;</td>
                            <td><asp:CheckBox ID="chkCapitaliseFees" runat="server" OnChange="SetCreateApplication(false, true);" /></td>
                        ...
                        <%--<tr id="rowInterestOnly" runat="server">
                            <td align="right">Interest Only:</td>
                            <td style="width:10px;">&nbsp;</td>
                            <td><asp:CheckBox ID="chkInterestOnly" runat="server" OnChange="SetCreateApplication(false, true);" /></td>
                        ...
                        <tr id="rowVariFixReset" runat="server">
                            ...
                            <td style="width:10px;">&nbsp;</td>
                            <td>
                            <asp:CheckBox ID="chkVFReset5Year" runat="server" Checked="true" OnClick="SetCreateApplication(false, true);SetResetPeriod(this);" Text="5 yrs" Enabled="false"/>
                            &nbsp;
                        ...
                        <tr>
                            ...
                            <td style="width:10px;">&nbsp;</td>
                            <td><asp:CheckBox ID="chkOMLDeveloperLoan" runat="server" /></td>
                        </tr>
                    </table>
                </asp:Panel>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td bgcolor="#ffbb00" class="FormHeading" valign="middle" runat="server" id="tdInterestOnlyColumnHeader">
                                                    <SAHL:SAHLLabel ID="lblColumnHeader2" runat="server">Interest Only</SAHL:SAHLLabel></td>
                                            </tr>
                                            <tr>
        ...
        <tr>
            <td colspan="2" align="right">
                <SAHL:SAHLButton ID="btnCalculate" runat="server" Text="Calculate" ButtonSize="Size5" CssClass="BtnNormal4" CausesValidation="false" OnClick="OnCalculate_Click"/>&nbsp;
                <SAHL:SAHLButton ID="btnCancel" runat="server" Text="Cancel" ButtonSize="Size5" CssClass="BtnNormal4" CausesValidation="false" OnClick="OnCancel_Click" />&nbsp;
                <SAHL:SAHLButton ID="btnCreateApplication" runat="server" Text="Create Application" 
                ButtonSize="Size5" CssClass="BtnNormal4" CausesValidation="false" 
                OnClick="OnCreateApplication" Enabled="false" SecurityTag="CalculatorCreateApplication"/>&nbsp;
            </td>
        </tr>
    </table>
</asp:Content>
