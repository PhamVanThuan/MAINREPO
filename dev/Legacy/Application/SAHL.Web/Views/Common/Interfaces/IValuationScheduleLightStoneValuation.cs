...
{
    public interface IValuationScheduleLightstoneValuation : IViewBase
    {
        event EventHandler btnValidatePropertyClicked;

        event EventHandler btnInstructClicked;

        void BindPropertyDetails(IProperty prop);

        void BindPropertyAccessDetails(IPropertyAccessDetails pad);
