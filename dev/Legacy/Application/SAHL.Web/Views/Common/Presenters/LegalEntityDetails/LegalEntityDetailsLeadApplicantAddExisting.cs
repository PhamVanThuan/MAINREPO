...
{
    public class LegalEntityDetailsLeadApplicantAddExisting : LegalEntityDetailsUpdateBase
    {
        public LegalEntityDetailsLeadApplicantAddExisting(ILegalEntityDetails view, SAHLCommonBaseController controller)
