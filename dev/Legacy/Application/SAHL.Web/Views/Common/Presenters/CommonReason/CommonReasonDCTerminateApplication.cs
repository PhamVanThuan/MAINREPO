...
{
    public class CommonReasonDCTerminateApplication : CommonReasonBase
    {
        private IDebtCounsellingRepository _debtCounsellingRepository;

         /// <summary>
        /// Constructpor for CommonReasonDCTerminateApplication
        /// </summary>
        /// <param name="view"></param>
        /// <param name="controller"></param>
        public CommonReasonDCTerminateApplication(ICommonReason view, SAHLCommonBaseController controller)
        ...
        {
            _view.SortByReasonDescription = true;
