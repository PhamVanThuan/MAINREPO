...
{
    /// <summary>
    /// This Viewapplication.ApplicationMailingAddresses
    /// </summary>
    public class ConditionsUpdateSet : SAHLCommonBasePresenter<IConditionsSet>
    {
        ...
        public ConditionsUpdateSet(IConditionsSet view, SAHLCommonBaseController controller)
        ...
        protected override void OnViewInitialised(object sender, EventArgs e)
        {
            ...
            //if(_view.IsMenuPostBack) return;
            ...
            if (!GlobalCacheData.ContainsKey(ViewConstants.ConditionSet))
            {
                if (conditionsRepository != null)
                {
                    ...
                    conditionsRepository.AddNavigateTo = "AddFromEdit";
                    conditionsRepository.CancelNavigateTo = "CancelFromEdit";
                }
        ...
        void btnAddConditionClicked(object sender, EventArgs e)
        {
            ...
            //GlobalCacheData.Remove("UpdateMode");
            //GlobalCacheData.Add("UpdateMode", true, new List<ICacheObjectLifeTime>());
        ...
        void btnUpdateClicked(object sender, EventArgs e)
        {
            ...
            if (UnpopulatedTokenNames.Length == 0)
            {
                ...
                try
                {
                    conditionsRepository.SaveExistingConditionSet((int)Languages.English);
                    GlobalCacheData.Remove("UpdateMode");
                    txn.VoteCommit();
                }
            ...
            if (MustBind)
                for (int x = 0; x < conditionsRepository.ConditionsSet.Tables[0].Rows.Count; x++)
                {
                    ...
                    */
                    ...
                    string OfferConditionKey = conditionsRepository.ConditionsSet.Tables[0].Rows[x][14].ToString();
                    string OfferConditionSetKey = conditionsRepository.ConditionsSet.Tables[0].Rows[x][15].ToString();
                    ...
                    if (Convert.ToBoolean(conditionsRepository.ConditionsSet.Tables[0].Rows[x][11])) // is selected
                    {
                        ...
                        conditionsRepository.ChosenArrayID += "'" + OfferConditionKey + "',";
                        ...
                        conditionsRepository.ChosenArrayOfferConditionSetKeys += "'" + OfferConditionSetKey + "',";
                    }
                    else
                    {
                        ...
                        conditionsRepository.SelectArrayID += "'" + OfferConditionKey + "',";
                        ...
                        conditionsRepository.SelectedArrayOfferConditionSetKeys += "'" + OfferConditionSetKey + "',";
                    }
                }
        }
        ...
        void RegisterClientScripts()
        {
            ...
            //mBuilder.AppendLine("window.addEventListener('unload', deinitIt, false);");
            mBuilder.AppendLine("}");
            mBuilder.AppendLine("else if (window.attachEvent)"); //IE exclusive method for binding an event
            mBuilder.AppendLine("{");
            mBuilder.AppendLine("window.attachEvent('onload', initIt);");
            // mBuilder.AppendLine("window.attachEvent('onunload', deinitIt);");
            mBuilder.AppendLine("}");
            ...
            //mBuilder.AppendLine("window.onunload=deinitIt;");
            mBuilder.AppendLine("}");

            //// basic page de-initialisation function
            //mBuilder.AppendLine("function deinitIt()");
            //mBuilder.AppendLine("{");
            //mBuilder.AppendLine("  chosenList.selectedIndex = -1;");
            //mBuilder.AppendLine("  selectedList.selectedIndex = -1;");
            //mBuilder.AppendLine("Alert('Unload function hit');");
            //mBuilder.AppendLine("}");
            ...
            //mBuilder.AppendLine("alert(SelectArrayStrings[ArrayCount]);");
            mBuilder.AppendLine("  selectOptions[ArrayCount] =  new Option(SelectArrayStrings[ArrayCount].replace(/(\\r\\n|\\n|\\r)/gm, '   '));");
            //mBuilder.AppendLine("  selectOptions[ArrayCount] =  new Option(SelectArrayStrings[ArrayCount]);");
