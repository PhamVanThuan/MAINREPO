<%@ Page Language="C#" MasterPageFile="~/MasterPages/Blank.Master" AutoEventWireup="true" CodeBehind="ValuationScheduleLightStoneValuationView.aspx.cs" Inherits="SAHL.Web.Views.Common.ValuationScheduleLightStoneValuationView" Title="Schedule a LightStone Valuation." EnableViewState="False" %>
            ...
            <tr>
                ...
                <td style="width: 70%">
                    <SAHL:SAHLTextBox ID="txtSpecialInstructions" runat="server" TextMode="MultiLine"
                        Width="90%" Visible="False" Height="76px"></SAHL:SAHLTextBox></td>
            </tr>
