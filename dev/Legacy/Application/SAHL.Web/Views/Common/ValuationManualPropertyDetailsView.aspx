<%@ Page Language="C#" MasterPageFile="~/MasterPages/Blank.Master" AutoEventWireup="true"
    Codebehind="ValuationManualPropertyDetailsView.aspx.cs" Inherits="SAHL.Web.Views.Common.ManualValuationMainDwellingDetails"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">
    ...
    function CottageRoofTypeChanged()
    {
        var cottageRoofType = document.getElementById("<%= ddlCottageRoofType.ClientID %>").options[document.getElementById("<%= ddlCottageRoofType.ClientID %>").selectedIndex].text;

        if (cottageRoofType == '- Please select -')
        {
            document.getElementById('<%=txtCottageExtent.ClientID%>').value = "";
            document.getElementById('<%=txtCottageRate.ClientID%>').value = "";
            document.getElementById('<%=txtCottageReplaceValue.ClientID%>').value = "R 0.00";
        }
    }
    </script>
    ...
    <table width="100%" class="tableStandard">
        <tr>
            <td align="left">
                <SAHLWebControl:AddressGrid ID="PropertyAddressGrid" runat="server" GridHeight="90px"
                    GridWidth="100%" Width="100%" HeaderCaption="Property" PostBackType="SingleClick"
                    NullDataSetMessage="" EmptyDataSetMessage="There are no Properties.">
                </SAHLWebControl:AddressGrid>
                <br />
                <SAHL:SAHLGridView ID="ExtendedDetailsGrid" runat="server" AutoGenerateColumns="false"
                    FixedHeader="false" EnableViewState="false" GridHeight="120px" GridWidth="100%"
                    Width="100%" HeaderCaption="Outbuildings and Improvements" PostBackType="NoneWithClientSelect"
                    NullDataSetMessage="No outbuildings or improvements exist" 
                    EmptyDataSetMessage="No outbuildings or improvements exist" OnRowDataBound="ExtendedDetailsGrid_RowDataBound" >
                                ...
                                <table border="0">
                                    <tr>
                                        ...
                                        <td style="width: 210px">
                                            ...
                                            <SAHL:SAHLDropDownList ID="ddlMainBuildingClassification" runat="server" AutoPostBack="false"
                                                PleaseSelectItem="true" Width="185px">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 210px">
                                            ...
                                            <SAHL:SAHLDropDownList ID="ddlMainBuildingRoofType" runat="server" AutoPostBack="false"
                                                PleaseSelectItem="true" Width="185px">
                                            </SAHL:SAHLDropDownList>&nbsp;
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="width: 210px">
                                            ...
                                            <SAHL:SAHLTextBox ID="txtMainBuildingExtent" runat="server" DisplayInputType="Number"
                                                AutoPostBack="false">
                                            </SAHL:SAHLTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="width: 210px">
                                            ...
                                            <SAHL:SAHLTextBox ID="txtMainBuildingRate" runat="server" DisplayInputType="Currency"
                                                AutoPostBack="false">
                                            </SAHL:SAHLTextBox>
                                        </td>
                                    </tr>
                                ...
                                <table border="0">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <SAHL:SAHLDropDownList ID="ddlCottageRoofType" runat="server" AutoPostBack="false"
                                                PleaseSelectItem="true" Width="115px" >
                                            </SAHL:SAHLDropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <SAHL:SAHLTextBox ID="txtCottageExtent" runat="server" DisplayInputType="Number"
                                                AutoPostBack="false" Width="100px"></SAHL:SAHLTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="TitleText" style="width: 210px">
                                        ...
                                        <td>
                                            ...
                                            <SAHL:SAHLTextBox ID="txtCottageRate" runat="server" DisplayInputType="Currency"
                                                AutoPostBack="false" Width="100px"></SAHL:SAHLTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                ...
                <table border="0" id="AdditionsTable" runat="server">
                    <tr id="trBuildingType" runat="server" style="width: 390px">
                        <td class="TitleText" style="width: 210px">
                            Building Type</td>
                        <td>
                            <SAHL:SAHLDropDownList ID="ddlBuildingType" runat="server" PleaseSelectItem="false"
                                AutoPostBack="true" Width="190px" OnSelectedIndexChanged="ddlBuildingType_SelectedIndexChanged">
                    ...
                    <tr>
                        <td valign="top" colspan="3" style="width: 390px">
                            <asp:Panel ID="CombinedOutbuildingsPanel" runat="server" GroupingText="Combined Outbuilding"
                                Width="390px">
                                <table border="0" id="TABLE1">
                                    <tr id="CombinedOutbuildingRoofType" runat="server">
                                        ...
                                        <td>
                                            ...
                                            <SAHL:SAHLDropDownList ID="ddlCombinedOutbuildingsRoofType" runat="server" AutoPostBack="false"
                                                PleaseSelectItem="true" Width="110px">
                                            </SAHL:SAHLDropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="width: 210px">
                                            ...
                                            <SAHL:SAHLTextBox ID="txtCombinedOutbuildingsExtent" runat="server" DisplayInputType="Number"
                                                AutoPostBack="false">
                                            </SAHL:SAHLTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="width: 210px">
                                            ...
                                            <SAHL:SAHLTextBox ID="txtCombinedOutbuildingsRate" runat="server" DisplayInputType="Currency"
                                                AutoPostBack="false">
                                            </SAHL:SAHLTextBox>
                                        </td>
                                    </tr>
                        ...
                        <td>
                            <asp:Panel ID="CombinedImprovementsPanel" runat="server" GroupingText="Combined Improvements"
                                Width="360px">
                                <table border="0">
                                    <tr id="CombinedImprovementType" runat="server">
                                        ...
                                        <td>
                                            <SAHL:SAHLDropDownList ID="ddlCombinedImprovementType" runat="server" AutoPostBack="false"
                                                PleaseSelectItem="true" Width="120px">
                                            </SAHL:SAHLDropDownList>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <SAHL:SAHLTextBox ID="txtCombinedImprovementsReplaceValue" runat="server" DisplayInputType="Currency"
                                                AutoPostBack="false"></SAHL:SAHLTextBox>
                                        </td>
                                    </tr>
                                </table>
                            </asp:Panel>
                ...
                <table>
                    <tr>
                        <td valign="top" style="width: 390px">
                            <asp:Panel ID="CombinedThatchPanel" runat="server" GroupingText="Combined Thatch"
                                Width="390px">
                                <table border="0" style="width: 390px">
                                    <tr id="CombinedThatchValueRow">
                                        ...
                                        <td style="width: 220px">
                                            ...
                                            <SAHL:SAHLTextBox ID="txtCombinedThatchValue" runat="server" DisplayInputType="Currency"
                                                AutoPostBack="false">
                                            </SAHL:SAHLTextBox>
                                        </td>
                                    </tr>
                                    ...
                                    <tr id="CombinedThatchExtentRow" runat="server">
                                        ...
                                        <td style="width: 200px">
                                            <SAHL:SAHLLabel ID="lblCombinedThatchExtCheck" runat="server">-</SAHL:SAHLLabel>
                                        </td>
                                    </tr>
                                </table>
                            </asp:Panel>
                        ...
                        <td valign="top" style="width: 360px">
                            <table border="0" id="tblValuation" runat="server" style="width: 353px">
                                <tr id="ValuationEscalation">
                                    ...
                                    <td>
                                        <SAHL:SAHLTextBox ID="txtEscalation" runat="server" DisplayInputType="Currency" AutoPostBack="false"
                                            Width="110px">20</SAHL:SAHLTextBox>
                                    </td>
                                </tr>
                                ...
                                <table border="0">
                                    <tr id="trImprovement" runat="server">
                                        ...
                                        <td>
                                            ...
                                            <SAHL:SAHLDropDownList ID="ddlImprovementType" runat="server" AutoPostBack="false"
                                                PleaseSelectItem="true" Width="110px">
                                            </SAHL:SAHLDropDownList>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <SAHL:SAHLTextBox ID="txtImprovementReplacementValue" runat="server" DisplayInputType="Currency"
                                                AutoPostBack="false"></SAHL:SAHLTextBox>
                                        </td>
                                    </tr>
                                </table>
        ...
        <tr id="ButtonRow" runat="server">
            <td align="center" style="width: 100%">
                ...
                <SAHL:SAHLButton ID="BackButton" runat="server" Text="Back" AccessKey="B" CausesValidation="False"
                    OnClick="BackButton_Click" />
                <SAHL:SAHLButton ID="AddButton" runat="server" Text="Add Entry" AccessKey="A" CausesValidation="true"
                    OnClick="Add_ButtonClicked" />
                <SAHL:SAHLButton ID="RemoveButton" runat="server" Text="Remove Entry" AccessKey="U"
                    CausesValidation="true" ButtonSize="Size5" OnClick="Remove_ButtonClick" />
