...
{
    public partial class PersonalLoanChangeTerm : SAHLCommonBaseView, IPersonalLoanChangeTerm
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            btnSubmit.Attributes["onclick"] = "if(!confirm('Are you sure you would like to Process Term Change for this Account ?')) return false";
        }
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            lblMaxTerm.Text = "(Max: " + _accountPersonalLoan.MaxNewRemainingInstalmentsAllowed.ToString() + " months)";
        ...
        /// <summary>
        /// Term Captured on Screen
        /// </summary>
        public int CapturedTerm
        {
            set 
            { 
                txtNewRemainingTerm.Text = value.ToString(); 
            }
            get
            {
                return txtNewRemainingTerm.Text.Length > 0 ? int.Parse(txtNewRemainingTerm.Text) : 0;
            }
        }
