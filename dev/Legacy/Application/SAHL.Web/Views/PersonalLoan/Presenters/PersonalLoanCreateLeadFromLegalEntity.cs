...
{
    public class PersonalLoanCreateLeadFromLegalEntity : SAHL.Web.Views.Common.Presenters.LegalEntityDetails.LegalEntityDetailsAddBase
    {
        public PersonalLoanCreateLeadFromLegalEntity(ILegalEntityDetails view, SAHLCommonBaseController controller)
        ...
        protected override void OnViewInitialised(object sender, EventArgs e)
        {
            ...
            // Bind LegalEntity Types  - Only NaturalPerson
            IDictionary<string, string> letypes = new Dictionary<string, string>();
            letypes.Add(Convert.ToString((int)LegalEntityTypes.NaturalPerson), LegalEntityTypes.NaturalPerson.ToString());
            _view.BindLegalEntityTypes(letypes, Convert.ToString((int)LegalEntityTypes.NaturalPerson));

            // Bind Citizen TYpe - South African only ( this will force id number validation)
            IDictionary<string, string> citizenTypes = new Dictionary<string, string>();
            citizenTypes.Add(Convert.ToString((int)CitizenTypes.SACitizen), CitizenTypes.SACitizen.ToString());
            _view.BindCitizenType(citizenTypes, Convert.ToString((int)CitizenTypes.SACitizen));
        }
        ...
        protected override void SubmitButtonClicked(object sender, EventArgs e)
        {
            ...
            using (TransactionScope transactionScope = new TransactionScope())
            {
                try
                {
                    ...
                    this.ExclusionSets.Add(RuleExclusionSets.PersonalLoanCreateLeadFromNewLegalEntity);                    
