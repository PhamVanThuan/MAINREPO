...
namespace SAHL.Web.Views.Administration.Presenters.DebtCounselling
{
    ...
    /// 
    /// </summary>
    public class PaymentDistributionAgentView : PaymentDistributionAgentBase
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public PaymentDistributionAgentView(IExternalOrganisationStructure view, SAHLCommonBaseController controller)
