...
namespace SAHL.Web.Views.Administration.Presenters.DebtCounselling
{
    ...
    ///
    /// </summary>
    public class PaymentDistributionAgentBase : SAHLCommonBasePresenter<IExternalOrganisationStructure>
    {
        ...
        public PaymentDistributionAgentBase(IExternalOrganisationStructure view, SAHLCommonBaseController controller)
        ...
        protected override void OnViewInitialised(object sender, EventArgs e)
        {
            ...
            _view.TreeViewHeading = "Payment Distribution Agencies / Agents";
        ...
        {
            IControl ct = CTRepo.GetControlByDescription("PaymentDistributionAgenciesRoot");
        ...
        void TreeNodeDragged(object sender, TreeListNodeDragEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    // Add exclusion set
                    this.ExclusionSets.Add(RuleExclusionSets.PaymentDistributionAgentDragDrop);

                    // current node details
                    IPaymentDistributionAgentOrganisationNode currentPaymentDistributionAgentOrganisationNode = DebtCounsellingRepo.GetPaymentDistributionAgentOrganisationNodeForKey(currentOrgStructureKey);
                    ILegalEntity currentLegalEntity = LegalEntityRepo.GetLegalEntityByKey(currentLegalEntityKey);
                    // target node details                    
                    IPaymentDistributionAgentOrganisationNode targetPaymentDistributionAgentOrganisationNode = DebtCounsellingRepo.GetPaymentDistributionAgentOrganisationNodeForKey(targetOrgStructureKey);

                    // do the move
                    IPaymentDistributionAgentOrganisationNode paymentDistributionAgentOrganisationNode = currentPaymentDistributionAgentOrganisationNode.MoveMe(targetPaymentDistributionAgentOrganisationNode, currentLegalEntity);

                    //save the new org structure
                    DebtCounsellingRepo.SavePaymentDistributionAgentOrganisationStructure(paymentDistributionAgentOrganisationNode);

                    this.ExclusionSets.Remove(RuleExclusionSets.PaymentDistributionAgentDragDrop);
