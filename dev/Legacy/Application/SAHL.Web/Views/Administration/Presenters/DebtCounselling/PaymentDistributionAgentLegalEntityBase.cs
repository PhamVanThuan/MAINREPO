...
{
    /// <summary>
    /// PaymentDistributionAgentLegalEntity Base
    /// </summary>
    public class PaymentDistributionAgentLegalEntityBase : SAHLCommonBasePresenter<IExternalOrganisationStructureLegalEntity>
    {
        #region Constants
        ...
        public PaymentDistributionAgentLegalEntityBase(IExternalOrganisationStructureLegalEntity view, SAHLCommonBaseController controller)
        ...
        public IDictionary<string, string> LENPRoleTypes
        {
            get
            {
                if (_lenpRoleTypes == null)
                {
                    ...
                    _lenpRoleTypes.Add(SAHL.Common.Constants.PaymentDistributionAgent.Contact, SAHL.Common.Constants.PaymentDistributionAgent.Contact);
                }
        ...
        private IPaymentDistributionAgentOrganisationNode _osSel;
        public IPaymentDistributionAgentOrganisationNode SelectedOrgNode
        {
            get
            {
                if (_osKeySet && _osKey > 0)
                {
                    if (_osSel == null)
                        _osSel = (IPaymentDistributionAgentOrganisationNode)DebtCounsellingRepo.GetPaymentDistributionAgentOrganisationNodeForKey(_osKey);
        ...
        private IPaymentDistributionAgentOrganisationNode _osParent;
        public IPaymentDistributionAgentOrganisationNode SelectedParentOrgNode
        {
            get
            {
                ...
                {
                    if (_osParent == null)
                        _osParent = (IPaymentDistributionAgentOrganisationNode)DebtCounsellingRepo.GetPaymentDistributionAgentOrganisationNodeForKey(_osKeyParent);
        ...
        protected List<ICacheObjectLifeTime> LifeTimes
        {
            get
            {
                if (_lifeTimes == null)
                {
                    ...
                    views.Add("AdminPaymentDistributionAgentLegalEntityAdd");
                    views.Add("AdminPaymentDistributionAgentLegalEntityUpdate");
                    views.Add("AdminPaymentDistributionAgentLegalEntityView");
                    views.Add("AdminPaymentDistributionAgentLegalEntityRemove");
