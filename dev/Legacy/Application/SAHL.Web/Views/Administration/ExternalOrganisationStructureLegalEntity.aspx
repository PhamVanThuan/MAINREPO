<%@ Page Language="C#" MasterPageFile="~/MasterPages/Blank.Master" AutoEventWireup="true"
    CodeBehind="ExternalOrganisationStructureLegalEntity.aspx.cs" Inherits="SAHL.Web.Views.Administration.ExternalOrganisationStructureLegalEntity"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">
    ...
    <table class="tableStandard" width="100%">
        <tr style="width: 100%">
            <td>
                <SAHL:SAHLLabel ID="lblParentOrgStructureType" runat="server" CssClass="LabelText"
                    Font-Bold="True"></SAHL:SAHLLabel>
                <SAHL:SAHLLabel ID="lblParentOrgStructure" runat="server" CssClass="LabelText"></SAHL:SAHLLabel>
            </td>
        </tr>
        <tr style="width: 100%">
            <td>
                <SAHL:SAHLLabel ID="lblBlankSpacer" runat="server"> </SAHL:SAHLLabel>
            </td>
        </tr>
        <tr style="width: 100%">
                                                        ...
                                                        <td>
                                                            <asp:Panel ID="pnlAdd" runat="server" Width="100%">
                                                                <table id="tblLegalEntityType" class="tableStandard" width="100%">
                                                                    ...
                                                                    <tr id="trNCRDCRegNumber" runat="server">
                                                                        <td id="NCRDCRegNumber" runat="server" class="TitleText">
                                                                            NCR DC Registration Number
                                                                        </td>
                                                                        <td>
                                                                            <SAHL:SAHLLabel ID="lblNCRDCRegNumber" runat="server" CssClass="LabelText">-</SAHL:SAHLLabel>
                                                                            <SAHL:SAHLTextBox ID="NCRDCRegNumberUpdate" runat="server" MaxLength="20" Width="80%"
                                                                ...
                                                                <asp:Panel ID="pnlCompanyAdd" runat="server" Width="100%" Visible="false">
                                                                    <table width="100%" class="tableStandard">
                                                                        <tr>
                                                                            ...
                                                                            <td class="cellDisplay" style="width: 70%;">
                                                                                ...
                                                                                <SAHL:SAHLDropDownList ID="ddlOrganisationType" runat="server" PleaseSelectItem="False"
                                                                                    AutoPostBack="true" OnSelectedIndexChanged="ddlOrganisationType_SelectedIndexChanged"
                                                                                    Width="80%" TabIndex="10" SecurityTag="LegalEntityRoleTypeChange" SecurityDisplayType="Disable">
                                                                                </SAHL:SAHLDropDownList>
                                                                            </td>
                                                                        </tr>
                                                                        <tr id="trCOIntroductionDate" runat="server">
                                                                            <td class="TitleText">
                                                                                Introduction Date
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td id="tdCORegisteredName" runat="server" class="TitleText">
                                                                                Company Name
                                                                            </td>
                                                                            <td>
                                                                        ...
                                                                        <tr id="trCOTradingName" runat="server">
                                                                            <td class="TitleText">
                                                                                Trading Name
                                                                            </td>
                                                                            <td>
                                                                        ...
                                                                        <tr id="trCORegNumber" runat="server">
                                                                            ...
                                                                            <td>
                                                                                <SAHL:SAHLLabel ID="lblWorkPhone" runat="server" CssClass="LabelText">-</SAHL:SAHLLabel><SAHL:SAHLTextBox
                                                                                    ...
                                                                                    TabIndex="112" Width="42px"></SAHL:SAHLTextBox><SAHL:SAHLTextBox ID="txtWorkPhoneNumber"
                                                                                        runat="server" DisplayInputType="Number" MaxLength="15" TabIndex="113" Width="136px"></SAHL:SAHLTextBox>
                                                                            </td>
                                                                        </tr>
                                                                            ...
                                                                            <td>
                                                                                <SAHL:SAHLLabel ID="lblFaxNumber" runat="server" CssClass="LabelText">-</SAHL:SAHLLabel><SAHL:SAHLTextBox
                                                                                    ...
                                                                                    Width="42px"></SAHL:SAHLTextBox><SAHL:SAHLTextBox ID="txtFaxNumber" runat="server"
                                                                                        DisplayInputType="Number" MaxLength="15" TabIndex="115" Width="136px"></SAHL:SAHLTextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr id="trCellPhone" runat="server">
                                                                            <td class="TitleText">
                                                                                Cellphone No
                                                                            </td>
                                                                            <td>
                                                                                <SAHL:SAHLLabel ID="lblCellphoneNumber" runat="server" CssClass="LabelText">-</SAHL:SAHLLabel><SAHL:SAHLTextBox
                                                                                    ...
                                                                                    TabIndex="116" Width="182px" CssClass="mandatory"></SAHL:SAHLTextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr id="trEmailAddress" runat="server">
                                                                            ...
                                                                            <td>
                                                                                <SAHL:SAHLLabel ID="lblEmailAddress" runat="server" CssClass="LabelText">-</SAHL:SAHLLabel><SAHL:SAHLTextBox
                                                                                    ...
                                                                                    TabIndex="117" Width="182px" CssClass="mandatory"></SAHL:SAHLTextBox>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </asp:Panel>
                                                            ...
                                                            <table id="Table1" runat="server" class="tableStandard" width="100%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <SAHL:SAHLDateBox ID="dtEffectiveDate" runat="server" Mandatory="true" CssClass="mandatory"></SAHL:SAHLDateBox>
                                                                    </td>
                                                                    <td class="TitleText">
                                                                        &nbsp;
                                                                    </td>
