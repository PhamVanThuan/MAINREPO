<%@ Page Language="C#" AutoEventWireup="True" Inherits="TimeoutError" Codebehind="TimeoutError.aspx.cs" %>
<%@ Register Assembly="SAHL.Common.Web.UI" Namespace="SAHL.Common.Web.UI.Controls" TagPrefix="SAHL" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>HALO :: Timeout</title>
...
<body class="Error">
    <form id="Form1" action="Default.aspx" runat="server">
        ...
        <div id="content">
            ...
            <h2 style="padding-top:5px;">Timeout</h2>
            <hr size="1" />
            The application has timed out due to user inactivity.  Click the button below to begin working again.
            <div id="buttonsPanel">
