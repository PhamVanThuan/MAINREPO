...
{
    public class ClientCommunicationPersonalLoansSMS : ClientCommunicationPersonalLoansSMSControls
    {
        private readonly IWatiNService watinService;

        public ClientCommunicationPersonalLoansSMS()
        {
        ...
        /// <summary>
        /// Check all the checkboxes in the recipients grid.
        /// </summary>
