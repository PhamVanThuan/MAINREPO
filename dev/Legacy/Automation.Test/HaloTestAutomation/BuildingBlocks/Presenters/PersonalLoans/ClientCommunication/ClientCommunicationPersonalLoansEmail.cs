...
{
    public class ClientCommunicationPersonalLoansEmail : ClientCommunicationPersonalLoansEmailControls
    {
        private readonly IWatiNService watinService;

        public ClientCommunicationPersonalLoansEmail()
        {
        ...
        public void Populate(string emailSubject, string emailMessage)
        {
            ...
            element.innerText = emailMessage;
        }
