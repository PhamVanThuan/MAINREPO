...
{
    public abstract class AdminPaymentDistributionAgentViewControls : BasePageControls
    {
        ...
        protected Span Description(string Description)
        {
            return base.Document.Span(Find.ByText(Description));
        }
