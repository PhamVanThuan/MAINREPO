...
{
    [RequiresSTA]
    public class CreditWorkflowEmploymentTypeConfirmation : OriginationTestBase<BasePage>
    {
        ...
        protected override void OnTestFixtureSetup()
        {
            ...
            base.Browser = new TestBrowser(TestUsers.CreditSupervisor);
        ...
        protected override void OnTestStart()
        {
            base.Browser.Page<BuildingBlocks.Presenters.CommonPresenters.WorkflowSuperSearch>().SearchByUniqueIdentifierAndApplicationType(base.Browser, offerKey.ToString()
                , new string[] { WorkflowStates.CreditWF.Credit }, ApplicationType.Any);
        }
        ...
        public void when_confirming_application_employment()
        {
            ...
            base.Browser.Page<BuildingBlocks.Presenters.Origination.ConfirmApplicationEmployment>().AssertApplicationEmploymentActionCompleted(offerKey, Workflows.Credit);
            ...
            BuildingBlocks.Assertions.StageTransitionAssertions.AssertStageTransitionCreated(offerKey, StageDefinitionStageDefinitionGroupEnum.Credit_ConfirmapplicationEmployment);
        }
    }
}