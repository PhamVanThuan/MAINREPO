...
this IDbConnection cnn, string sql, Func<TFirst, TSecond, TReturn> map, dynamic param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = null
        ...
        {
            return MultiMap<TFirst, TSecond, DontMap, DontMap, DontMap,DontMap,DontMap,DontMap,DontMap, TReturn>(cnn, sql, map, param as object, transaction, buffered, splitOn, commandTimeout, commandType);
        }
...
this IDbConnection cnn, string sql, Func<TFirst, TSecond, TThird, TReturn> map, dynamic param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = null
        ...
        {
            return MultiMap<TFirst, TSecond, TThird, DontMap, DontMap, DontMap, DontMap, DontMap,DontMap, TReturn>(cnn, sql, map, param as object, transaction, buffered, splitOn, commandTimeout, commandType);
        }
...
this IDbConnection cnn, string sql, Func<TFirst, TSecond, TThird, TFourth, TReturn> map, dynamic param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = null
        ...
        {
            return MultiMap<TFirst, TSecond, TThird, TFourth, DontMap, DontMap, DontMap, DontMap,DontMap, TReturn>(cnn, sql, map, param as object, transaction, buffered, splitOn, commandTimeout, commandType);
        }
#if !CSHARP30
        ...
        {
            return MultiMap<TFirst, TSecond, TThird, TFourth, TFifth, DontMap, DontMap, DontMap, DontMap,TReturn>(cnn, sql, map, param as object, transaction, buffered, splitOn, commandTimeout, commandType);
        }
#endif
#if !CSHARP30
        ...
        {
            return MultiMap<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, DontMap, DontMap, DontMap,TReturn>(cnn, sql, map, param as object, transaction, buffered, splitOn, commandTimeout, commandType);
        }
#endif
#if !CSHARP30
        ...
        {
            return MultiMap<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, DontMap,DontMap, TReturn>(cnn, sql, map, param as object, transaction, buffered, splitOn, commandTimeout, commandType);
        }
#endif
#if !CSHARP30
        public static IEnumerable<TReturn> Query<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEigth, TReturn>(this IDbConnection cnn, string sql, Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEigth, TReturn> map, dynamic param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = null)
        {
            return MultiMap<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh,TEigth,DontMap, TReturn>(cnn, sql, map, param as object, transaction, buffered, splitOn, commandTimeout, commandType);
        }
#endif
#if !CSHARP30
        public static IEnumerable<TReturn> Query<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEigth,TNinth, TReturn>(this IDbConnection cnn, string sql, Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEigth,TNinth, TReturn> map, dynamic param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = null)
        {
            return MultiMap<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEigth,TNinth, TReturn>(cnn, sql, map, param as object, transaction, buffered, splitOn, commandTimeout, commandType);
        }
#endif
        class DontMap { }
        static IEnumerable<TReturn> MultiMap<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEigth,TNinth, TReturn>(
        ...
        {
            var results = MultiMapImpl<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh,TEigth,TNinth, TReturn>(cnn, sql, map, param, transaction, splitOn, commandTimeout, commandType, null, null);
            return buffered ? results.ToList() : results;
        }

        static IEnumerable<TReturn> MultiMapImpl<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh,TEigth,TNinth, TReturn>(this IDbConnection cnn, string sql, object map, object param, IDbTransaction transaction, string splitOn, int? commandTimeout, CommandType? commandType, IDataReader reader, Identity identity)
        {
            ...
            try
            {
                ...
                if ((deserializer = cinfo.Deserializer) == null || (otherDeserializers = cinfo.OtherDeserializers) == null)
                {
                    ...
                    {
                        var next = nextSplit(typeof(TSixth));
                        otherDeserializer.Add(GetDeserializer<TSixth>(reader, split, next - split, true));
                    }
                    if (typeof(TSeventh) != typeof(DontMap))
                    {
                        var next = nextSplit(typeof(TSeventh));
                        otherDeserializer.Add(GetDeserializer<TSeventh>(reader, split, next - split, true));
                    }
                    if (typeof(TEigth) != typeof(DontMap))
                    {
                        var next = nextSplit(typeof(TEigth));
                        otherDeserializer.Add(GetDeserializer<TEigth>(reader, split, next - split, true));
                    }
                    if (typeof(TNinth) != typeof(DontMap))
                    {
                        var next = nextSplit(typeof(TNinth));
                ...
                if (otherDeserializers.Length > 1)
                {
                    ...
                    if (otherDeserializers.Length > 2)
                    {
                        ...
                        if (otherDeserializers.Length > 3)
                        {
                            ...
                            if (otherDeserializers.Length > 4)
                            {
                                var deserializer6 = (Func<IDataReader, TSixth>)otherDeserializers[4];
                                if (otherDeserializers.Length > 5)
                                {
                                    var deserializer7 = (Func<IDataReader, TSeventh>)otherDeserializers[5];
                                    if (otherDeserializers.Length > 6)
                                    {
                                        var deserializer8 = (Func<IDataReader, TEigth>)otherDeserializers[6];
                                        if (otherDeserializers.Length > 7)
                                        {
                                            var deserializer9 = (Func<IDataReader, TNinth>)otherDeserializers[7];
                                            mapIt = r => ((Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEigth, TNinth,TReturn>)map)(rootDeserializer(r), deserializer2(r), deserializer3(r), deserializer4(r), deserializer5(r), deserializer6(r), deserializer7(r), deserializer8(r), deserializer9(r));
                                        }
                                        else
                                        {
                                            mapIt = r => ((Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEigth, TReturn>)map)(rootDeserializer(r), deserializer2(r), deserializer3(r), deserializer4(r), deserializer5(r), deserializer6(r), deserializer7(r), deserializer8(r));
                                        }
                                    }
                                    else
                                    {
                                        mapIt = r => ((Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>)map)(rootDeserializer(r), deserializer2(r), deserializer3(r), deserializer4(r), deserializer5(r), deserializer6(r), deserializer7(r));
                                    }
                                }
                                else
                                {
                                    mapIt = r => ((Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TReturn>)map)(rootDeserializer(r), deserializer2(r), deserializer3(r), deserializer4(r), deserializer5(r), deserializer6(r));
                                }
                            }
                            else
                            {
...
IDataReader reader, int startBound = 0, int length = -1, bool returnNullIfFirstMissing = false
        ...
        public class GridReader : IDisposable
        {
            ...
            private IEnumerable<TReturn> MultiReadInternal<TFirst, TSecond, TThird, TFourth, TFifth,TSixth,TSeventh,TEigth,TNinth, TReturn>(object func, string splitOn)
            {
                ...
                try
                {
                    foreach (var r in SqlMapper.MultiMapImpl<TFirst, TSecond, TThird, TFourth, TFifth,TSixth,TSeventh,TEigth,TNinth, TReturn>(null, null, func, null, null, splitOn, null, null, reader, identity))
                    {
                        yield return r;
                    }
                }
...
#endif
            {
                return MultiReadInternal<TFirst, TSecond, DontMap, DontMap, DontMap,DontMap,DontMap,DontMap,DontMap, TReturn>(func, splitOn);
            }
...
#endif
            {
                return MultiReadInternal<TFirst, TSecond, TThird, DontMap, DontMap, DontMap, DontMap, DontMap, DontMap, TReturn>(func, splitOn);
            }
...
#endif
            {
                return MultiReadInternal<TFirst, TSecond, TThird, TFourth, DontMap, DontMap, DontMap, DontMap, DontMap, TReturn>(func, splitOn);
            }
            ...
            {
                return MultiReadInternal<TFirst, TSecond, TThird, TFourth, TFifth,DontMap,DontMap,DontMap,DontMap, TReturn>(func, splitOn);
            }
#endif
#if !CSHARP30
            ...
            {
                return MultiReadInternal<TFirst, TSecond, TThird, TFourth, TFifth, TSixth,DontMap,DontMap,DontMap, TReturn>(func, splitOn);
            }
#endif
#if !CSHARP30  
            ...
            {
                return MultiReadInternal<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, DontMap,DontMap,TReturn>(func, splitOn);
            }
#endif
#if !CSHARP30  
            public IEnumerable<TReturn> Read<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEight, TReturn>(Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEight,TReturn> func, string splitOn = "id")

            {
                return MultiReadInternal<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEight,DontMap ,TReturn>(func, splitOn);
            }
#endif
#if !CSHARP30
            public IEnumerable<TReturn> Read<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEight,TNinth, TReturn>(Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEight,TNinth, TReturn> func, string splitOn = "id")
            {
                return MultiReadInternal<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEight, TNinth, TReturn>(func, splitOn);
            }
#endif
...
string name, object value = null, DbType? dbType = null, ParameterDirection? direction = null, int? size = null
    ...
    public class DapperSqlConnection : IDbConnection
	{
		...
		{
			get { return sqlConnection.ConnectionTimeout; }
		}
