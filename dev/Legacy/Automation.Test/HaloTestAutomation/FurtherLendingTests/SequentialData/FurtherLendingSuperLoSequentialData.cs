...
namespace FurtherLendingTests
{
    ...
    /// </summary>
    public class FurtherLendingSuperLoSequentialData
    {
        /// <summary>
        ...
        /// <summary>
        /// Constructor for FurtherLendingSuperLoSequentialData, uses the test.AutomationFLTestCases table to build up lists.
        /// </summary>
        public FurtherLendingSuperLoSequentialData()
        {
            try
            {
                var db = new _2AMDataHelper();
                QueryResults results = db.GetSuperLoOptFLAutomationOffers();
