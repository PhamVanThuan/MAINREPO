...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[test].[UpdateAddressDetailsWherePropertyValuationGreaterThan12MonthsOld]') AND type in (N'P', N'PC'))
DROP PROCEDURE [test].[UpdateAddressDetailsWherePropertyValuationGreaterThan12MonthsOld]
go

USE [2AM]
GO
/****** Object:  StoredProcedure [test].[UpdateAddressDetailsWherePropertyValuationGreaterThan12MonthsOld]    Script Date: 10/07/2010 11:55:13 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

Create PROCEDURE [test].[UpdateAddressDetailsWherePropertyValuationGreaterThan12MonthsOld]
		@offerKey int,
		@marketValue int
