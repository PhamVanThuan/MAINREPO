<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Survey.aspx.cs" Inherits="Views_Survey" %>
<%@ Register Src="Menu.ascx" TagPrefix="menu" TagName="SideMenu" %>
<%@ Register Src="~/Components/Survey/Survey.ascx" TagPrefix="SAHL" TagName="Survey" %>
    ...
    <div>
            <table border="0" cellpadding="10px" cellspacing="10px" style="width: 100%">
                ...
                <tr>
                    ...
                    <SAHL:Survey ID="Survey" runat="server" />
                    </td>
                </tr>
                <tr>
