<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SendQ1MarketingMail.aspx.cs" Inherits="Views_Q1SendMail" %>
<%@ Register Src="Menu.ascx" TagPrefix="menu" TagName="SideMenu" %>
<%@ Register Src="~/Components/Other/SendQ1Email.ascx" TagPrefix="SAHL" TagName="Q1AdCampaign" %>
    ...
    <div>
            <table border="0" cellpadding="10px" cellspacing="10px" style="width: 100%">
                ...
                <tr>
                    ...
                    <SAHL:Q1AdCampaign ID="Q1AdCampaign" runat="server" />
                    </td>
                </tr>
                <tr>
