...
namespace SAHL.TestWTF
{
    public class DAODataConsistancyChecker
    {
        ...
        private static string TestString = "RS - Generic Test";
        ...
        //public static void SpewToScreen(List<string> Messages, Type Ty)
        //{
        //    if (Messages.Count == 0)
        //    {
        //        Console.WriteLine("{0} is valid", Ty);
        //        Debug.WriteLine(string.Format("Valid: {0}", Ty));
        //        return;
        //    }
        //    foreach (string s in Messages)
        //    {
        //        string str = string.Format("Failed!!!: {0} {1}", Ty, s);
        //        Debug.WriteLine(str);
        ...
        public static void CheckTypes(List<Type> DAOTypes, string KeyName)
        {
            ...
            foreach (Type t in DAOTypes)
            {
                ...
                try
                {
                    ...
                    object[] oo = t.GetCustomAttributes(true);//typeof(Castle.ActiveRecord.ActiveRecordAttribute), true);
