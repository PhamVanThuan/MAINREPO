...
namespace SAHL.Web.Test.Presenters.Common
{
    [Ignore]
    [TestFixture]
    public class StageTransitionHistoryLifeOrigPresenter : TestViewBase
    {
        ...
        public void TestEventsHookUp()
        {
            ...
            StageTransitionHistoryLifeOrigination presenter = new StageTransitionHistoryLifeOrigination(_StageTransitionHistoryView, controller);
        }
