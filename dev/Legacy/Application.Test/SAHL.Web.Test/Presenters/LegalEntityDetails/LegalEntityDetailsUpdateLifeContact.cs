...
namespace SAHL.Web.Test.Presenters.LegalEntityDetailsTest
{
    [Ignore]
    [TestFixture]
    public class LegalEntityDetailsUpdateLifeContactTest : LegalEntityDetailsUpdateTestBase
    {
        ...
        public void ViewInitializeCompany()
        {
            ...
            // Additionally bind Insurable Interest
            _view.BindInsurableInterestType(null, null);
            LastCall.IgnoreArguments();
            ...
            // setup the result for global cache
            /*
            GlobalData GlobalCacheData = new GlobalData();
            if (!GlobalCacheData.ContainsKey(ViewConstants.SelectedLifeLegalEntityKey))
                GlobalCacheData.Add(ViewConstants.SelectedLifeLegalEntityKey, -1, new List<ICacheObjectLifeTime>());

            SetupResult.For(GlobalCacheData).Return(GlobalCacheData);
            ...
            */
            ...
            LegalEntityDetailsUpdateLifeContact LegalEntityDetailsPresenter = new LegalEntityDetailsUpdateLifeContact(_view, controller);
        ...
        public void ViewPreRenderExceptionStatusNotThree()
        {
            ...
            // Simulate the test conditions
            SetupResult.For(LegalEntityNaturalPerson.LegalEntityExceptionStatus).Return(LegalEntityExceptionStatus); // Has an Exception (override)
            SetupResult.For(LegalEntityExceptionStatus.Key).Return(0); // Has an ExceptionStatus of 0
