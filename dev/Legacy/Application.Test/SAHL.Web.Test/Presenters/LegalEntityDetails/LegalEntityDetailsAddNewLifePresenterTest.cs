...
namespace SAHL.Web.Test.Presenters.LegalEntityDetailsTest
{
    [Ignore]
    [TestFixture]
    public class LegalEntityDetailsAddNewLifePresenterTest : LegalEntityDetailsPresenterTestBase
    {
        ...
        public void EventsHookupOnCreation()
        {
            ...
            LegalEntityDetailsLifeAdd LegalEntityDetailsPresenter = new LegalEntityDetailsLifeAdd(_view, controller);
        ...
        public void SaveTest()
        {
            ...
            ILegalEntity legalEntity = _legalEntityRepository.GetLegalEntityByKey(134549);

            ILegalEntityNaturalPerson legalEntityNaturalPerson = legalEntity as ILegalEntityNaturalPerson;

            // legalEntity.CellPhoneNumber = "555 1254";
            // legalEntityNaturalPerson.Surname = "Neeran1";

            legalEntity.HomePhoneCode = "031";

            using (new TransactionScope(TransactionMode.Inherits))
            {
                _legalEntityRepository.SaveLegalEntity( legalEntity, false);
            }
