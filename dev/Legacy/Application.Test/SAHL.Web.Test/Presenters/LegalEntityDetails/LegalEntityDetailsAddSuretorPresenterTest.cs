...
namespace SAHL.Web.Test.Presenters.LegalEntityDetailsTest
{
    [Ignore]
    [TestFixture]
    public class LegalEntityDetailsAddSuretorPresenterTest : LegalEntityDetailsPresenterTestBase
    {
        ...
        public void EventsHookupOnCreation()
        {
            ...
            LegalEntityDetailsAddSuretor LegalEntityDetailsPresenter = new LegalEntityDetailsAddSuretor(_view, controller);
