...
namespace SAHL.Web.Test.Presenters.ManualDebitOrders
{
    [Ignore]
    [TestFixture]
    public class ManualDebitOrderUpdatePresenter : TestViewBase
    {
        ...
        public void InitialiseTest()
        {
            ...
            _mockery.ReplayAll();
            ManualDebitOrderUpdate presenter = new ManualDebitOrderUpdate(_view, controller);
        ...
        public void PreRenderTest()
        {
            ...
            //_view.AmountUpdateVisible = false;
            //_view.EffectiveDateUpdateVisible = false;
            //_view.NoteUpdateVisible = false;
            //_view.ReferenceUpdateVisible = false;
            //_view.NotePanelVisible = true;
