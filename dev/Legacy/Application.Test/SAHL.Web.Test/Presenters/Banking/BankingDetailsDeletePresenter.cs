...
namespace SAHL.Web.Test.Presenters.Banking
{
    [Ignore]
    [TestFixture]
    public class BankingDetailsDeletePresenter : TestViewBase
    {
        ...
        public void InitialiseTest()
        {
            ...
            _mockery.ReplayAll();
            BankingDetailsDelete presenter = new BankingDetailsDelete(_view, controller);
        ...
        public void SubmitButtonClickedTest()
        {
            ...
            // SetupResult.For(_view.SelectedBankAccountKey).Return(bankAccountKey);
