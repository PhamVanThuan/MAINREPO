...
namespace WorkflowMaps.Origination.Specs.Workflows.Valuations.Activities.Further_Valuation_Required.OnComplete
{
    ...
    internal class when_further_valuation_required_on_manager_worklist : WorkflowSpecValuations
    {
        ...
        private It should_reassign_to_previous_valuation_user_or_round_robin = () =>
        {
            workflowAssignmentClient.WasToldTo(x => x.ReassignToPreviousValuationsUserIfExistsElseRoundRobin((IDomainMessageCollection)messages,
                "Valuations Administrator D", 111, 0, "Valuations", 0, "Further Valuation Requested",
