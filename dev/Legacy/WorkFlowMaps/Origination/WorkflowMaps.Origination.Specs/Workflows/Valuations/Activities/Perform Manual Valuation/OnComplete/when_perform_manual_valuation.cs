...
namespace WorkflowMaps.Origination.Specs.Workflows.Valuations.Activities.Perform_Manual_Valuation.OnComplete
{
    [Subject("Activity => Perform_Manual_Valuation => OnComplete")]
    internal class when_perform_manual_valuation : WorkflowSpecValuations
    {
        ...
        private Because of = () =>
        {
            result = workflow.OnCompleteActivity_Perform_Manual_Valuation(instanceData, workflowData, paramsData, messages, ref message);
        };
