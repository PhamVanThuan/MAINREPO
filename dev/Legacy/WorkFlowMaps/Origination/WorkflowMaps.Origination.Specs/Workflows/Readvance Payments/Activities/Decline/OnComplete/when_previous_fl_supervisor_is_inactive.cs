...
namespace WorkflowMaps.Origination.Specs.Workflows.Readvance_Payments.Activities.Decline.OnComplete
{
    ...
    internal class when_previous_fl_supervisor_is_inactive : WorkflowSpecReadvancePayments
    {
        ...
        {
            wfa.WasNotToldTo(x => x.ReassignCaseToUser((IDomainMessageCollection)messages, instanceData.ID, workflowData.ApplicationKey, adUserName, 155, 921,
                "Rapid Decision"));
        };
