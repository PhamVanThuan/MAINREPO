...
namespace WorkflowMaps.Origination.Specs.Workflows.Readvance_Payments.Activities.Further_Loan.OnStart
{
    ...
    internal class when_application_is_not_a_further_loan : WorkflowSpecReadvancePayments
    {
        ...
        private Establish context = () =>
        {
            ...
            client.WhenToldTo(x => x.IsFurtherLoanApplication(Param.IsAny<IDomainMessageCollection>(), Param.IsAny<int>())).Return(false);
        };
