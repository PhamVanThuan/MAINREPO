...
namespace WorkflowMaps.Origination.Specs.Workflows.Readvance_Payments.Activities.Decline.OnComplete
{
    ...
    internal class when_previous_fl_processor_is_inactive : WorkflowSpecReadvancePayments
    {
        ...
        {
            wfa.WasToldTo(x => x.X2RoundRobinForPointerDescription((IDomainMessageCollection)messages, instanceData.ID, (int)SAHL.Common.Globals.RoundRobinPointers.FLProcessor, workflowData.ApplicationKey,
                "FL Processor D", "Decline", SAHL.Common.Globals.Process.Origination));
        };
