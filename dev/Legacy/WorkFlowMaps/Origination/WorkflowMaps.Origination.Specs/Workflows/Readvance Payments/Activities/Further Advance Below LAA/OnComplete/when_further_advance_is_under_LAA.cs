...
namespace WorkflowMaps.Origination.Specs.Workflows.Readvance_Payments.Activities.Further_Advance_Below_LAA.OnComplete
{
    [Subject("Activity => Further_Advance_Below_LAA => OnComplete")]
    internal class when_further_advance_is_under_LAA : WorkflowSpecReadvancePayments
    {
        ...
        private Because of = () =>
        {
            result = workflow.OnCompleteActivity_Further_Advance_Below_LAA(instanceData, workflowData, paramsData, messages, ref message);
        };
