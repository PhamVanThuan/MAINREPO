...
namespace WorkflowMaps.Origination.Specs.Workflows.Readvance_Payments.Activities.Reinstate_NTU.OnComplete
{
    ...
    internal class when_reinstate_ntu_previous_state_not_rapid_decision_and_no_adusername : WorkflowSpecReadvancePayments
    {
        ...
        private It should_round_robin = () =>
        {
            client.WasToldTo(x => x.X2RoundRobinForPointerDescription((IDomainMessageCollection)messages, instanceData.ID, (int)SAHL.Common.Globals.RoundRobinPointers.FLProcessor,
        ...
        private It should_not_reactivate_fl_supervisors = () =>
        {
