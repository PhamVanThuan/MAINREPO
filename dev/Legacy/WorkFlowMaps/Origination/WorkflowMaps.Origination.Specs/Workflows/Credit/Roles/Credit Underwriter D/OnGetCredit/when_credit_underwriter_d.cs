...
namespace WorkflowMaps.Origination.Specs.Workflows.Credit.Roles.Credit_Underwriter_D.OnGetCredit
{
    [Subject("Roles => Credit_Underwriter_D => OnGetCredit")]
    internal class when_credit_underwriter_d : WorkflowSpecCredit
    {
        ...
        private Because of = () =>
        {
            result = workflow.OnGetRole_Credit_Credit_Underwriter_D(instanceData, workflowData, roleName, paramsData, messages);
        };
