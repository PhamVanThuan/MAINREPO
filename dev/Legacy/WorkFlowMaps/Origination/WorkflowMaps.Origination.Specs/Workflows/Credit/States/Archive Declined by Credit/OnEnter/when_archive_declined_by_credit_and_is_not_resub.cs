...
namespace WorkflowMaps.Origination.Specs.Workflows.Credit.States.Archive_Declined_by_Credit.OnEnter
{
    ...
    internal class when_archive_declined_by_credit_and_is_not_resub : WorkflowSpecCredit
    {
        ...
        {
            credit.WasNotToldTo(x => x.SendResubMail(Param.IsAny<IDomainMessageCollection>(), Param.IsAny<int>()));
        };
