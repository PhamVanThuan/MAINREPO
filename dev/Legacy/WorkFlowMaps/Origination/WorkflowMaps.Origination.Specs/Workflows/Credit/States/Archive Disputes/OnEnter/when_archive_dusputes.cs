...
namespace WorkflowMaps.Origination.Specs.Workflows.Credit.States.Archive_Disputes.OnEnter
{
    [Subject("State => Archive_Disputes => OnEnter")]
    internal class when_archive_dusputes : WorkflowSpecCredit
    {
        ...
        private Because of = () =>
        {
            result = workflow.OnEnter_Archive_Disputes(instanceData, workflowData, paramsData, messages);
        };
