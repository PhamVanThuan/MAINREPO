...
namespace WorkflowMaps.Origination.Specs.Workflows.Credit.States.Archive_Resubmission.OnEnter
{
    [Subject("State => Archive_Resubmission => OnEnter")]
    internal class when_archive_resubmission : WorkflowSpecCredit
    {
        ...
        private Because of = () =>
        {
            result = workflow.OnEnter_Archive_Resubmission(instanceData, workflowData, paramsData, messages);
        };
