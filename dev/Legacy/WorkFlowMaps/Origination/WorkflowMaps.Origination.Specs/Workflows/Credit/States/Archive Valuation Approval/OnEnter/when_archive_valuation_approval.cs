...
namespace WorkflowMaps.Origination.Specs.Workflows.Credit.States.Archive_Valuation_Approval.OnEnter
{
    [Subject("State => Archive_Valuation_Approval => OnEnter")]
    internal class when_archive_valuation_approval : WorkflowSpecCredit
    {
        ...
        private Because of = () =>
        {
            result = workflow.OnEnter_Archive_Valuation_Approval(instanceData, workflowData, paramsData, messages);
        };
