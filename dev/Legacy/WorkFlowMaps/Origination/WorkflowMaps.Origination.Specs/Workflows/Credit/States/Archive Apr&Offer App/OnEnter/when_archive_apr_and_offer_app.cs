...
namespace WorkflowMaps.Origination.Specs.Workflows.Credit.States.Archive_Apr_Offer_App.OnEnter
{
    [Subject("State => Archive_Apr_Offer_App => OnEnter")]
    internal class when_archive_apr_and_offer_app : WorkflowSpecCredit
    {
        ...
        private Because of = () =>
        {
            result = workflow.OnEnter_Archive_Apr_Offer_App(instanceData, workflowData, paramsData, messages);
        };
