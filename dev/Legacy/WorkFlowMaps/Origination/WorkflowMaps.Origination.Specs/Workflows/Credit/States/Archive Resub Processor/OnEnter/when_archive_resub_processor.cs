...
namespace WorkflowMaps.Origination.Specs.Workflows.Credit.States.Archive_Resub_Processor.OnEnter
{
    [Subject("State => Archive_Resub_Processor => OnEnter")]
    internal class when_archive_resub_processor : WorkflowSpecCredit
    {
        ...
        private Because of = () =>
        {
            result = workflow.OnEnter_Archive_Resub_Processor(instanceData, workflowData, paramsData, messages);
        };
