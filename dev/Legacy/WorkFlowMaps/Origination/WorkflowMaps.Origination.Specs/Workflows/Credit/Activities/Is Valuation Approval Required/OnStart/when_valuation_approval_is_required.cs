...
namespace WorkflowMaps.Origination.Specs.Workflows.Credit.Activities.Is_Valuation_Approval_Required.OnStart
{
    ...
    internal class when_valuation_approval_is_required : WorkflowSpecCredit
    {
        ...
        private Establish context = () =>
        {
            ...
            client.WhenToldTo(x => x.IsValuationApprovalRequired(Param.IsAny<IDomainMessageCollection>(), Param.IsAny<long>())).Return(true);
        };
