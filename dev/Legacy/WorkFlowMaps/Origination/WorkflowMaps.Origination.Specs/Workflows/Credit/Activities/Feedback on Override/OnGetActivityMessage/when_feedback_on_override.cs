...
namespace WorkflowMaps.Origination.Specs.Workflows.Credit.Activities.Feedback_on_Override.OnGetActivityMessage
{
    [Subject("Activity => Feedback_On_Override => OnGetActivityMessage")]
    internal class when_feedback_on_override : WorkflowSpecCredit
    {
        ...
        private Because of = () =>
        {
            result = workflow.GetActivityMessage_Feedback_on_Override(instanceData, workflowData, paramsData, messages);
        };
