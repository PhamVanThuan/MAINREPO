...
namespace WorkflowMaps.Origination.Specs.Workflows.Credit.Activities.Approve_with_Pricing_Changes.OnComplete
{
    ...
    internal class when_approve_with_pricing_changes_and_rules_pass : WorkflowSpecCredit
    {
        ...
        {
            workflowData.ActionSource.ShouldBeTheSameAs("Approve with Pricing Changes");
        };
