...
namespace WorkflowMaps.Origination.Specs.Workflows.Application_Capture.Activities.Is_Estate_Agent_Lead.OnStart
{
    ...
    internal class when_is_estate_agent_lead_and_successfully_assigned_to_a_branch_admin : WorkflowSpecApplicationCapture
    {
        ...
        private It should_assign_creator_as_branch_admin = () =>
        {
            adminCallCount.ShouldEqual(1);
        };
