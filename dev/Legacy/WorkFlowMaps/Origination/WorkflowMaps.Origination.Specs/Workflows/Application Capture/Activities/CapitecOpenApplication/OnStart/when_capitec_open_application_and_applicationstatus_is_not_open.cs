...
namespace WorkflowMaps.Origination.Specs.Workflows.Application_Capture.Activities.CapitecOpenApplication.OnStart
{
    ...
    internal class when_capitec_open_application_and_applicationstatus_is_not_open : WorkflowSpecApplicationCapture
    {
        ...
        private Establish context = () =>
        {
            ...
            expectedApplicationStatusKey = (int)SAHL.Common.Globals.OfferStatuses.Declined;
