...
namespace WorkflowMaps.Origination.Specs.Workflows.Application_Management.States.Archive_Processor.OnEnter
{
    ...
    internal class when_archive_processor_adusername_is_empty : WorkflowSpecApplicationManagement
    {
        ...
        private It should_deactivate_and_process_users_for_instance_and_process = () =>
        {
