...
namespace WorkflowMaps.Origination.Specs.Workflows.Application_Management.States.Archive_NTU.OnEnter
{
    ...
    internal class when_archive_NTU_and_is_not_fl_and_archive_child_instances : WorkflowSpecApplicationManagement
    {
        ...
        private It should_not_complete_unhold_next_application = () =>
       {
        ...
        private It should_not_DeActiveUsers_For_Instance = () =>
        {
            workflowAssignment.WasNotToldTo(x => x.DeActiveUsersForInstanceAndProcess((IDomainMessageCollection)messages, instanceData.ID, workflowData.ApplicationKey, workflowRoles, SAHL.Common.Globals.Process.Origination));
        };
