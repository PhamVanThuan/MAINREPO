...
namespace WorkflowMaps.ApplicationManagement.Specs.States.Registration_Pipeline.OnEnter
{
    ...
    internal class when_email_not_sent_and_is_alpha_housing : WorkflowSpecApplicationManagement
    {
        ...
        private Establish context = () =>
        {
            ...
            appMan.Expect(x => x.SendAlphaHousingSurveyEmail((IDomainMessageCollection)messages, workflowData.ApplicationKey, paramsData.ADUserName, out isAlpha)).OutRef(true);
