...
namespace WorkflowMaps.Origination.Specs.Workflows.Application_Management.States.Further_Info_Request.OnEnter
{
    ...
    internal class when_further_info_request_is_not_fl : WorkflowSpecApplicationManagement
    {
        ...
        private It should_reactivate_users_or_round_robin_org_structure_106 = () =>
        {
            client.WasToldTo(x => x.ReactiveUserOrRoundRobinForOSKeyByProcess((IDomainMessageCollection)messages, "New Business Processor D", workflowData.ApplicationKey, 106, instanceData.ID,
        ...
        private It should_not_reactivate_users_or_round_robin_org_structure_157 = () =>
        {
            client.WasNotToldTo(x => x.ReactiveUserOrRoundRobinForOSKeyByProcess((IDomainMessageCollection)messages, "FL Processor D", workflowData.ApplicationKey, 157, instanceData.ID,
