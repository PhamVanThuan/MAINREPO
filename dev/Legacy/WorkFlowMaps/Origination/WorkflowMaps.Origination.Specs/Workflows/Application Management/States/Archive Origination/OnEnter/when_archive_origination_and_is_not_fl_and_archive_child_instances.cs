...
namespace WorkflowMaps.Origination.Specs.Workflows.Application_Management.States.Archive_Origination.OnEnter
{
    ...
    internal class when_archive_origination_and_is_not_fl_and_archive_child_instances : WorkflowSpecApplicationManagement
    {
        ...
        {
            fl.WasNotToldTo(x => x.SuretySignedConfirmed((IDomainMessageCollection)messages, workflowData.ApplicationKey));
        };
