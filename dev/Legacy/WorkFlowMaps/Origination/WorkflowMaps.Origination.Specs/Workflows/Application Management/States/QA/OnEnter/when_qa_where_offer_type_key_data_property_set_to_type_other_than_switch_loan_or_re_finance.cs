...
namespace WorkflowMaps.Origination.Specs.Workflows.Application_Management.States.QA.OnEnter
{
    ...
    internal class when_qa_where_offer_type_key_data_property_set_to_type_other_than_switch_loan_or_re_finance : WorkflowSpecApplicationManagement
    {
        ...
        {
            result = false;
            workflowData.OfferTypeKey = 2; //or 3 or 4 or 5 or 7 or 9 or 10
