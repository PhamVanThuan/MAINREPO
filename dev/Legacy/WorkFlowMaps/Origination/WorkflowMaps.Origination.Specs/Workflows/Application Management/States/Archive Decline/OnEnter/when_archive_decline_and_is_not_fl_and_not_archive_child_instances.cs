...
namespace WorkflowMaps.Origination.Specs.Workflows.Application_Management.States.Archive_Decline.OnEnter
{
    ...
    internal class when_archive_decline_and_is_not_fl_and_not_archive_child_instances : WorkflowSpecApplicationManagement
    {
        ...
        private It should_not_deactivate_users_for_instance_and_process = () =>
        {
            workFlowAssignment.WasNotToldTo(x => x.DeActiveUsersForInstanceAndProcess((IDomainMessageCollection)messages, instanceData.ID, workflowData.ApplicationKey, dynamicRoles, SAHL.Common.Globals.Process.Origination));
        };
