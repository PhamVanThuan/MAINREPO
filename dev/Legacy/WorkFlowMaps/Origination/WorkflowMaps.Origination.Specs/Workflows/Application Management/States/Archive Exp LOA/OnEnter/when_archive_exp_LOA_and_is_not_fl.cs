...
namespace WorkflowMaps.Origination.Specs.Workflows.Application_Management.States.Archive_Exp_LOA.OnEnter
{
    ...
    internal class when_archive_exp_LOA_and_is_not_fl : WorkflowSpecApplicationManagement
    {
        ...
        private Because of = () =>
        {
            result = result = workflow.OnEnter_Archive_Exp_LOA(instanceData, workflowData, paramsData, messages);
        };
