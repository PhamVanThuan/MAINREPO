...
{
    public class when_feed_back_on_query_and_CheckMinIncomeRules_fail : WorkflowSpecApplicationManagement
    {
        ...
        private Establish context = () =>
        {
            ...
            common.WhenToldTo(x => x.CheckApplicationMinimumIncomeRules(Param.IsAny<IDomainMessageCollection>(), Param.IsAny<int>(), Param.IsAny<bool>())).Return(false);
