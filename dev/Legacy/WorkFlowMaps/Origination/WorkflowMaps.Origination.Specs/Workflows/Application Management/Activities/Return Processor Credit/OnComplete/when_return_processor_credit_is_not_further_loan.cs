...
namespace WorkflowMaps.ApplicationManagement.Specs.Activities.Return_Processor_Credit.OnComplete
{
    ...
    internal class when_return_processor_credit_is_not_further_loan : WorkflowSpecApplicationManagement
    {
        ...
        {
            assignmentClient.WasToldTo(x => x.ReactiveUserOrRoundRobinForOSKeyByProcess((IDomainMessageCollection)messages, "New Business Processor D",
                            workflowData.ApplicationKey, 106, instanceData.ID, "Manage Application",
