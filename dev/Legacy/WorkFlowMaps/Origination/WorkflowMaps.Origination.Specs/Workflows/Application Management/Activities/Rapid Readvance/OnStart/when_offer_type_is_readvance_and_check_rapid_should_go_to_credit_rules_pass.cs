...
namespace WorkflowMaps.Origination.Specs.Workflows.Application_Management.Activities.Rapid_Readvance.OnStart
{
    ...
    internal class when_offer_type_is_readvance_and_check_rapid_should_go_to_credit_rules_pass : WorkflowSpecApplicationManagement
    {
        ...
        private It should_deactiv_user_for_instance_and_process = () =>
        {
