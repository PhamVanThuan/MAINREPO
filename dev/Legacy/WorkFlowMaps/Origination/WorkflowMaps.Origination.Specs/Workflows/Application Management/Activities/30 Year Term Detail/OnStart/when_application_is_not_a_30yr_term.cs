...
namespace WorkflowMaps.ApplicationManagement.Specs.Activities._30_Year_Term_Detail.OnStart
{
    [Subject("Activity => Convert_to_30_Year_Term => OnStart")]
    internal class when_application_is_not_a_30yr_term : WorkflowSpecApplicationManagement
    {
        static bool result;
