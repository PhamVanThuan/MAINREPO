...
namespace WorkflowMaps.Origination.Specs.Workflows.Application_Management.Activities.Reinstate_Decline.OnComplete
{
    ...
    internal class when_resintate_decline_where_is_not_fl_and_previous_state_is_manage_application : WorkflowSpecApplicationManagement
    {
        ...
        private Establish context = () =>
        {
            ...
            workflowData.PreviousState = "MANAGE APPLICATION";
        ...
        private It should_reactive_new_business_processor_d_user_or_round_robin = () =>
        {
