...
namespace WorkflowMaps.Origination.Specs.Workflows.Application_Management.Activities.NTU_PipeLine.OnComplete
{
    ...
    internal class when_ntu_pipeline_where_not_fl_has_ework_folder_id_and_perform_ework_action_unsuccessfull : WorkflowSpecApplicationManagement
    {
        ...
        private It should_not_ntu_case = () =>
        {
            appMan.WasNotToldTo(x => x.NTUCase((IDomainMessageCollection)messages, workflowData.ApplicationKey));
        };
