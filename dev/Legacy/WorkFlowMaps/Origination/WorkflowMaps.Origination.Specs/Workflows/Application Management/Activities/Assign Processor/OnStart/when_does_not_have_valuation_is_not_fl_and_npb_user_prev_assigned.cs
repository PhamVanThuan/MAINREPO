...
namespace WorkflowMaps.Origination.Specs.Workflows.Application_Management.Activities.Assign_Processor.OnStart
{
    ...
    internal class when_assign_processor_where_does_not_have_valuation_is_not_fl_and_npb_user_prev_assigned : WorkflowSpecApplicationManagement
    {
        ...
        {
            assignment.WasToldTo(x => x.ReassignCaseToUser((IDomainMessageCollection)messages,
                instanceData.ID,
                workflowData.ApplicationKey,
                assignedUser,
                106,
                (int)SAHL.Common.Globals.OfferRoleTypes.NewBusinessProcessorD,
                "Manage Application"));
        };
