...
namespace WorkflowMaps.Origination.Specs.Workflows.Application_Management.Activities.Query_on_Application.OnComplete
{
    ...
    internal class when_query_on_application_and_is_not_fl_and_income_insufficient : WorkflowSpecApplicationManagement
    {
        ...
        {
            assignment.WasNotToldTo(x => x.ReActivateBranchUsersForOrigination((IDomainMessageCollection)messages,
                instanceData.ID,
