...
namespace WorkflowMaps.Origination.Specs.Workflows.Application_Management.Activities.Feedback_on_Query.OnComplete
{
    ...
    internal class when_feedback_on_query_and_is_not_fl : WorkflowSpecApplicationManagement
    {
        ...
        private It should_reactive_new_business_process_d_user_or_round_robin = () =>
        {
