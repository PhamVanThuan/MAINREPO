...
namespace WorkflowMaps.Origination.Specs.Workflows.Application_Management.Roles.Credit_Manager_D.OnGetRole
{
    [Subject("Roles => Credit_Manager_D => OnGetRole")]
    internal class when_credit_manager_d : WorkflowSpecApplicationManagement
    {
        ...
        private Because of = () =>
        {
            result = workflow.OnGetRole_Application_Management_Credit_Manager_D(instanceData, workflowData, roleName, paramsData, messages);
        };
