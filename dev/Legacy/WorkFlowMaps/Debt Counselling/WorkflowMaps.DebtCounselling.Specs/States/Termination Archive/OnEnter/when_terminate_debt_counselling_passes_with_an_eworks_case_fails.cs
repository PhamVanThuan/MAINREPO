...
namespace WorkflowMaps.DebtCounselling.Specs.States.Termination_Archive.OnEnter
{
    ...
    internal class when_terminate_debt_counselling_passes_with_an_eworks_case_fails : WorkflowSpecDebtCounselling
    {
        ...
        private Establish context = () =>
        {
            ...
            commonClient.WhenToldTo(x => x.PerformEWorkAction((IDomainMessageCollection)messages, "test", SAHL.Common.Constants.EworkActionNames.X2ReturnDebtCounselling, workflowData.DebtCounsellingKey, "test", "test")).Return(false);
