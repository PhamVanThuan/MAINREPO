...
namespace WorkflowMaps.DebtCounselling.Specs.Activities.Continue_Debt_Review.OnComplete
{
    ...
    internal class when_efolder_exists_and_ework_action_is_not_performed : WorkflowSpecDebtCounselling
    {
        ...
        private Establish context = () =>
        {
            ...
            commonClient.WhenToldTo(x => x.PerformEWorkAction(Param.IsAny<IDomainMessageCollection>(), Param.IsAny<string>(), Param.IsAny<string>(),
                Param.IsAny<int>(), Param.IsAny<string>(), Param.IsAny<string>())).Return(false);
        ...
        private It should_not_load_balance_assign_to_debt_counselling_administrator = () =>
            {
