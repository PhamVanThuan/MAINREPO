...
namespace WorkflowMaps.DebtCounselling.Specs.Activities.Accept.OnComplete
{
    ...
    internal class when_accept_and_assignment_passes : WorkflowSpecDebtCounselling
    {
        ...
        private It should_assign_or_load_balance_the_case_to_the_debt_counselling_consultant = () =>
        {
            workflowAssignment.WasToldTo(x => x.AssignDebtCounsellingCaseForGroupOrLoadBalance((IDomainMessageCollection)messages, instanceData.ID, workflowData.DebtCounsellingKey,
                SAHL.Common.Globals.WorkflowRoleTypes.DebtCounsellingConsultantD, "Accept Proposal", statesToExclude, false, workflowData.CourtCase));
        };
