...
namespace WorkflowMaps.DebtCounselling.Specs.Activities.Court_Details.OnComplete
{
    ...
    internal class when_consent_order_granted : WorkflowSpecDebtCounselling
    {
        ...
        private Establish context = () =>
            {
                ...
                parameters.WhenToldTo(x => x.Data).Return((int)SAHL.Common.Globals.HearingAppearanceTypes.ConsentOrderGranted);
                result = false;
        ...
        private It should_not_assign_or_load_balance_to_the_debt_counselling_court_consultant = () =>
            {
        ...
        private It should_not_set_court_case_data_property_to_true = () =>
        {
