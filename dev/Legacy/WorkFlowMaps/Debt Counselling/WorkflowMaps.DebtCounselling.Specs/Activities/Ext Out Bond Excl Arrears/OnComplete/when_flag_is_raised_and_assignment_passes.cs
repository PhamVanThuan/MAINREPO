...
namespace WorkflowMaps.DebtCounselling.Specs.Activities.Ext_Out_Bond_Excl_Arrears.OnComplete
{
    [Subject("Activity => Ext_Out_Bond_Excl_Arrears => OnComplete")]
    internal class when_flag_is_raised_and_assignment_passes : WorkflowSpecDebtCounselling
    {
        ...
        private Because of = () =>
        {
            result = workflow.OnCompleteActivity_Ext_Out_Bond_Excl_Arrears(instanceData, workflowData, paramsData, messages, ref message);
        };
