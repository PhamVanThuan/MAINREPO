...
namespace WorkflowMaps.DebtCounselling.Specs.Activities.Respond_to_Debt_Counsellor.OnComplete
{
    ...
    internal class when_can_assign_and_previously_sent_to_litigation : WorkflowSpecDebtCounselling
    {
        ...
        private Establish context = () =>
        {
            ...
            client.Expect(x => x.GetEworkDataForLossControlCase((IDomainMessageCollection)messages, workflowData.AccountKey, out eStageName, out eFolderID, out aduserName)).OutRef("Stage", "eFolder", "adUser");
        ...
        private It should_not_perform_the_x2_debt_counselling_ework_action = () =>
        {
            commonClient.WasNotToldTo(x => x.PerformEWorkAction((IDomainMessageCollection)messages, eFolderID, SAHL.Common.Constants.EworkActionNames.X2DebtCounselling, workflowData.DebtCounsellingKey, string.Empty, eStageName));
        };
    }
}