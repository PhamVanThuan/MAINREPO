...
namespace WorkflowMaps.HelpDesk.Specs.Activities.AutoArchive.OnStart
{
    ...
    internal class when_help_desk_query_key_data_property_is_greater_than_zero_and_workflow_data_updated : WorkflowSpecHelpDesk
    {
        ...
        private Establish context = () =>
        {
            ...
            client.WhenToldTo(x => x.X2AutoArchive2AM_Update(Param.IsAny<IDomainMessageCollection>(), Param.IsAny<int>())).Return(true);
