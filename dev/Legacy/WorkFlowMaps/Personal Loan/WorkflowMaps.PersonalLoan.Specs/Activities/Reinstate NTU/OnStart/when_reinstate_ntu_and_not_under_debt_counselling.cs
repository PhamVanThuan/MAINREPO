...
namespace WorkflowMaps.PersonalLoan.Specs.Activities.Reinstate_NTU.OnStart
{
    ...
    internal class when_reinstate_ntu_and_not_under_debt_counselling : WorkflowSpecPersonalLoans
    {
        ...
        private Establish context = () =>
        {
            ...
            client.WhenToldTo(x => x.CheckUnderDebtCounsellingRule(Param.IsAny<IDomainMessageCollection>(), Param.IsAny<bool>(), Param.IsAny<int>())).Return(true);
        };
