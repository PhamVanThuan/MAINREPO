...
namespace WorkflowMaps.PersonalLoan.Specs.Activities.Disburse_Funds.OnStart
{
    ...
    internal class when_disbursing_funds_with_unceded_external_life : WorkflowSpecPersonalLoans
    {
        ...
        private Establish context = () =>
            {
                ...
                client.WhenToldTo(x => x.CheckExternalPolicyIsCededRule(Param.IsAny<IDomainMessageCollection>(), Param.IsAny<int>(), Param.IsAny<bool>())).Return(false);
            };
        ...
        private It should_check_external_policy_fully_captured_and_is_ceded = () =>
        {
        ...
        private It should_not_bother_check_disbursement_cut_off_time = () =>
        {
