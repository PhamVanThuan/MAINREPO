...
namespace WorkflowMaps.PersonalLoan.Specs.Activities.NTU_Lead.OnComplete
{
    [Subject("Activity => Lead NTU => OnComplete")]
    internal class when_ntu_lead : WorkflowSpecPersonalLoans
    {
        ...
        private Because of = () =>
        {
            result = workflow.OnCompleteActivity_NTU_Lead(instanceData, workflowData, paramsData, messages, ref message);
        };
