...
namespace WorkflowMaps.PersonalLoan.Specs.Activities.Altered_Approval.OnComplete
{
    [Subject("Activity => Altered_Approval => OnComplete")]
    internal class when_altered_approval : WorkflowSpecPersonalLoans
    {
        ...
        private Because of = () =>
        {
            result = workflow.OnCompleteActivity_Altered_Approval(instanceData, workflowData, paramsData, messages, ref message);
        };
