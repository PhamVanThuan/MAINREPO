...
{
    public class PersonalLoanAccountDetailsDrillDownTileConfiguration : MajorTileConfiguration<PersonalLoanAccountDetailsMajorTileModel>,
                                                                 IDrillDownTileConfiguration<LegalEntityPersonalLoanAccountMinorTileConfiguration>
    {
        public PersonalLoanAccountDetailsDrillDownTileConfiguration()
            : base("MortgageLoanAccountDetailsDrillDownTileAccess", "Details")
        {
