...
{
    public class ResidentialStreetPageModelValidator : AbstractEditorPageModelValidator<ResidentialStreetPageModel>
    {
        public ResidentialStreetPageModelValidator()
        {
