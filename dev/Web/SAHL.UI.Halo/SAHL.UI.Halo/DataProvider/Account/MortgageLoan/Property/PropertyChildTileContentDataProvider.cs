...
{
    public class PropertyChildTileContentDataProvider : HaloTileBaseContentDataProvider<PropertyChildModel>
    {
        public PropertyChildTileContentDataProvider(IDbFactory dbFactory)
            : base(dbFactory)
        {
        }
