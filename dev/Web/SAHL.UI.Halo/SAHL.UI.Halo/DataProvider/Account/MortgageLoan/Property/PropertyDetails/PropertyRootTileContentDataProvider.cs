...
namespace SAHL.UI.Halo.DataProvider.Account.MortgageLoan.Property.PropertyDetails
{
    public class PropertyRootTileContentDataProvider : HaloTileBaseContentDataProvider<PropertyRootModel>
    {
        public PropertyRootTileContentDataProvider(IDbFactory dbFactory)
            : base(dbFactory)
        {
        }
