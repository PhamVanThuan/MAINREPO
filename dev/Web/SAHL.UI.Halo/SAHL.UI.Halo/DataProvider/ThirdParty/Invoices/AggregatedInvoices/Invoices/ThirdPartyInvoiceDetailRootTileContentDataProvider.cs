...
{
    public class ThirdPartyInvoiceDetailRootTileContentDataProvider : HaloTileBaseContentDataProvider<ThirdPartyInvoiceDetailRootModel>
    {
        public ThirdPartyInvoiceDetailRootTileContentDataProvider(IDbFactory dbFactory)
            : base(dbFactory)
        {
        }
