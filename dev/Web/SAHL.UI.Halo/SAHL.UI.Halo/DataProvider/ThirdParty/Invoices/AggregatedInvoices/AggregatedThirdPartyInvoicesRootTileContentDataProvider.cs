...
{
    public class AggregatedThirdPartyInvoicesRootTileContentDataProvider : HaloTileBaseContentDataProvider<AggregatedThirdPartyInvoiceRootModel>
    {
        public AggregatedThirdPartyInvoicesRootTileContentDataProvider(IDbFactory dbFactory)
            : base(dbFactory)
        {
        }
