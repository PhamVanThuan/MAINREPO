...
{
    public class SwitchApplicationRootTileContentDataProvider : HaloTileBaseContentDataProvider<SwitchApplicationRootModel>
    {
        public SwitchApplicationRootTileContentDataProvider(IDbFactory dbFactory)
            : base(dbFactory)
        {
        }
