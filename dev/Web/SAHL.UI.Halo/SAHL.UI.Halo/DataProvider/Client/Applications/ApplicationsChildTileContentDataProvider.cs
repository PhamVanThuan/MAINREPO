...
{
    public class ApplicationsChildTileContentDataProvider : HaloTileBaseContentDataProvider<ApplicationsChildModel>
    {
        public ApplicationsChildTileContentDataProvider(IDbFactory dbFactory)
            : base(dbFactory)
        {
        }
        ...
        {
            return string.Format(@"select count(*) as NumOpenApplications from (
                    ...
                    where LegalEntityKey={0} and ofr.GeneralStatusKey=1
                    union
                    ...
                    ) as CountOfApplications", businessContext.BusinessKey.Key);
        }
    }
}