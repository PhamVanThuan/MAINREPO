...
{
    public class ApplicationsRootTileContentDataProvider : HaloTileBaseContentDataProvider<ApplicationRootModel>
    {
        public ApplicationsRootTileContentDataProvider(IDbFactory dbFactory)
            : base(dbFactory)
        {
        }
