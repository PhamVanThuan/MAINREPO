...
{
    public class ClientDetailRootTileContentDataProvider : HaloTileBaseContentDataProvider<ClientDetailModel>,
                                                           IHaloTileChildDataProvider<ClientDetailRootTileConfiguration>
    {
        public ClientDetailRootTileContentDataProvider(IDbFactory dbFactory)
            : base(dbFactory)
        {
        }
