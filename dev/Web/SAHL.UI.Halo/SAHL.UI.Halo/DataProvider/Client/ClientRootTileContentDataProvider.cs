...
{
    public class ClientRootTileContentDataProvider : HaloTileBaseContentDataProvider<ClientRootModel>
    {
        public ClientRootTileContentDataProvider(IDbFactory dbFactory)
            : base(dbFactory)
        {
        }
