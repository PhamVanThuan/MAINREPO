...
{
    public class ThirdPartyWorkflowEscalateForApprovalConditionalProvider : HaloWorkflowActionConditionalProviderBase
    {
        public ThirdPartyWorkflowEscalateForApprovalConditionalProvider(IDbFactory dbFactory)
            : base(dbFactory, "Third Party Invoices", "Third Party Invoices", "Escalate for Approval")
        {
        }
