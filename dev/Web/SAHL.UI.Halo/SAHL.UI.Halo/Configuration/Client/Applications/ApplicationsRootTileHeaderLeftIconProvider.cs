...
{
    public class ApplicationsRootTileHeaderLeftIconProvider : HaloTileHeaderIconProviderBase<ApplicationsRootTileHeaderConfiguration>
    {
        public ApplicationsRootTileHeaderLeftIconProvider()
