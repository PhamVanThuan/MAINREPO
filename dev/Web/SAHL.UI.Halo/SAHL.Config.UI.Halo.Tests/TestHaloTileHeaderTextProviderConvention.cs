...
{
    [TestFixture]
    public class TestHaloTileHeaderTextProviderConvention
    {
        ...
        public void Constructor()
        {
            ...
            //---------------Assert Precondition----------------
            //---------------Execute Test ----------------------
            var convention = new HaloTileHeaderTextProviderConvention();
            //---------------Test Result -----------------------
            Assert.IsNotNull(convention);
        }

        [Test]
        public void Process_ShouldRegisterHaloHeaderTextProviders()
        {
            //---------------Set up test pack-------------------
            //---------------Assert Precondition----------------
            //---------------Execute Test ----------------------
            var tileHeaders = this.iocContainer.GetAllInstances<IHaloTileHeaderTextProvider<ClientRootTileHeaderConfiguration>>();
            //---------------Test Result -----------------------
