'use strict';
angular.module('Home.LossControlManager.PaidInvoicesPerDayRootTileConfiguration.tpl.html',['sahl.js.ui.graphing'])
.controller('Home_LossControlManager_PaidInvoicesPerDayRootTileConfigurationCtrl',['$scope','$activityManager','$paidInvoicesPerDayService',
function($scope,$activityManager,$paidInvoicesPerDayService){
	var operations = {
		load : function(){
			$activityManager.startActivityWithKey('paidInvoicesPerDay');
			$paidInvoicesPerDayService.getData().then(function(data){
				$activityManager.stopActivityWithKey('paidInvoicesPerDay');
...
//
angular.module('Home.LossControlManager.PaidInvoicesPerDayRootTileConfiguration.tpl.html')
.service('$paidInvoicesPerDayService',['$q',function($q){
	var fakeData = [
