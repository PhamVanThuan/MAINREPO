angular.module('scenarioMaps.startActivity', ['sahl.js.workflow.workflowManager', 'sahl.js.core.fluentDecorator', 'mock.workflow.workflowManagerDecorator'])
    ...
    .controller('startActivityCtrl', ['$rootScope', '$scope', '$workflowManager', function($rootScope, $scope, $workflowManager) {

        $scope.describe = replaceAll('start activity', ' ', '_');
        $scope.it = replaceAll('should start an activity', ' ', '_');
