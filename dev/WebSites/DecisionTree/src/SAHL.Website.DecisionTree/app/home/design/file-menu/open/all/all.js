...
angular.module('sahl.tools.app.home.design.file-menu.open.all', [
  'ui.router',
  'sahl.tools.app.services'
])

.config(function config($stateProvider) {
    $stateProvider.state('home.design.file-menu.open.all', {
        url: "/all",
        templateUrl: "./app/home/design/file-menu/open/all/all.tpl.html",
        controller: 'FileOpenAllCtrl'
    });
})

.controller('FileOpenAllCtrl', ['$rootScope', '$scope', '$state', '$keyboardManager', '$documentManager', '$stateParams', '$activityManager', '$queryManager', '$decisionTreeDesignQueries','$serviceConfig','$eventAggregatorService', '$eventDefinitions',
    function FileOpenAllCtrl($rootScope, $scope, $state, $keyboardManager, $documentManager, $stateParams, $activityManager, $queryManager, $decisionTreeDesignQueries, $serviceConfig, $eventAggregatorService, $eventDefinitions) {
