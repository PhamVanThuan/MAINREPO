...
namespace SAHL.Config.Services.Halo.Modules.Client.Tiles.ClientDashboard.ClientDetail.ResidentialAddress.Actions
{
    public class UpdateAddressActionConfiguration : ActionTileConfiguration<UpdateAddressActionTileModel>,
                                             IParentedActionTileConfiguration<LegalEntityResidentialAddressDrillDownTileConfiguration>
    {
