var capitecSearchsearchQueryFakes = function(){
	...
	this.ApplicationStatusQueryResult = function(){
		return {
			...
			"SystemMessages" : SystemMessages(),
						"Add" : function(documentId,score,applicationNumber,applicationDate,applicationStage,applicationStatus,applicantsJson,consultantName,consultantContactNumber,identityNumberList){
				this.ReturnData.Results.$values.push(
					...
					"IdentityNumberList": identityNumberList
					}
				)
			}
					}
