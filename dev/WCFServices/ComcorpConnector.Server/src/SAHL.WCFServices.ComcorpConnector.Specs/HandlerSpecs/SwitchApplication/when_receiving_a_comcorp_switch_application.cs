...
{
    public class when_receiving_a_comcorp_switch_application : WithCoreFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            validationUtils.WhenToldTo(x => x.ParseEnum<OfferType>("Switch Loan")).Return(OfferType.SwitchLoan);
            ...
            modelCreationManager.WhenToldTo(x => x.PopulateSwitchApplicationCreationModel(Param.IsAny<Application>()))
                                .Return(ApplicationCreationTestHelper.PopulateApplicationCreationModel(OfferType.SwitchLoan) as SwitchApplicationCreationModel);
        };
        ...
        {
            modelCreationManager.WasToldTo(x => x.PopulateSwitchApplicationCreationModel(request.Application));
        };

        private It should_start_the_Switch_Application_Domain_Process = () =>
        {
            domainProcessManagerService.WasToldTo(x => x.StartDomainProcess(Param<StartDomainProcessCommand>.Matches(m =>
                ...
                m.DataModel is SwitchApplicationCreationModel)));
        };
