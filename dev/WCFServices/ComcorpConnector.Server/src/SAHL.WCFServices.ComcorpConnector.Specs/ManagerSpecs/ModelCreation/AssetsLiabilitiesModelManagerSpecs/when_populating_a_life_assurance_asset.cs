...
{
    public class when_populating_a_life_assurance_asset : WithCoreFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            lifeAssuranceAsset = comcorpAssetItems.Where(x => x.SAHLAssetDesc == "Life Assurance").First();
        ...
        private Because of = () =>
        {
            result = modelManager.PopulateAssets(comcorpAssetItems)
                .Where(x => x.AssetLiabilityType == AssetLiabilityType.LifeAssurance)
                .FirstOrDefault();
        };
        ...
        {
            result.LiabilityValue.ShouldBeNull();
        };
