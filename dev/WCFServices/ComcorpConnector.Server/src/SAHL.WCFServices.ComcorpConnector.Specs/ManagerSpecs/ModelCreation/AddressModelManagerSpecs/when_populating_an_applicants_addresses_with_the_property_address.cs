...
{
    public class when_populating_an_applicants_addresses_with_the_property_address : WithCoreFakes
    {
        ...
        private Because of = () =>
        {
            applicantPropertyAddress = modelManager.PopulateAddresses(applicant, propertyAddress, null)
