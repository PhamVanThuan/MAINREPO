...
{
    public class when_handling_a_request_with_non_existent_reference : WithCoreFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            requestHeader = SupportingDocumentFactory.GetDocumentRequestHeader(offerKey.ToString(), imagingReference.ToString(), requestDateTime);

            dataManager.WhenToldTo(x => x.DoesImagingReferenecExist(imagingReference)).Return(false);
