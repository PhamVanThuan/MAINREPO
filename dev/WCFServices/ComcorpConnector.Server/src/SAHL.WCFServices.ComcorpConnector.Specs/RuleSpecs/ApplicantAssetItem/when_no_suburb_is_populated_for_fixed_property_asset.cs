...
{
    public sealed class when_no_suburb_is_populated_for_fixed_property_asset : WithCoreFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            assetItems = new List<AssetItem>()
            {
                new AssetItem
                {
                    ...
                    AssetPhysicalAddressSuburb = null,
        ...
        {
            messages.ErrorMessages().First().Message.ShouldEndWith("Suburb is required for Fixed Property Asset address.");
        };
    }
}
