...
{
    public sealed class when_no_province_is_populated_for_fixed_property_asset : WithCoreFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            assetItems = new List<AssetItem>()
            {
                new AssetItem
                {
                    ...
                    AssetPhysicalAddressCity = "City",
                    AssetPhysicalAddressCode = "4015",
                    AssetPhysicalProvince = "",
        ...
        {
            messages.ErrorMessages().First().Message.ShouldEndWith("Province is required for Fixed Property Asset address.");
        };
    }
}
