...
{
    public sealed class when_no_address_line_1_is_populated_for_fixed_property_asset : WithCoreFakes
    {
        ...
        {
            messages.ErrorMessages().First().Message.ShouldEndWith("Address Line 1 is required for Fixed Property Asset address.");
        };
    }
}
