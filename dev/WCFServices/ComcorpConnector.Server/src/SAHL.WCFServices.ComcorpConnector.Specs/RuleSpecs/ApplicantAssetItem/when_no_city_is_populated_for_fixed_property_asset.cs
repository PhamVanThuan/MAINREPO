...
{
    public sealed class when_no_city_is_populated_for_fixed_property_asset : WithCoreFakes
    {
        ...
        {
            messages.ErrorMessages().First().Message.ShouldEndWith("City is required for Fixed Property Asset address.");
        };
    }
}
