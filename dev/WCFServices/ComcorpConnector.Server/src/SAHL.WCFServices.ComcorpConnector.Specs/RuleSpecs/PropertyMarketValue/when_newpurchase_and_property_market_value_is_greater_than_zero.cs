...
{
    public sealed class when_newpurchase_and_property_market_value_is_greater_than_zero : WithCoreFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            _validationUtils.WhenToldTo(x => x.ParseEnum<OfferType>("New Purchase Loan")).Return(OfferType.NewPurchaseLoan);
            application = new Application();
            application.SahlLoanPurpose = "New Purchase";
