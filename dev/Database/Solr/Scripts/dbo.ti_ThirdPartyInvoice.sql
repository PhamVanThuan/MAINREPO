...
IF OBJECT_ID('dbo.ti_ThirdPartyInvoice') is null
BEGIN 
	DECLARE @Qry VARCHAR(1024)
	SET @Qry =	'CREATE TRIGGER dbo.ti_ThirdPartyInvoice ON  dbo.ThirdPartyInvoice ' +
				'FOR INSERT ' +
				'AS ' +
				'BEGIN ' +
				'SET NOCOUNT ON; ' +
...
ALTER TRIGGER dbo.ti_ThirdPartyInvoice ON  dbo.ThirdPartyInvoice
FOR INSERT 
AS 
