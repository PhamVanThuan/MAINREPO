...
namespace SAHL.WorkflowMaps.ThirdPartyInvoices.Specs.Activities.Query_on_Invoice.OnComplete
{
    ...
    internal class when_successfully_querying_an_invoice : WorkflowSpecThirdPartyInvoices
    {
        ...
        {
            ((ParamsDataStub)paramsData).Data = "query comments";
            ...
            thirdPartyInvoices.WhenToldTo(x => x.QueryThirdPartyInvoice(messages, Param.IsAny<int>(), paramsData.Data.ToString(), Param.IsAny<IServiceRequestMetadata>()))
                .Return(true);
        ...
        private It should_use_the_metadata_from_the_params_when_performing_the_query_command = () =>
        {
            thirdPartyInvoices.WasToldTo(x => x.QueryThirdPartyInvoice(messages, Param.IsAny<int>(), paramsData.Data.ToString(), paramsData.ServiceRequestMetadata));
        };

        private It should_use_the_third_party_invoice_key_when_performing_the_query_command = () =>
        {
            thirdPartyInvoices.WasToldTo(x => x.QueryThirdPartyInvoice(messages, workflowData.ThirdPartyInvoiceKey, paramsData.Data.ToString(), paramsData.ServiceRequestMetadata));
        };
