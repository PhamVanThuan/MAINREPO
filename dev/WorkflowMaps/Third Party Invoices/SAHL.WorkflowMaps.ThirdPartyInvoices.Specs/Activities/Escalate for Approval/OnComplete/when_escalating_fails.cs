...
namespace SAHL.WorkflowMaps.ThirdPartyInvoices.Specs.Activities.Escalate_for_Approval.OnComplete
{
    ...
    internal class when_escalating_fails : WorkflowSpecThirdPartyInvoices
    {
        ...
        private Establish context = () =>
        {
            ...
            workflowAssignment.WhenToldTo(x => x.AssignCaseToSpecificUserInCapability(Param.IsAny<ISystemMessageCollection>(), GenericKeyType.ThirdPartyInvoice, Param.IsAny<int>(),
                Param.IsAny<long>(), Capability.InvoiceApprover, Param.IsAny<IServiceRequestMetadata>(), Param.IsAny<int>())).Return(false);
        ...
        {
            thirdPartyInvoices.WasNotToldTo(x => x.EscalateThirdPartyInvoiceForApproval(Param.IsAny<ISystemMessageCollection>(), Param.IsAny<int>(), Param.IsAny<int>(),
