...
{
    public class when_an_active_client_role_does_not_exist_in_our_system : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            applicationDataManager.WhenToldTo(x => x.IsActiveClientRole(check.ApplicationRoleKey)).Return(false);
        ...
        {
            systemMessages.ErrorMessages().First().Message.ShouldEqual("There is no active client role for the provided offer role.");
        };
    }
}