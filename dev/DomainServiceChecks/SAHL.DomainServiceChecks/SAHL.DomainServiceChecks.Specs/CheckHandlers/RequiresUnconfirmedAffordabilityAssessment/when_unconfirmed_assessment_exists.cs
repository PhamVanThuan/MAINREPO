...
{
    public class when_unconfirmed_assessment_exists : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            affordabilityAssessmentDataModel = new AffordabilityAssessmentDataModel(0, 0, 0, (int)AffordabilityAssessmentStatus.Unconfirmed, 0, 0, DateTime.Now, 0, 0, 0, null, null, null);
