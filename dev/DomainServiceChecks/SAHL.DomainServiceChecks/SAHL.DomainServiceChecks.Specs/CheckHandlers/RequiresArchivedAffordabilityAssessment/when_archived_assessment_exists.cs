...
{
    public class when_archived_assessment_exists : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            affordabilityAssessmentDataModel = new AffordabilityAssessmentDataModel(0, 0, 0, (int)AffordabilityAssessmentStatus.Confirmed, (int)GeneralStatus.Inactive, 0, DateTime.Now, 0, 0, 0, null, null, null);
