...
{
    public class when_a_pending_disability_claim_does_not_exist : WithFakes
    {
        ...
        private Establish context = () =>
            {
                ...
                disabilityClaim = new DisabilityClaimDataModel(1, 1, DateTime.Now.AddDays(-5), DateTime.Now.AddMonths(-1), DateTime.Now.AddDays(-20),
                    "Rally Driver", (int)DisabilityType.HeadInjury, "Mental", DateTime.Now.AddYears(1), (int)DisabilityClaimStatus.Approved, DateTime.Now.AddMonths(4),
        ...
        private It should_contain_error_messages = () =>
            {
                systemMessages.ErrorMessages().First().Message.ShouldEqual("Disability Claim status should be pending to perform this operation.");
            };
    }
}