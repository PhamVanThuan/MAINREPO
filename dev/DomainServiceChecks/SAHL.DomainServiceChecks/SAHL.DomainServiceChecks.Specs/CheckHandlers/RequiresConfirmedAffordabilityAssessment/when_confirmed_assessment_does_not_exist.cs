...
{
    public class when_confirmed_assessment_does_not_exist : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            affordabilityAssessmentDataModel = new AffordabilityAssessmentDataModel(0, 0, 0, (int)AffordabilityAssessmentStatus.Unconfirmed, 0, DateTime.Now, 0, 0, 0, null, null, null);
        ...
        {
            systemMessages.ErrorMessages().First().Message.ShouldEqual("Affordability assessment status should be confirmed to perform this operation.");
        };
    }
}