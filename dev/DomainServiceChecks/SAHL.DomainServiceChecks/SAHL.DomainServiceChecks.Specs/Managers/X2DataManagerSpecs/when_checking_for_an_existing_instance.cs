...
{
    public class when_checking_for_an_existing_instance : WithCoreFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            fakeDbFactory.FakedDb.InReadOnlyAppContext().WhenToldTo(x => x.SelectOne<int>(Param<DoesInstanceExistStatement>.Matches(y => y.InstanceId == InstanceId))).Return(1);
        };
        ...
        private It should_return_that_the_true = () =>
        {
