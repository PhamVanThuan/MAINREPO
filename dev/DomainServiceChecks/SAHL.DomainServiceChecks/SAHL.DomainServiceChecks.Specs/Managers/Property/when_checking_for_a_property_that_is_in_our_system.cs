...
namespace SAHL.DomainService.Check.Specs.Managers.Property
{
    public class when_checking_for_a_property_that_is_in_our_system : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            fakeDbFactory.FakedDb.InReadOnlyAppContext().WhenToldTo(x => x.SelectOne<int>(Param.IsAny<PropertyExistsStatement>())).Return(1);
        };
        ...
        {
            propertyExistsResponse.ShouldBeTrue();
        };
    }
}