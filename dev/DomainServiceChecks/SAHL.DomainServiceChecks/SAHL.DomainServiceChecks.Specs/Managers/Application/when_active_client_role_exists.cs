...
{
    public class when_active_client_role_exists : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            fakeDbFactory.FakedDb.InReadOnlyAppContext().WhenToldTo(x => x.SelectOne<int>(Param.IsAny<IsActiveClientRoleStatement>())).Return(1);
        };
        ...
        {
            isActiveClientRole.ShouldEqual(true);
        };
    }
}