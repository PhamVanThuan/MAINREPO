...
{
    public class when_open_application_does_not_exist : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            fakeDbFactory.FakedDb.InReadOnlyAppContext().WhenToldTo(x => x.SelectOne<int>(Param.IsAny<IsOpenApplicationStatement>())).Return(0);
        };
        ...
        {
            isOpenApplication.ShouldBeFalse();
        };
    }
}