...
namespace SAHL.DomainServiceCheck.Specs.Managers.Application
{
    public class when_latest_application_information_is_not_open : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            fakeDbFactory.FakedDb.InReadOnlyAppContext().WhenToldTo(x => x.SelectOne<int>(Param.IsAny<IsLatestApplicationInformationOpenStatement>())).Return(0);
        };
        ...
        private It should_not_be_open = () =>
        {
            isLatestApplicationInformationOpen.ShouldEqual(false);
        };
    }
}