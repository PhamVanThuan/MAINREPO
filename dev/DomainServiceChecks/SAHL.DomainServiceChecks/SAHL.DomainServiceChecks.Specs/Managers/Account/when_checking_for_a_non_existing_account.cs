...
{
    public class when_checking_for_a_non_existing_account : WithCoreFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            fakeDbFactory.FakedDb.InReadOnlyAppContext().WhenToldTo(x => x.SelectOne<int>(Param.IsAny<AccountExistsStatement>())).Return(0);
        };
        ...
        {
            accountExistsResponse.ShouldBeFalse();
        };
    }
}