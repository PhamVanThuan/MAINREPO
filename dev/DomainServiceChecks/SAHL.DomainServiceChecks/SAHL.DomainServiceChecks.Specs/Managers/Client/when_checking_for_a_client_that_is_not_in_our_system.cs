...
{
    public class when_checking_for_a_client_that_is_not_in_our_system : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            fakeDbFactory.FakedDb.InReadOnlyAppContext().WhenToldTo(x => x.SelectOne<int>(Param.IsAny<ClientExistsStatement>())).Return(0);
        };
        ...
        private It should_acknolewdge_that_the_client_does_not_exists_in_our_system = () =>
        {
            clientExistsResponse.ShouldBeFalse();
        };
    }
}