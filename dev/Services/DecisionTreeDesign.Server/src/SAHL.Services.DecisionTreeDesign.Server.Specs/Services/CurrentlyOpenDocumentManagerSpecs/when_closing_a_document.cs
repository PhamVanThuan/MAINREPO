...
namespace SAHL.Services.DecisionTreeDesign.Server.Specs.Services.CurrentlyOpenDocumentManagerSpecs
{
    ...
    public class when_closing_a_document : WithFakes
    {
        ...
        It should_close_document_for_user = () =>
        {
            currentlyOpenDocumentDataManager.WasToldTo(x => x.CloseDocument(documentVersionId, username));
        };
    }
}
