...
namespace SAHL.Services.DecisionTreeDesign.QueryStatements
{
    ...
    public class GetEnumerationAtVersionQueryStatement : IServiceQuerySqlStatement<GetEnumerationAtVersionQuery, GetEnumerationSetQueryResult>
    {
        public string GetStatement()
        {
            return @"SELECT TOP 1 es.[Id],es.[Version],es.[Data],CASE WHEN pes.Publisher IS NULL THEN 0 ELSE 1 END as IsPublished,ISNULL(pes.Publisher,'') as Publisher
