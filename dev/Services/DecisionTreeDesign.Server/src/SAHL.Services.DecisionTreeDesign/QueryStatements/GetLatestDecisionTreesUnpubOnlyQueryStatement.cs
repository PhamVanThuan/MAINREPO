...
namespace SAHL.Services.DecisionTreeDesign.QueryStatements
{
    ...
    public class GetLatestDecisionTreesUnpubOnlyQueryStatement : IServiceQuerySqlStatement<GetLatestDecisionTreesUnpubOnlyQuery, GetLatestDecisionTreesUnpubOnlyQueryResult>
    {
