...
{
    public partial class ComcorpProgressLiveReply : IServiceProjector<RegistrationsLoanRegisteredLegacyEvent, ICommunicationsServiceClient>
    {
        public void Handle(RegistrationsLoanRegisteredLegacyEvent @event, IServiceRequestMetadata metadata, ICommunicationsServiceClient service)
        {
