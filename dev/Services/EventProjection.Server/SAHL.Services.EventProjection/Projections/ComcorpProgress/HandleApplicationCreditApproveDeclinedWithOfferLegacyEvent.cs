...
{
    public partial class ComcorpProgressLiveReply : IServiceProjector<ApproveApplicationCreditApproveDeclinedWithOfferLegacyEvent, ICommunicationsServiceClient>
    {
        public void Handle(ApproveApplicationCreditApproveDeclinedWithOfferLegacyEvent @event, IServiceRequestMetadata metadata, ICommunicationsServiceClient service)
        {
