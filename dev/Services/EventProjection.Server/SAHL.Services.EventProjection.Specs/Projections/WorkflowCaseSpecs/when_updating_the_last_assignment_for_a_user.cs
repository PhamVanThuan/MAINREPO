...
{
    public class when_updating_the_last_assignment_for_a_user : WithFakes
    {
        private static IDbFactory dbFactory;
        private static UpdateCurrentlyAssignedUserForInstanceHandler handler;
        ...
        private Establish that = () =>
        {
            ...
            dbFactory
                ...
                .Return(userName);
            handler = new UpdateCurrentlyAssignedUserForInstanceHandler(dbFactory);
        ...
        private It should_have_updated_the_projection = () =>
        {
            dbFactory
                .NewDb()
                .InAppContext()
                .WasToldTo(a => a.ExecuteNonQuery(Param<UpdateCurrentlyAssignedUserForInstanceStatement>
