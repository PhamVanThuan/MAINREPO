...
{
    public class when_creating_an_UpdateLastAssignmentForUser_statement : WithFakes
    {
        Establish that = () =>
        {
            instanceId = 1L;
        ...
        private Because of = () =>
        {
            statement = new UpdateCurrentlyAssignedUserForInstanceStatement(instanceId, capabilityKey, userOrganisationStructureKey, genericKeyTypeKey, genericKey, userName);
        };
        ...
        private static UpdateCurrentlyAssignedUserForInstanceStatement statement;
