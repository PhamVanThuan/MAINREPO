...
namespace SAHL.Services.EventProjection.Specs.Projections.AttorneyInvoiceMonthlyBreakdownSpecs.RejectedPostApprovalHandler
{
    public class when_rejected_post_approval : WithFakes
    {
        private static ICombGuid combGuidGenerator;
        private static ThirdPartyInvoiceRejectedPostApprovalEvent thirdPartyInvoiceRejectedEvent;
        private static IServiceProjector<ThirdPartyInvoiceRejectedPostApprovalEvent, ICommunicationsServiceClient> projector;
        ...
        private Establish context = () =>
        {
            ...
            thirdPartyInvoiceRejectedEvent = new ThirdPartyInvoiceRejectedPostApprovalEvent(
                  DateTime.Now
                , 378264
