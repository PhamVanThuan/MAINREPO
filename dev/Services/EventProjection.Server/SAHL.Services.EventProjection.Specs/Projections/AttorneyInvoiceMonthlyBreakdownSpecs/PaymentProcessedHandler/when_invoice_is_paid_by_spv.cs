...
{
    public class when_invoice_is_paid_by_spv : WithFakes
    {
        ...
        private Establish context = () =>
         {
             invoice = new ThirdPartyInvoiceDataModel(1, "sahl_reference", 1, 1428540, Guid.NewGuid(), "invoice_number", null, "clintons@sahomeloans.com", 5000.00M, 5000.00M, 5000.00M, false,
