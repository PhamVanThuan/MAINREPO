...
{
    internal class when_account_is_under_debt_counselling : WithFakes
    {
        ...
        {
            invoice = new ThirdPartyInvoiceDataModel(1, "sahl_reference", 1, 1428540, Guid.NewGuid(), "invoice_number", null, "clintons@sahomeloans.com", 1000.00M, 0.00M, 1000.00M, false,
            ...
            monthlyBreakdownManager.WhenToldTo(x => x.IsAccountUnderDebtCounselling(invoice.AccountKey)).Return(true);
        ...
        private It should_increase_the_debt_review_value = () =>
        {
            monthlyBreakdownDataManager.WasToldTo(x => x.UpdatePaymentFieldsForAttorney(invoice.ThirdPartyId.GetValueOrDefault(), invoiceTotalValue, invoiceTotalValue, 0.00M));
        };
    }
}