...
{
    public class when_inserting_for_invoice_rejection_post_approval : WithFakes
    {
        ...
        private Establish that = () =>
        {
            ...
            @event = new ThirdPartyInvoiceRejectedPostApprovalEvent(DateTime.Now, 1408282, "attorney@straussdaly.co.za", "InvoiceNumber", @"SAHL\ClintonS", "Rejection Comments", "SAHL_Reference",
