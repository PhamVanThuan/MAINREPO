...
{
    public class when_inserting_correspondence_for_invoice_query_post_approval : WithFakes
    {
        ...
        private Establish that = () =>
        {
            ...
            @event = new ThirdPartyInvoiceQueriedPostApprovalEvent(DateTime.Now, 1222, @"SAHL\ClintonS", "QueryComments");
