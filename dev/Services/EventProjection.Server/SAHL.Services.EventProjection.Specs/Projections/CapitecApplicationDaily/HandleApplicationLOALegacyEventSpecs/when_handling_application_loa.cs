...
namespace SAHL.Services.EventProjection.Specs.Projections.CapitecApplicationDaily.HandleApplicationLOALegacyEventSpecs
{
    [Subject("SAHL.Services.EventProjection.Projections.CapitecApplicationDaily.CapitecApplicationDaily.HandleApplicationLOALegacyEvent")]
    public class when_handling_application_loa : WithFakes
    {
        private static CapitecApplicationDailyReport projection;
        private static AppProgressInLOALegacyEvent appProgressInLOALegacyEvent;
        ...
        private Establish context = () =>
        {
            ...
            appProgressInLOALegacyEvent = new AppProgressInLOALegacyEvent(
        ...
        private Because of = () =>
        {
            projection.Handle(appProgressInLOALegacyEvent, metadata);
        };
