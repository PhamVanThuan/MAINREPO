...
namespace SAHL.Services.EventProjection.Specs.Projections.CapitecApplicationDaily.HandleApplicationCreditLegacyEventSpecs
{
    [Subject("SAHL.Services.EventProjection.Projections.CapitecApplicationDaily.CapitecApplicationDaily.HandleApplicationCreditLegacyEvent")]
    public class when_handling_application_capture : WithFakes
    {
        private static CapitecApplicationDailyReport projection;
        private static AppProgressInCreditLegacyEvent applicationCreditEvent;
        ...
        private Establish context = () =>
        {
            ...
            applicationCreditEvent = new AppProgressInCreditLegacyEvent(
