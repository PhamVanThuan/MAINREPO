...
namespace SAHL.Services.EventProjection.Specs.Projections.CapitecApplicationDaily.HandleApplicationNTUFinalizedLegacyEventSpecs
{
    [Subject("SAHL.Services.EventProjection.Projections.CapitecApplicationDaily.CapitecApplicationDaily.HandleApplicationNTUFinalizedLegacyEvent")]
    public class when_handling_application_ntu : WithFakes
    {
        private static CapitecApplicationDailyReport projection;
        private static ApplicationNTUFinalizedLegacyEvent applicationNTUFinalizedLegacyEvent;
        ...
        private Establish context = () =>
        {
            ...
            applicationNTUFinalizedLegacyEvent = new ApplicationNTUFinalizedLegacyEvent(
        ...
        private Because of = () =>
        {
            projection.Handle(applicationNTUFinalizedLegacyEvent, metadata);
        };
