...
namespace SAHL.Services.EventProjection.Specs.Projections.CapitecApplicationDaily.HandleApplicationRegistrationStartedLegacyEventSpecs
{
    ...
    public class when_handling_application_registration_started : WithFakes
    {
        private static CapitecApplicationDailyReport projection;
        private static AppProgressRegistrationStartedLegacyEvent appProgressRegistrationStartedLegacyEven;
        ...
        private Establish context = () =>
        {
            ...
            appProgressRegistrationStartedLegacyEven = new AppProgressRegistrationStartedLegacyEvent(
        ...
        private Because of = () =>
        {
            projection.Handle(appProgressRegistrationStartedLegacyEven, metadata);
        };
