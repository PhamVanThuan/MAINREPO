...
namespace SAHL.Services.EventProjection.Specs.Projections.CapitecApplicationDaily.HandleApplicationCaptureLegacyEventSpecs
{
    [Subject("SAHL.Services.EventProjection.Projections.CapitecApplicationDaily.CapitecApplicationDaily.HandleApplicationCaptureLegacyEvent")]
    public class when_handling_application_capture : WithFakes
    {
        private static CapitecApplicationDailyReport projection;
        private static AppProgressInApplicationCaptureLegacyEvent applicationCaptureEvent;
        ...
        private Establish context = () =>
        {
            ...
            applicationCaptureEvent = new AppProgressInApplicationCaptureLegacyEvent(
        ...
        private Because of = () =>
        {
            projection.Handle(applicationCaptureEvent, metadata);
        };
