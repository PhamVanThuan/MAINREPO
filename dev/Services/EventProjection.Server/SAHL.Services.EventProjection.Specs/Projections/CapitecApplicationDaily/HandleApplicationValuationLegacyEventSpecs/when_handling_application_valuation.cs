...
namespace SAHL.Services.EventProjection.Specs.Projections.CapitecApplicationDaily.HandleApplicationValuationLegacyEventSpecs
{
    [Subject("SAHL.Services.EventProjection.Projections.CapitecApplicationDaily.CapitecApplicationDaily.HandleApplicationValuationLegacyEvent")]
    public class when_handling_application_valuation : WithFakes
    {
        private static CapitecApplicationDailyReport projection;
        private static AppProgressInValuationLegacyEvent appProgressInValuationLegacyEvent;
        ...
        private Establish context = () =>
        {
            ...
            appProgressInValuationLegacyEvent = new AppProgressInValuationLegacyEvent(
                ...
                Param<string>.IsAnything,
                Param<string>.IsAnything,
                Param<AppProgressEnum>.IsAnything
            );
        ...
        private Because of = () =>
        {
            projection.Handle(appProgressInValuationLegacyEvent, metadata);
        };
        ...
        private It should_get_commissionable_consultants_phone_number = () =>
        {
            dbFactory.FakedDb.DbReadOnlyContext.WasToldTo(x => x.SelectOne<ConsultantInfoDataModel>(Param<GetConsultantLegalEntityDetailsStatement>.IsAnything));
        };
