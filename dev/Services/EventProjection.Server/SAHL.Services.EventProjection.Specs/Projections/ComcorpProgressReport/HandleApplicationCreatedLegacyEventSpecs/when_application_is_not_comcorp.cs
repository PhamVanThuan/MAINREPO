...
namespace SAHL.Services.EventProjection.Specs.Projections.ComcorpProgressReport.HandleApplicationCreatedLegacyEventSpecs
{
    [Subject("namespace SAHL.Services.EventProjection.Projections.ComcorpProgress.IsComcorpApplicationLegacyEvent")]
    public class when_application_is_not_comcorp : WithFakes
    {
        private static IServiceProjector<IsComcorpApplicationLegacyEvent, ICommunicationsServiceClient> projector;
        private static IsComcorpApplicationLegacyEvent @event;
        ...
        private Establish context = () =>
        {
            ...
            @event = new IsComcorpApplicationLegacyEvent(
