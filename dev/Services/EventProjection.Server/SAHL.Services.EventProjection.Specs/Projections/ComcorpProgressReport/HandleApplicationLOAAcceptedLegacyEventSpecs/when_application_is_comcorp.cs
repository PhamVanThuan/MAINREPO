...
namespace SAHL.Services.EventProjection.Specs.Projections.ComcorpProgressReport.HandleApplicationLOAAcceptedLegacyEventSpecs
{
    [Subject("namespace SAHL.Services.EventProjection.Projections.ComcorpProgress.ComcorpProgressReport.HandleApplicationLOAAcceptedLegacyEvent")]
    public class when_application_is_comcorp : WithFakes
    {
        private static IServiceProjector<AppProgressLOAAcceptedLegacyEvent, ICommunicationsServiceClient> projector;
        private static AppProgressLOAAcceptedLegacyEvent @event;
        ...
        private Establish context = () =>
        {
            ...
            @event = new AppProgressLOAAcceptedLegacyEvent(
