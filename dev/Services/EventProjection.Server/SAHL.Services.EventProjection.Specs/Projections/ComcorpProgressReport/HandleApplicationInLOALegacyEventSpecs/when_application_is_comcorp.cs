...
namespace SAHL.Services.EventProjection.Specs.Projections.ComcorpProgressReport.HandleApplicationInLOALegacyEventSpecs
{
    [Subject("namespace SAHL.Services.EventProjection.Projections.ComcorpProgress.ComcorpProgressReport.HandleApplicationInLOALegacyEvent")]
    public class when_application_is_comcorp : WithFakes
    {
        private static IServiceProjector<AppProgressInLOALegacyEvent, ICommunicationsServiceClient> projector;
        private static AppProgressInLOALegacyEvent @event;
        ...
        private Establish context = () =>
        {
            ...
            @event = new AppProgressInLOALegacyEvent(
