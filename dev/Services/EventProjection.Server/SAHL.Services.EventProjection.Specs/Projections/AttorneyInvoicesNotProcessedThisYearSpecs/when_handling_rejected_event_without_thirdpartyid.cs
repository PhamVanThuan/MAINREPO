...
namespace SAHL.Services.EventProjection.Specs.Projections.AttorneyInvoicesNotProcessedThisYearSpecs
{
    ...
    {
        private static InvoicesNotProcessedThisYearRejectedHandler handler;
        ...
        private Establish context = () =>
         {
             ...
             thirdPartyInvoiceModel = new ThirdPartyInvoiceDataModel("reference", 111210, 112, Guid.Empty, "FF0011", DateTime.Now, null, invoiceValue, 0.00M, invoiceValue,
             ...
             handler = new InvoicesNotProcessedThisYearRejectedHandler(dataManager, breakdownDataManager);
         };
        ...
        {
            dataManager.WasNotToldTo(x => x.DecrementCountAndDecreaseYearlyValue(invoiceValue));
        };
    }
}