...
namespace SAHL.Services.EventProjection.Specs.Projections.AttorneyInvoicesNotProcessedThisMonthSpecs
{
    ...
    {
        private static InvoicesNotProcessedThisMonthCapturedHandler handler;
        ...
        private Establish context = () =>
         {
             ...
             handler = new InvoicesNotProcessedThisMonthCapturedHandler(dataManager);
         };
        ...
        private It should_increase_the_paid_count = () =>
         {
             dataManager.WasToldTo(x => x.IncrementCountAndIncreaseMonthlyValue(@event.ThirdPartyInvoiceModel.TotalAmountIncludingVAT));
         };
    }
}