...
{
    public class ThirdPartyInvoiceDocumentListRepresentation : Representation, IListRepresentation
    {
        ...
        public ThirdPartyInvoiceDocumentListRepresentation(ILinkResolver linkResolver, IList<Representation> list)
        {
