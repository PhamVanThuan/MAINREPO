...
{
   public class ThirdPartyInvoiceListRepresentation : Representation, IListRepresentation
    {
        ...
        public ThirdPartyInvoiceListRepresentation(ILinkResolver linkResolver, IList<Representation> list) 
        {
