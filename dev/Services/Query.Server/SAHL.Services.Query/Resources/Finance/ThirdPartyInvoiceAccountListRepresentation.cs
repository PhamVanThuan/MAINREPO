...
{
   public class ThirdPartyInvoiceAccountListRepresentation : Representation, IListRepresentation
    {
        ...
        public ThirdPartyInvoiceAccountListRepresentation(ILinkResolver linkResolver, IList<Representation> list) 
        {
