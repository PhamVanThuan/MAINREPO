...
{
    public class InvoiceLineItemDescriptionListRepresentation : Representation, IListRepresentation
    {
        ...
        public InvoiceLineItemDescriptionListRepresentation(ILinkResolver linkResolver, IList<Representation> list) 
        {
