...
namespace SAHL.Services.Query.Resources.ThirdParty
{
    ...
    public class ThirdPartyContactInformationListRepresentation : Representation, IListRepresentation
    {
        ...
        public ThirdPartyContactInformationListRepresentation(ILinkResolver linkResolver, IList<Representation> list) 
        {
