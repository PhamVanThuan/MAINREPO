...
namespace SAHL.Services.Query.Resources.ThirdParty
{
   ...
   public class ThirdPartyPaymentBankAccountListRepresentation: Representation, IListRepresentation
    {
        ...
        public ThirdPartyPaymentBankAccountListRepresentation(ILinkResolver linkResolver, IList<Representation> list) 
        {
