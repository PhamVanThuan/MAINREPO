...
namespace SAHL.Services.Query.Resources.Process
{
    ...
    public class ProcessListRepresentation : Representation, IListRepresentation
    {
        ...
        public ProcessListRepresentation(ILinkResolver linkResolver, IList<Representation> list)
        {
