...
{
    //[RootRepresentation]
    public class AttorneyListRepresentation : Representation, IListRepresentation
    {
        ...
        public AttorneyListRepresentation(ILinkResolver linkResolver, IList<Representation> list) 
        {
