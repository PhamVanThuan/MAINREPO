...
{
    public class GetLookupsStatement : ISqlStatement<LookupDataModel>
    {
        ...
        public GetLookupsStatement(string database, string lookupType, string schema, string keyColumn, string descriptionColumn)
        {
        ...
        {
            string queryString = string.Format("Select {3} as Id, {4} as Description From [{0}].[{1}].[{2}]", Database,
