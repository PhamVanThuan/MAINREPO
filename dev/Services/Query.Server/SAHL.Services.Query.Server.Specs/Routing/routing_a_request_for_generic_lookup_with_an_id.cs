...
{
    public class routing_a_request_for_generic_lookup_with_an_id : WithFakes
    {
        Establish that = () =>
        {
            ...
            requestMessage = new HttpRequestMessage(httpMethod, "http://localhost/api/lookup/" + lookUpType + "/" + id);
        };
