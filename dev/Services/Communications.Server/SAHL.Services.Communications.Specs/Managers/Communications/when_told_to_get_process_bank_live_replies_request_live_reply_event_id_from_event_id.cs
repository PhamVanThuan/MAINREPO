...
{
    public class when_told_to_get_process_bank_live_replies_request_live_reply_event_id_from_event_id : WithFakes
    {
        ...
        {
            eventId = (int)ComcorpEventStatusEnum.Submitted;
        ...
        {
            processBankLiveRepliesRequestLiveReplyEventId.ShouldNotBeNull();
        };
    }
}