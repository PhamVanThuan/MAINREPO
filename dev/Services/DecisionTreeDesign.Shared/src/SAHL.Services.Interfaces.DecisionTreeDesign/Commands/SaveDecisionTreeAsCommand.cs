...
namespace SAHL.Services.Interfaces.DecisionTreeDesign.Commands
{
    ...
    public class SaveDecisionTreeAsCommand : ServiceCommand, IDecisionTreeServiceCommand
    {
        public SaveDecisionTreeAsCommand(Guid decisionTreeId, string name, string description, bool isActive, Guid decisionTreeVersionId, string data, string username, string thumbnail) 
        {
