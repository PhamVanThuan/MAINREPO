...
namespace SAHL.Services.Interfaces.Capitec.Tests.Commands
{
    ...
    public partial class CommandConventions
    {
        ...
        {
            ICapitecServiceCommand command = null;
            ...
            if (command == null)
            {
                command = (ICapitecServiceCommand)assembly.CreateInstance(commandType.FullName, false, BindingFlags.CreateInstance, null, constructorArgs.ToArray(), null, new object[] { });
            }
        ...
        public void Custom()
        {
            CheckCommandConstructorParametersAreSetOnProperties(typeof(CreateSAHomeLoansNewPurchaseApplicationCommand));
        }
    }
}