...
{
    public class when_batch_is_not_processed : WithFakes
    {
        ...
        Establish context = () =>
        {
            ...
            catsBatchRecord = new CATSPaymentBatchDataModel(cATSPaymentBatchKey: 96, cATSPaymentBatchTypeKey: (int)CATSPaymentBatchType.ThirdPartyInvoice,
                createdDate: DateTime.Now, processedDate: DateTime.Now, cATSPaymentBatchStatusKey: (int)CATSPaymentBatchStatus.Failed, cATSFileSequenceNo: 1,
        ...
        It should_add_error_messages = () =>
        {
            messages.ErrorMessages().First().Message.ShouldEqual("The batch provided is not in processed state.");
        };
    }
}
