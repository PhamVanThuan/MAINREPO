...
namespace SAHL.Services.CATS.Server.Specs.Rules.bankingDetails.Target
{
    public class when_account_name_is_longer_than_30_characters : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            var bankAccountDataModel = new BankAccountDataModel(1, "50024", "03214001", 1, "SAHL", "Tom", DateTime.Now);
            targetBankAccountDataModel = new BankAccountDataModel(1, "50024", "03210012", 1, accountName, "Tom", DateTime.Now);
        ...
        private It should_return_an_account_name_out_of_error_message = () =>
        {
            messages.ErrorMessages()
                .Where(X => X.Message.Equals("Invalid account name: " + accountName + ". The target account's account name should not be longer than 30 characters."))
            .ShouldNotBeEmpty();
        };
