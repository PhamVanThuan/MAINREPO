...
{
    public class when_a_file_is_in_the_failure_directory : WithFakes
    {
        ...
        private Establish context = () =>
         {
             ...
             fileSystem.File.WhenToldTo(x => x.Exists(catsConfigSsettings.CATSOutputFileLocation + filename)).Return(false);
             fileSystem.File.WhenToldTo(x => x.Exists(catsConfigSsettings.CATSFailureFileLocation + filename)).Return(true);
         };
        ...
        private It should_check_if_the_file_is_in_the_sendfailure_directory = () =>
         {
             fileSystem.File.WasToldTo(x => x.Exists(catsConfigSsettings.CATSFailureFileLocation + filename));
         };
