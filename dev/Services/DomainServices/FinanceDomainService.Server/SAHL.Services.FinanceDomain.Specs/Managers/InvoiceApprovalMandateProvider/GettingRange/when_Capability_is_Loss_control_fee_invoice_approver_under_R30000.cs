...
{
    public class when_capability_is_Loss_control_fee_invoice_approver_under_R30000 : WithFakes
    {
        ...
        {
            providedAuthoriserCapability = LossControlFeeInvoiceApproverCapability.Loss_Control_Fee_Invoice_Approver_Under_R30000;
            expectedRange = new Tuple<decimal, decimal>(15000.00M, 29999.99M);
        ...
        private It should_return_mandated_range_15K_to_30K = () =>
        {
