...
{
    public class when_capability_is_loss_control_fFee_invoice_approver_under_R15000 : WithFakes
    {
        ...
        {
            providedAuthoriserCapability = LossControlFeeInvoiceApproverCapability.LOSS_CONTROL_FEE_INVOICE_APPROVER_UNDER_R15000;
            expectedRange = new Tuple<decimal, decimal>(0.00M, 14999.99M);
        ...
        private It should_return_mandated_range_less_than_15K = () =>
        {
