...
{
    public class when_capability_is_invoice_approver_over_R60000 : WithFakes
    {
        ...
        {
            providedAuthoriserCapability = LossControlFeeInvoiceApproverCapability.INVOICE_APPROVER_OVER_R60000;
            expectedRange = new Tuple<decimal, decimal>(60000.00M, decimal.MaxValue);
        ...
        private It should_return_mandated_range_greater_than_60K = () =>
        {
