...
{
    public class when_invoice_amount_from_R60K : WithFakes
    {
        ...
        private It should_not_return_Loss_control_fee_invoice_approver_under_R15000 = () =>
        {
            sandatedCapabilities.Any(x => x.Equals(LossControlFeeInvoiceApproverCapability.LOSS_CONTROL_FEE_INVOICE_APPROVER_UNDER_R15000, StringComparison.Ordinal)).ShouldBeFalse();
        };

        private It should_not_return_Loss_control_fee_invoice_approver_under_R30000 = () =>
        {
            sandatedCapabilities.Any(x => x.Equals(LossControlFeeInvoiceApproverCapability.Loss_Control_Fee_Invoice_Approver_Under_R30000, StringComparison.Ordinal)).ShouldBeFalse();
        };

        private It should_not_return_should_return_Loss_control_fee_invoice_approver_up_to_R60000 = () =>
        {
            sandatedCapabilities.Any(x => x.Equals(LossControlFeeInvoiceApproverCapability.LOSS_CONTROL_FEE_INVOICE_APPROVER_UP_TO_R60000, StringComparison.Ordinal)).ShouldBeFalse();
        };
