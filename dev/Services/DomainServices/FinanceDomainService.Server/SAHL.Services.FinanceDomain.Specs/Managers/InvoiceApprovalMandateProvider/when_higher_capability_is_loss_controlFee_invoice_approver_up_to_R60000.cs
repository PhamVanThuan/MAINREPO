...
{
    public class when_higher_capability_is_loss_controlFee_invoice_approver_up_to_R60000 : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            capabilities = new string[3] {LossControlFeeInvoiceApproverCapability.LOSS_CONTROL_FEE_INVOICE_APPROVER_UP_TO_R60000
        ...
        private It should_return_loss_controlFee_invoice_approver_up_to_R60000 = () =>
        {
            capabilityWithHigherMandate.Equals(LossControlFeeInvoiceApproverCapability.LOSS_CONTROL_FEE_INVOICE_APPROVER_UP_TO_R60000).ShouldBeTrue();
        };
    }
}