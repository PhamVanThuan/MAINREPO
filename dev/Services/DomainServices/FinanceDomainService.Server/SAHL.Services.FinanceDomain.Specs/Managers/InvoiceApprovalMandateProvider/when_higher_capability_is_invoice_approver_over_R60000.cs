...
{
    public class when_higher_capability_is_invoice_approver_over_R60000 : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            capabilities = new string[4] {LossControlFeeInvoiceApproverCapability.INVOICE_APPROVER_OVER_R60000
                ,LossControlFeeInvoiceApproverCapability.LOSS_CONTROL_FEE_INVOICE_APPROVER_UP_TO_R60000
                ,LossControlFeeInvoiceApproverCapability.LOSS_CONTROL_FEE_INVOICE_APPROVER_UNDER_R15000 
                 ,LossControlFeeInvoiceApproverCapability.Loss_Control_Fee_Invoice_Approver_Under_R30000 };
        ...
        private It should_return_invoice_approver_up_to_R60000 = () =>
        {
            capabilityWithHigherMandate.Equals(LossControlFeeInvoiceApproverCapability.INVOICE_APPROVER_OVER_R60000).ShouldBeTrue();
        };
    }
}