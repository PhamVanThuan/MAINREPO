...
{
    public class when_the_payment_ref_has_changed : WithFakes
    {
        ...
        private Establish context = () =>
            {
                ...
                oldInvoice = new ThirdPartyInvoiceDataModel(1111, "SAHL-2015/05/1111", (int)InvoiceStatus.Received, 1408282, thirdPartyId, "Inv/11//11/222", DateTime.MinValue,
                    "test@sahomeloans.com", null, null, null, true, DateTime.Now, "Old Payment Reference");
                newInvoice = new ThirdPartyInvoiceModel(1111, thirdPartyId, "Inv/11//11/222", DateTime.MinValue, Enumerable.Empty<InvoiceLineItemModel>(), true, "New Payment Reference");
