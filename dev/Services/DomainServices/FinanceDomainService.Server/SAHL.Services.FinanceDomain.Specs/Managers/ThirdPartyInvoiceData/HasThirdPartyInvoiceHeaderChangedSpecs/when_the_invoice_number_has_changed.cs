...
{
    public class when_the_invoice_number_has_changed : WithFakes
    {
        ...
        private Establish context = () =>
            {
                ...
                oldInvoice = new ThirdPartyInvoiceDataModel(1111, "SAHL-2015/05/1111", (int)InvoiceStatus.Received, 1408282, thirdPartyId, "Inv/9/99/999", DateTime.MinValue,
                    "test@sahomeloans.com", null, null, null, true, DateTime.Now, string.Empty);
                
                newInvoice = new ThirdPartyInvoiceModel(1111, thirdPartyId, "Inv/11//11/222", DateTime.MinValue, Enumerable.Empty<InvoiceLineItemModel>(), true, string.Empty);
