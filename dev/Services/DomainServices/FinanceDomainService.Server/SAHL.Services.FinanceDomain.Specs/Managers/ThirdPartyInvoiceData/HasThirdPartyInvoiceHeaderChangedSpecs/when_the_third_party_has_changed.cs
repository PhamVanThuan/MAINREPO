...
{
    public class when_the_third_party_has_changed : WithFakes
    {
        ...
        private Establish context = () =>
            {
                ...
                oldInvoice = new ThirdPartyInvoiceDataModel(1111, "SAHL-2015/05/1111", (int)InvoiceStatus.Received, 1408282, Guid.NewGuid(), "Inv/11//11/222", DateTime.MinValue,
                    "test@sahomeloans.com", null, null, null, true, DateTime.Now, string.Empty);
                
                newInvoice = new ThirdPartyInvoiceModel(1111, Guid.NewGuid(), "Inv/11//11/222", DateTime.MinValue, Enumerable.Empty<InvoiceLineItemModel>(), true, string.Empty);
