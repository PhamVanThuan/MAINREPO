...
{
    public class when_the_invoice_date_has_not_been_captured : WithFakes
    {
        ...
        {
            dataModel = new ThirdPartyInvoiceDataModel(1, "SAHL_Reference", 1, 1, Guid.NewGuid(), "Invoice_Number", null, "clintons@sahomeloans.com",
        ...
        {
            messages.ErrorMessages().First().Message.ShouldEqual("The Invoice Date has not been captured.");
        };
