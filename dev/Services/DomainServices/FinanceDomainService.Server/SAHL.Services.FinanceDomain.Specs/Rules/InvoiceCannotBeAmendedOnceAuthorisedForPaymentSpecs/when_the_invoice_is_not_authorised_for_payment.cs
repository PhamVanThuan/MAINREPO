...
{
    public class when_the_invoice_is_not_authorised_for_payment : WithFakes
    {
        ...
        {
            dataModel = new ThirdPartyInvoiceDataModel(1, "SAHL_Reference", (int)InvoiceStatus.Received, 1, Guid.NewGuid(), "Invoice_Number", DateTime.Now, "clintons@sahomeloans.com",
