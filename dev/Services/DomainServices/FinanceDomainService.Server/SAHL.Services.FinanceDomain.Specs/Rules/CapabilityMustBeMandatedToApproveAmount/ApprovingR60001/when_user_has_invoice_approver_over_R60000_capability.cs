...
namespace SAHL.Services.FinanceDomain.Specs.Rules.CapabilityMustBeMandatedToApproveAmount.ApprovingR60001
{
    public class when_user_has_invoice_approver_over_R60000_capability : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            invoiceLineItems = new List<InvoiceLineItemModel> { new InvoiceLineItemModel(null,1212, 1, 30001.00M, true),
                new InvoiceLineItemModel(null,1110, 1, 30000.00M, true) };
