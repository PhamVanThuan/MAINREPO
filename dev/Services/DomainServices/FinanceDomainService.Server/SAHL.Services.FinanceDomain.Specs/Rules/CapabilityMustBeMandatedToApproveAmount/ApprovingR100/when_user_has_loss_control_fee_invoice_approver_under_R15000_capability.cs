...
{
    public class when_user_has_loss_control_fee_invoice_approver_under_R15000_capability : WithFakes
    {
        private static IThirdPartyInvoiceApprovalMandateProvider thirdPartyInvoiceApprovalMandateProvider;
        private static UserWithApproverUnderR15000CapabilityCannotApproveInvoicesGreaterThanR15000Rule thirdPartyInvoiceApprovalRoleAmountRule;
        ...
        {
            approverCapability = LossControlFeeInvoiceApproverCapability.LOSS_CONTROL_FEE_INVOICE_APPROVER_UNDER_R15000;
            thirdPartyInvoiceApprovalMandateProvider = An<IThirdPartyInvoiceApprovalMandateProvider>();
            thirdPartyInvoiceApprovalRoleAmountRule = new UserWithApproverUnderR15000CapabilityCannotApproveInvoicesGreaterThanR15000Rule(thirdPartyInvoiceApprovalMandateProvider);
            ...
            thirdPartyInvoiceApprovalMandateProvider.WhenToldTo(y => y.GetMandatedRange(approverCapability))
                .Return(new Tuple<decimal, decimal>(0.00M, 14999.99M));
        };
