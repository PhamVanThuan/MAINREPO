...
namespace SAHL.Services.FinanceDomain.Specs.Rules.CapabilityMustBeMandatedToApproveAmount.ApprovingR30000
{
    public class when_user_has_invoice_approver_over_R60000_capability : WithFakes
    {
        ...
        private static UserWithApproverAboveR60000CapabilityCanApproveAnyInvoicesAmountRule thirdPartyInvoiceApprovalRoleAmountRule;
        ...
        private Establish context = () =>
        {
            ...
            thirdPartyInvoiceApprovalRoleAmountRule = new UserWithApproverAboveR60000CapabilityCanApproveAnyInvoicesAmountRule(thirdPartyInvoiceApprovalMandateProvider);
            systemMessages = SystemMessageCollection.Empty();

            invoiceLineItems = new List<InvoiceLineItemModel> { new InvoiceLineItemModel(null,1212, 1, 15000.00M, true),
                new InvoiceLineItemModel(null,1110, 1, 15000.00M, true) };
