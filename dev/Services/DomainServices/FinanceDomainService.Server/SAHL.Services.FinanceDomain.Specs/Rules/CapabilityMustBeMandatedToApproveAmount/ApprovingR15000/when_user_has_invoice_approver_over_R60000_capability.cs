...
namespace SAHL.Services.FinanceDomain.Specs.Rules.CapabilityMustBeMandatedToApproveAmount.ApprovingR15000
{
    public class when_user_has_invoice_approver_over_R60000_capability : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            invoiceLineItems = new List<InvoiceLineItemModel> { new InvoiceLineItemModel(null,1212, 1, 7500.00M, true),
                new InvoiceLineItemModel(null,1110, 1, 7500.00M, true) };
