...
{
    public class when_payment_has_been_processed : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            invoice = new ThirdPartyInvoiceDataModel(1, "reference", (int)InvoiceStatus.ProcessingPayment, 1428540, Guid.NewGuid(), "invoiceNumber", DateTime.Now, "clintons@sahomeloans.com",
