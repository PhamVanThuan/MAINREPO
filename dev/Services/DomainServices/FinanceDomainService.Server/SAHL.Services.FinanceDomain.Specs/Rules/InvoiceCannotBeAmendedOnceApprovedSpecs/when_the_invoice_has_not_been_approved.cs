...
{
    public class when_the_invoice_has_not_been_approved : WithFakes
    {
        ...
        {
            dataModel = new ThirdPartyInvoiceDataModel(1, "SAHL_Reference", (int)InvoiceStatus.Received, 1, Guid.NewGuid(),
