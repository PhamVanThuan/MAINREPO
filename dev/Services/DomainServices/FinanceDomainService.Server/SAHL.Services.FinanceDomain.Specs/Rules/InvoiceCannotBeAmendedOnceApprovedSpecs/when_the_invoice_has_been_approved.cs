...
namespace SAHL.Services.FinanceDomain.Specs.Rules.InvoiceCannotBeAmendedOnceApprovedSpecs
{
    public class when_the_invoice_has_been_approved : WithFakes
    {
        private static InvoiceCannotBeAmendedOnceApprovedRule rule;
        ...
        {
            dataModel = new ThirdPartyInvoiceDataModel(1, "SAHL_Reference", (int)InvoiceStatus.Approved, 1, Guid.NewGuid(),
                "Invoice_Number", DateTime.Now, "clintons@sahomeloans.com", null, null, null, true, DateTime.Now, string.Empty);
            ...
            rule = new InvoiceCannotBeAmendedOnceApprovedRule(dataManager);
        };
        ...
        private It should_return_an_error_message = () =>
            {
                messages.ErrorMessages().First().Message.ShouldEqual("An Approved Invoice cannot be amended.");
            };
