...
{
    public class when_the_third_party_has_not_been_captured : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            dataModel = new ThirdPartyInvoiceDataModel(1, "SAHLRef", 1, 1408282, null, "invoiceNumber", DateTime.Now, "clintons@sahomeloans.com", null, null, null, true,
