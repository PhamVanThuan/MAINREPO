...
{
    public class when_one_does_not_exist_against_another_invoice_for_the_same_third_party : WithFakes
    {
        ...
        private Establish context = () =>
         {
             ...
             ruleModel = new ThirdPartyInvoiceModel(5555, Guid.NewGuid(), invoiceNumber, DateTime.Now.AddDays(-5), new InvoiceLineItemModel[]{ 
