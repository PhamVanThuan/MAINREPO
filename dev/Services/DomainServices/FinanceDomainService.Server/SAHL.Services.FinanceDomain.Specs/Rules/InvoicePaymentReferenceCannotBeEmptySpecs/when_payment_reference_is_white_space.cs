...
{
    public class when_payment_reference_is_white_space : WithFakes
    {
        ...
        Establish context = () =>
        {
            ruleModel = new ThirdPartyInvoiceModel(1, Guid.NewGuid(), "Invoice_Number", DateTime.Now, new List<InvoiceLineItemModel>(), true, "           ");
