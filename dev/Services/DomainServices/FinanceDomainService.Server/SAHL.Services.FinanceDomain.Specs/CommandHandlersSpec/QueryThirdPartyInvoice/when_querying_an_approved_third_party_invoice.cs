...
{
    public class when_querying_an_approved_third_party_invoice : WithCoreFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            dataManager.WhenToldTo(x => x.HasThirdPartyInvoiceBeenApproved(thirdPartyInvoiceKey)).Return(true);
        };
        ...
        private It should_confirm_that_invoice_has_been_approved = () =>
        {
        ...
        {
            eventRaiser.WasToldTo(x => x.RaiseEvent(Arg.Any<DateTime>(), Arg.Is<ThirdPartyInvoiceQueriedPostApprovalEvent>(y => y.ThirdPartyInvoiceKey == command.ThirdPartyInvoiceKey
