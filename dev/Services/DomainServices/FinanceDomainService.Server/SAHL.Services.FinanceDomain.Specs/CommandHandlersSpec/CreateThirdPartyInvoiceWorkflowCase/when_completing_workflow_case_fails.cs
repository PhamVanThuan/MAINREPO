...
{
    public class when_completing_workflow_case_fails : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            {
                y.Result = new X2Response(Guid.NewGuid(), missingNodeSupportingThirdPartInvoicesErrMessage, 1234, false);
