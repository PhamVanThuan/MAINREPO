...
{
    public class when_posting_capitalised_invoice : WithFakes
    {
        ...
        private It should_not_process_the_non_reversal_transaction_types = () =>
         {
             ...
             var validTransactionTypes = new List<LoanTransactionTypeEnum>() {
                    LoanTransactionTypeEnum.CapitalisedLegalFeeTransaction
             };
