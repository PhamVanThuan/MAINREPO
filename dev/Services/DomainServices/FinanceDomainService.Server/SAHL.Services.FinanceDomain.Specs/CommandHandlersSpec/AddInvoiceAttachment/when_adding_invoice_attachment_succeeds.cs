...
{
    public class when_adding_invoice_attachment_succeeds : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            attachment = new InvoiceAttachment(fileName, fileExtension, "Something");
            ...
            documentManager.WhenToldTo(x => x.PerformCommand(Param.IsAny<StoreAttorneyInvoiceCommand>(), 
                Param.IsAny<IServiceRequestMetadata>())).Return(storeManagerMessages);
        };
