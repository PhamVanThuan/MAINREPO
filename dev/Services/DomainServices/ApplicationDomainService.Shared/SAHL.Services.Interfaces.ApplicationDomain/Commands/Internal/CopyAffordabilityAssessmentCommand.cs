...
{
    public class CopyAffordabilityAssessmentCommand : ServiceCommand, IApplicationDomainInternalCommand
    {
        public CopyAffordabilityAssessmentCommand(AffordabilityAssessmentModel affordabilityAssessment)
        {
