...
{
    public class AmendAffordabilityAssessmentCommand : ServiceCommand, IApplicationDomainCommand
    {
        public AmendAffordabilityAssessmentCommand(AffordabilityAssessmentModel affordabilityAssessment)
        {
