...
{
    public class when_the_creditcheck_declaration_is_null : WithFakes
    {
        ...
        {
            ex.Message.ShouldEqual("The PermissiontoConductCreditCheckDeclaration field is required.");
        };
    }
}