...
{
    public class when_the_debtreview_declaration_is_null : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            debtCounsellingDeclaration = null;
        ...
        {
            ex.Message.ShouldEqual("The CurrentlyUnderDebtReviewDeclaration field is required.");
        };
    }
}