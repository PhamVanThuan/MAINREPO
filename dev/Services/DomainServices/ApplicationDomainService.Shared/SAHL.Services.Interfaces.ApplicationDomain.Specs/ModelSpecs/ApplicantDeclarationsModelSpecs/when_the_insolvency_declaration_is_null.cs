...
{
    public class when_the_insolvency_declaration_is_null : WithFakes
    {
        ...
        {
            ex.Message.ShouldEqual("The DeclaredInsolventDeclaration field is required.");
        };
    }
}