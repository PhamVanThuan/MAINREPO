...
{
    internal class When_creating_a_valid_AddApplicantAffordabilitiesCommand
    {
        ...
        private Because of = () =>
        {
            command = new AddApplicantAffordabilitiesCommand(Param.IsAny<ApplicantAffordabilityModel>());
        };
