...
{
    internal class When_creating_a_valid_UpdateAffordabilityAssessmentCommand
    {
        ...
        private Because of = () =>
        {
            command = new UpdateAffordabilityAssessmentCommand(Param.IsAny<AffordabilityAssessmentModel>());
        };
