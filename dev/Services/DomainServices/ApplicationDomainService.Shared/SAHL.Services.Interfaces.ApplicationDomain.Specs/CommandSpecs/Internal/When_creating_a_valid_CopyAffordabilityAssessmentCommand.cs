...
{
    internal class When_creating_a_valid_CopyAffordabilityAssessmentCommand
    {
        ...
        private Because of = () =>
        {
            command = new CopyAffordabilityAssessmentCommand(Param.IsAny<AffordabilityAssessmentModel>());
        };
