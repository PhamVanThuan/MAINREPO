...
{
    internal class When_creating_a_valid_AddRefinanceApplicationCommand
    {
        ...
        private Because of = () =>
        {
            command = new AddRefinanceApplicationCommand(Param.IsAny<RefinanceApplicationModel>(), Param.IsAny<Guid>());
        };
