...
{
    internal class When_creating_a_valid_AmendAffordabilityAssessmentCommand
    {
        ...
        private Because of = () =>
        {
            command = new AmendAffordabilityAssessmentCommand(Param.IsAny<AffordabilityAssessmentModel>());
        };
