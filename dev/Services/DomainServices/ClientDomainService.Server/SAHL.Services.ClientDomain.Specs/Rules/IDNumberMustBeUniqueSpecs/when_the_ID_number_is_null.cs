...
{
    public class when_the_ID_number_is_null : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            model = new NaturalPersonClientModel(null, string.Empty, SalutationType.Mr, "Clint", "Speed", "C", "Clint", Gender.Male,
        ...
        {
            validationUtils.WasNotToldTo(x => x.ValidateIDNumber(Param.IsAny<string>()));
        };
