...
{
    public class when_client_address_is_not_a_pending_domicilum_address : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            domiciliumDataManager.WhenToldTo(x => x.IsClientAddressPendingDomicilium(ruleModel.ClientAddresskey)).Return(false);
        };
