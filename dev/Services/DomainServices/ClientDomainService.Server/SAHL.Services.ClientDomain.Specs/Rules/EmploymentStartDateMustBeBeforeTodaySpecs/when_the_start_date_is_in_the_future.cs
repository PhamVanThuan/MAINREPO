...
{
    public class when_the_start_date_is_in_the_future : WithFakes
    {
        private static EmploymentStartDateMustBeBeforeTodayRule<SalaryDeductionEmploymentModel> rule;
        ...
        {
            messages.ErrorMessages().First().Message.ShouldContain("The start date of a current employment record cannot be in the future.");
        };
    }
}