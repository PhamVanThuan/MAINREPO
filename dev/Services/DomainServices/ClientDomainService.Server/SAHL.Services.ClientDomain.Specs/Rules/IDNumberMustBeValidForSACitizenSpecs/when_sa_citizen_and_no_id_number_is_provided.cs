...
namespace SAHL.Services.ApplicationDomain.Specs.RuleSpecs.IDNumberMustBeValidForSACitizen
{
    public class when_sa_citizen_and_no_id_number_is_provided : WithFakes
    {
