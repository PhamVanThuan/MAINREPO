...
{
    public class when_non_resident_and_an_invalid_passport_number_is_provided : WithFakes
    {
        ...
        {
            messages.ErrorMessages().First().Message.ShouldEqual("The passport number must be more than 6 digits.");
        };
    }
}
