...
{
    public class when_no_valid_details_are_provided : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            model = new ClientContactDetailsTestModel(string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty);
