...
{
    public class when_a_valid_email_address_is_provided : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            model = new ClientContactDetailsTestModel(string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, "test@gmail.com");
