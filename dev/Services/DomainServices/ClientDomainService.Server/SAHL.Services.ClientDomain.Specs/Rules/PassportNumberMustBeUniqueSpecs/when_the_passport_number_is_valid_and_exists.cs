...
{
    public class when_the_passport_number_is_valid_and_exists : WithFakes
    {
        ...
        {
            existingClient = new LegalEntityDataModel(1, null, null, null, null, DateTime.Now, null, "Clint", "C", "Speed", "",
                                                     "8211045229080", "A03396521", "", "", "", "", null, "", "", "", "", "", "",
        ...
        private It should_ensure_the_passport_number_is_valid = () =>
        {
            validationUtils.WasToldTo(x => x.ValidatePassportNumber(model.PassportNumber));
        };
        ...
        private It should_return_an_error_message = () =>
        {
            messages.ErrorMessages().First().Message.ShouldEqual
                (string.Format("A client with passport number {0} already exists", model.PassportNumber));
        };
    }
}