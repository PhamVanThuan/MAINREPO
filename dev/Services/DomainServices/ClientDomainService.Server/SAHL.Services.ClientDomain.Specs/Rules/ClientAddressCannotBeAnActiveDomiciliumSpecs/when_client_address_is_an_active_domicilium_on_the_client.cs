...
{
    public class when_client_address_is_an_active_domicilium_on_the_client : WithFakes
    {
        ...
        Establish context = () =>
        {
            ...
            domiciliumAddressDataManager.WhenToldTo(x => x.IsClientAddressActiveDomicilium(ruleModel.ClientAddresskey, ruleModel.ClientKey)).Return(true);
        };
