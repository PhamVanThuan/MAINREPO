...
{
    public class when_an_existing_client_has_a_null_DOB : WithCoreFakes
    {
        ...
        private static DateTime? newDateOfBirth = DateTime.Now.AddYears(-31);
        private static DateTime? oldDateOfBirth = null;
        ...
        private Establish context = () =>
        {
            ...
            existingActiveClient = new LegalEntityDataModel(1, 1, 1, 1, DateTime.Now, 1, "Clint", "C", "Speed", "Clint", "8211045229080", string.Empty, "0944500587", string.Empty, string.Empty,
                string.Empty, oldDateOfBirth, "031", "5647788", "031", "5713036", "0825548000", "clintonspeed@gmail.com", "0861", "900000", string.Empty, 1, 1, string.Empty,
        ...
        private It should_update_the_date_of_birth_to_new_value_provided = () =>
        {
            clientDataManager.WasToldTo(x => x.UpdateLegalEntity(Arg.Is<LegalEntityDataModel>(y => y.DateOfBirth == activeNaturalPersonClientModel.DateOfBirth)));
        };
    }
}