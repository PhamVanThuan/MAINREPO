...
{
    class when_address_is_not_linked_to_client : WithCoreFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            assetLiabilityDataManager.WhenToldTo(x => x.CheckIsAddressLinkedToClientAsFixedPropertyAsset(Param.IsAny<int>(), 
