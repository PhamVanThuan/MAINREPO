...
{
    public class when_saving_other_asset_liabity_fails : WithCoreFakes
    {
        ...
        {
            assetLiabilityDataManager.WasToldTo(x => x.SaveOtherAsset(Arg.Is<OtherAssetModel>(y => y.Description == otherAsset.Description)));
        };
