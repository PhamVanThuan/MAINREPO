...
{
    public class when_adding_a_valid_other_asset : WithCoreFakes
    {
        ...
        Establish context = () =>
        {
            ...
            assetLiabilityDataManager.WhenToldTo
              (x => x.SaveOtherAsset(Param.IsAny<OtherAssetModel>()))
                .Return(assetLiabilityKey);
            ...
            unitOfWorkFactory.WhenToldTo
             (x => x.Build()).Return(unitOfWork);
        };
        ...
        private It should_raise_other_asset_added_event = () =>
        {
