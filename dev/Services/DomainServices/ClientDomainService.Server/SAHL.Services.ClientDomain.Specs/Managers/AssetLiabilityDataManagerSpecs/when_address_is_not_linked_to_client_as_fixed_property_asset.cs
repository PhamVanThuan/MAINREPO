...
{
    public class when_address_is_not_linked_to_client_as_fixed_property_asset : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            dbFactory.FakedDb.DbReadOnlyContext.WhenToldTo(x => x.SelectOne(Param.IsAny<ISqlStatement<int>>())).Return(0);
        };
        ...
        {
            dbFactory.FakedDb.DbReadOnlyContext.WasToldTo(x => x.SelectOne(Param.IsAny<IsAddressLinkedToClientAsGivenAssetTypeStatement>()));
        };
