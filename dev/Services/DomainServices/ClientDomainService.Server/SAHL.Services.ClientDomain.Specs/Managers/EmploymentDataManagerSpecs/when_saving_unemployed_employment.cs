...
{
    internal class when_saving_unemployed_employment : WithFakes
    {
        static EmploymentDataManager dataManager;
        static int clientKey;
        static UnemployedEmploymentModel model;
        private static FakeDbFactory dbFactory;
        static EmployerModel employer;
        Establish context = () =>
        {
            dbFactory = new FakeDbFactory();
            employer = new EmployerModel(3099, "Unemployed", "031", "1234567", null, null, EmployerBusinessType.Unknown, EmploymentSector.FinancialServices);
            model = new UnemployedEmploymentModel(10000, 25, employer, DateTime.MinValue, UnemployedRemunerationType.RentalIncome, EmploymentStatus.Current);
            clientKey = 2;
        ...
        Because of = () =>
        {
            dataManager.SaveUnemployedEmployment(clientKey, model);
        };
