...
{
    public class when_rate_configuration_is_not_provided : WithFakes
    {
        ...
        private static RateConfigurationValuesModel RateConfigurationValues = null;
        ...
        {
            ex.Message.ShouldEqual("RateConfigurationValuesModel must be provided.");
        };
    }
}