...
namespace SAHL.Services.Interfaces.PropertyDomain.Events
{
    public class ComcorpOfferPropertyDetailsAddedEvent : Event
    {
        public ComcorpOfferPropertyDetailsAddedEvent(DateTime date, string sellerIDNo, string sahlOccupancyType, string sahlPropertyType, string sahlTitleType, string sectionalTitleUnitNo, 
            string complexName, string streetNo, string streetName, string suburb, string city, string province, string postalCode, string contactCellphone, string contactName, 
            string namePropertyRegistered, string standErfNo, string portionNo)
            : base(date)
        {
