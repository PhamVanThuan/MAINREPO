...
namespace SAHL.Services.Interfaces.PropertyDomain.Queries
{
    public class GetPropertyByAddressQuery : ServiceQuery<GetPropertyByAddressQueryResult>, IPropertyDomainQuery, ISqlServiceQuery<GetPropertyByAddressQueryResult>
    {
        public GetPropertyByAddressQuery(string unitNumber, string buildingName, string buildingNumber, string streetNumber, string streetName, string suburb,
                                         string city, string province, string postalCode, string erfNumber, string erfPortionNumber)
        {
