...
namespace SAHL.PropertyDomainService.Specs.CommandHandlersSpec.AddProperty
{
    public class when_adding_an_existing_comcorp_offer_property_details : WithCoreFakes
    {
        ...
        {
            propertyDataManager.WasToldTo(x => x.UpdateComcorpOfferPropertyDetails(Param.IsAny<ComcorpOfferPropertyDetailsDataModel>()));
        };
    }
}