...
{
    public class InstanceReturnedToLastUserInCapabilityEvent : Event
    {
        ...
        public InstanceReturnedToLastUserInCapabilityEvent(DateTime date, int genericKeyTypeKey, int genericKey, long instanceId, int userOrganisationStructureKey, int capabilityKey)
            : base(date)
        {
