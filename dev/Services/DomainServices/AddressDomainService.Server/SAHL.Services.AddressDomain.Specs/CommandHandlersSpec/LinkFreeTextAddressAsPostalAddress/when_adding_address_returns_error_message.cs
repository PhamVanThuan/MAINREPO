    ...
    public class when_adding_address_returns_error_message : WithCoreFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            serviceCommandRouter
                .WhenToldTo(x => x.HandleCommand(Param.IsAny<AddFreeTextAddressCommand>(), Param.IsAny<IServiceRequestMetadata>()))
        ...
        private It should_not_raise_a_free_text_postal_address_linked_to_client_event = () =>
        {
            eventRaiser.WasNotToldTo(x =>
                x.RaiseEvent(
