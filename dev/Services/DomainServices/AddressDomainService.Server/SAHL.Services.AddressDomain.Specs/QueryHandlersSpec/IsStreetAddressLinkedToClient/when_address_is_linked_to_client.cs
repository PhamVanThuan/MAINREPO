...
namespace SAHL.Services.Interfaces.AddressDomain.Specs.QueryHandlersSpec.IsStreetAddressLinkedToClient
{
    class when_address_is_linked_to_client : WithFakes
    {
        ...
        private It should_determine_if_there_a_client_linked_to_address = () =>
        {
        ...
        private It should_set_the_query_result = () =>
        {
            ...
            query.Result.Results.FirstOrDefault().ClientAddressKey.ShouldEqual(legalEntityAddress.LegalEntityAddressKey);
        };
    }
}
