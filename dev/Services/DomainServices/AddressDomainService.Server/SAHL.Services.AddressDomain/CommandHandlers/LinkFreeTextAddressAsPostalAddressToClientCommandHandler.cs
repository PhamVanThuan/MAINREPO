...
{
    public class LinkFreeTextAddressAsPostalAddressToClientCommandHandler : IDomainServiceCommandHandler<LinkFreeTextAddressAsPostalAddressToClientCommand, FreeTextPostalAddressLinkedToClientEvent>
    {
        ...
        public LinkFreeTextAddressAsPostalAddressToClientCommandHandler(IServiceCommandRouter serviceCommandRouter, IAddressDataManager addressDataManager, ICombGuid combGuid,
        ...
        public ISystemMessageCollection HandleCommand(LinkFreeTextAddressAsPostalAddressToClientCommand command, IServiceRequestMetadata metadata)
        {
            ...
            using (var uow = unitOfWorkFactory.Build())
            {
                ...
                var clientAddress = new ClientAddressModel(command.ClientKey, freeTextAddressKey, AddressType.Postal);
                ...
                if (!messages.HasErrors)
                {
                    ...
                    var @event = new FreeTextPostalAddressLinkedToClientEvent(DateTime.Now, command.FreeTextAddressModel.FreeText1, command.FreeTextAddressModel.FreeText2, 
