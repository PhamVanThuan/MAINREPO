...
{
    public class FreeTextPostalAddressLinkedToClientEvent : Event
    {
        public FreeTextPostalAddressLinkedToClientEvent(DateTime date, string freeText1, string freeText2, string freeText3,
