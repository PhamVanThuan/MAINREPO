...
{
    public class LinkFreeTextAddressAsPostalAddressToClientCommand : ServiceCommand, IAddressDomainCommand, IRequiresClient
    {
        [Required]
        ...
        public LinkFreeTextAddressAsPostalAddressToClientCommand(FreeTextAddressModel freeTextAddressModel, int clientKey, Guid clientAddressGuid)
        {
