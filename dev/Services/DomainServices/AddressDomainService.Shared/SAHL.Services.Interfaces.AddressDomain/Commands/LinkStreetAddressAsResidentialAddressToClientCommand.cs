...
{
    public class LinkStreetAddressAsResidentialAddressToClientCommand : ServiceCommand, IAddressDomainCommand, IRequiresClient
    {
        [Required]
        ...
        public LinkStreetAddressAsResidentialAddressToClientCommand(StreetAddressModel streetAddressModel, int clientKey, Guid clientAddressGuid)
        {
