...
{
    public class when_the_link_exists_and_is_inactive : WithCoreFakes
    {
        ...
        private static int clientKey, clientBankAccountKey, bankAccountKey;
        ...
        private Establish context = () =>
        {
            ...
            existingClientBankAccount = new LegalEntityBankAccountDataModel[] 
                                            { 
                                                new LegalEntityBankAccountDataModel(clientBankAccountKey, clientKey, bankAccountKey, (int)GeneralStatus.Inactive, "5050", null) 
                                            };
        ...
        private It should_reactivate_the_link = () =>
        {
            bankAccountDataManager.WasToldTo(x => x.ReactivateClientBankAccount(existingClientBankAccount.First().LegalEntityBankAccountKey));
        };
