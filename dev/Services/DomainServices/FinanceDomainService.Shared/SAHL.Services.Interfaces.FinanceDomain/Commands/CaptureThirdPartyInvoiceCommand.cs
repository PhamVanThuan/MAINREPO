...
{
    public class CaptureThirdPartyInvoiceCommand : ServiceCommand, IFinanceDomainCommand, IRequiresThirdPartyInvoice, IRequiresThirdParty
    {
        ...
        public CaptureThirdPartyInvoiceCommand(ThirdPartyInvoiceModel thirdPartyInvoiceModel)
        {
