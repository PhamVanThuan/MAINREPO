...
{
    public class when_funding_an_application_that_is_accepted : WithFakes
    {
        private static ApplicationMayNotBeAcceptedWhenFundingNewBusinessApplicationRule rule;
        ...
        private Establish context = () =>
        {
            ...
            OfferInformationDataModel notAcceptedOfferInfo = new OfferInformationDataModel(DateTime.Now, applicationNumber, (int)OfferInformationType.AcceptedOffer, "someone", null, null);
            financialDataManager.WhenToldTo(x => x.GetLatestApplicationOfferInformation(applicationNumber)).Return(notAcceptedOfferInfo);
            rule = new ApplicationMayNotBeAcceptedWhenFundingNewBusinessApplicationRule(financialDataManager);
        ...
        {
            messages.ErrorMessages().First().Message.ShouldEqual(ApplicationMayNotBeAcceptedWhenFundingNewBusinessApplicationRule.ErrorMessage);
        };
    }
}