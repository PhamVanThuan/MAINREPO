...
{
    public class when_pricing_an_application_that_is_accepted : WithFakes
    {
        ...
        {
            messages.ErrorMessages().First().Message.ShouldEqual(ApplicationMayNotBeAcceptedWhenPricingNewBusinessApplicationRule.ErrorMessage);
        };
    }
}