...
{
    public class when_funding_an_application_that_is_not_a_new_mortgageloan : WithFakes
    {
        ...
        {
            messages.ErrorMessages().First().Message.ShouldEqual(ApplicationMustBeANewBusinessMortgageLoanWhenFundingRule.ErrorMessage);
        };
    }
}