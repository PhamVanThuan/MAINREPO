...
{
    public class when_pricing_application_given_capitalised_fees : WithCoreFakes
    {
        ...
        private static bool capitaliseFees = true;
        ...
        private Establish context = () =>
        {
            ...
            loanAmountNoFees = mortgageLoanApplicationInformation.LoanAmountNoFees + originationFees.InterimInterest;
            totalLoanAmount = loanAmountNoFees + originationFees.TotalFees();
