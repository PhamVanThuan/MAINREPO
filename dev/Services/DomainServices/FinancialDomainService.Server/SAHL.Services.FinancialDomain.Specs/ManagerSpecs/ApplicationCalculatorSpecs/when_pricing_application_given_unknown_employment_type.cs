...
{
    public class when_pricing_application_given_unknown_employment_type : WithCoreFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            financialDataManager.WhenToldTo(x => x.DetermineCreditCriteria(mortgageLoanApplicationInformation.MortgageLoanPurpose, EmploymentType.Salaried, totalLoanAmount, ltvPercentage, mortgageLoanApplicationInformation.OriginationSource, Product.NewVariableLoan, mortgageLoanApplicationInformation.HouseholdIncome)).Return(creditCriteria);
        ...
        {
            financialDataManager.WasToldTo(x => x.DetermineCreditCriteria(mortgageLoanApplicationInformation.MortgageLoanPurpose, EmploymentType.Salaried, totalLoanAmount, ltvPercentage, mortgageLoanApplicationInformation.OriginationSource, Product.NewVariableLoan, mortgageLoanApplicationInformation.HouseholdIncome));
        };
