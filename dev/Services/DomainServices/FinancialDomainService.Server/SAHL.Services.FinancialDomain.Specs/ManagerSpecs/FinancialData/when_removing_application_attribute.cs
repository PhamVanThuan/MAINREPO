...
{
    public class when_removing_application_attribute : WithCoreFakes
    {
        ...
        private Because of = () =>
        {
            financialDataManager.RemoveApplicationAttribute(applicationNumber, offerAttributeTypeKey);
        };

        private It should_delete_the_application_attribute = () =>
        {
            dbFactory.FakedDb.InAppContext().WasToldTo(x => x.Delete<int>(Arg.Is<RemoveApplicationAttributeStatement>(y => y.ApplicationNumber == applicationNumber
