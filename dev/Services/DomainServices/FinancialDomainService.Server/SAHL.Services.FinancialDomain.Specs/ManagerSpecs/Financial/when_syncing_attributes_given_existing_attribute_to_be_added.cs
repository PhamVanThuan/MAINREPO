...
{
    public class when_syncing_attributes_given_existing_attribute_to_be_added : WithCoreFakes
    {
        ...
        private It should_not_add_the_application_attribute = () =>
        {
            financialDataManager.WasNotToldTo(x => x.AddApplicationAttribute(applicationNumber, offerAttributeTypeToAdd));
        };
    }
}
