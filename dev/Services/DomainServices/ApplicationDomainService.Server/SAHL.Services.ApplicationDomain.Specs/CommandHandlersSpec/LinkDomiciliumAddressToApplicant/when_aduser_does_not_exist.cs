...
{
    public class when_aduser_does_not_exist : WithCoreFakes
    {
        ...
        Establish context = () =>
        {
            ...
            applicantDataManager.WhenToldTo(
                x => x.GetActiveApplicationRole(applicantDomiciliumAddressModel.ApplicationNumber
                    , applicantDomiciliumAddressModel.ClientKey)).Return(applicationRoleDataModel);
        ...
        It should_attempt_retrieve_the_aduser_key = () =>
        {
        ...
        It should_contain_correct_error_message = () =>
        {
