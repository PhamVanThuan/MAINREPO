...
{
    public class when_amending_an_affordability_assessment_given_an_unconfirmed_ass : WithCoreFakes
    {
        ...
        {
            affordabilityAssessmentModel = new AffordabilityAssessmentModel(0, 0, AffordabilityAssessmentStatus.Unconfirmed, DateTime.Now, 0, 0, 0, new List<int>(), null, null);
        ...
        private It should_call_the_update_command = () =>
        {
            serviceCommandRouter.WasToldTo(x => x.HandleCommand(Param.IsAny<UpdateAffordabilityAssessmentCommand>(), serviceRequestMetaData));
        };
