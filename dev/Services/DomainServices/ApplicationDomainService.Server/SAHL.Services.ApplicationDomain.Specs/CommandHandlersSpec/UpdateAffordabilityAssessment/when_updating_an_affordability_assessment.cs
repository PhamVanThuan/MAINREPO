...
{
    public class when_updating_an_affordability_assessment : WithCoreFakes
    {
        private static UpdateAffordabilityAssessmentCommand command;
        private static UpdateAffordabilityAssessmentCommandHandler handler;
        ...
        private Establish context = () =>
        {
            ...
            command = new UpdateAffordabilityAssessmentCommand(affordabilityAssessmentModel);
            handler = new UpdateAffordabilityAssessmentCommandHandler(adUserManager, affordabilityAssessmentManager);
        };
        ...
        {
            affordabilityAssessmentManager.WasToldTo(x => x.UpdateAffordabilityAssessmentAndAffordabilityAssessmentItems(affordabilityAssessmentModel, 99));
        };
    }
}