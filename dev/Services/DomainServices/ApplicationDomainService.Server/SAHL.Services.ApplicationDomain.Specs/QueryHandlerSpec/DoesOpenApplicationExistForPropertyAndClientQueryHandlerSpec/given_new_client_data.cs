...
{
    public class given_new_client_data : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            applicationDataManager.WhenToldTo(x => x.DoesOpenApplicationExistForPropertyAndClient(Param.IsAny<int>(), Param.IsAny<string>())).Return(false);
        };
        ...
        {
            query.Result.Results.First().ShouldBeFalse();
        };
    }
}