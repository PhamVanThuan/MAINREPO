...
namespace SAHL.Services.ApplicationDomain.Specs.QueryHandlerSpec.GetBondInstalmentForApplicationQueryHandlerSpec
{
    public class given_a_further_lending_application : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            affordabilityAssessmentManager.WhenToldTo(x => x.GetBondInstalmentForFurtherLendingApplication(Param.IsAny<int>())).Return(Param.IsAny<double>());
        ...
        {
            affordabilityAssessmentManager.WasToldTo(x => x.GetBondInstalmentForFurtherLendingApplication(0));
        };
    }
}