...
namespace SAHL.Services.ApplicationDomain.Specs.QueryHandlerSpec.GetHocInstalmentForApplicationQueryHandlerSpec
{
    public class given_a_new_business_application : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            affordabilityAssessmentManager.WhenToldTo(x => x.GetHocInstalmentForNewBusinessApplication(Param.IsAny<int>())).Return(Param.IsAny<double>());
        ...
        {
            affordabilityAssessmentManager.WasToldTo(x => x.GetHocInstalmentForNewBusinessApplication(0));
        };
    }
}