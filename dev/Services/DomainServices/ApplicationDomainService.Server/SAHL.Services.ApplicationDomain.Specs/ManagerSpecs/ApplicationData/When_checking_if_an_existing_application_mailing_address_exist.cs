...
{
    public class when_checking_if_an_existing_application_mailing_address_exist : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            dbFactory.FakedDb.DbReadOnlyContext.WhenToldTo(x => x.Select<int>(Param.IsAny<DoesApplicationMailingAddressExistStatement>())).Return(new int[] { 1 });
        };
