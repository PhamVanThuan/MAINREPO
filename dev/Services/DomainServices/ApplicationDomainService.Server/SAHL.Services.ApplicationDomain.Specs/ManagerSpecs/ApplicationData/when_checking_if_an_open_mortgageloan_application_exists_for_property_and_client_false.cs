...
{
    public class when_checking_if_an_open_mortgageloan_application_exists_for_property_and_client_false : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            dbFactory.FakedDb.DbReadOnlyContext.WhenToldTo(x => x.SelectOne<int>(Param.IsAny<DoesOpenApplicationExistForPropertyAndClientStatement>())).Return(0);
        };
