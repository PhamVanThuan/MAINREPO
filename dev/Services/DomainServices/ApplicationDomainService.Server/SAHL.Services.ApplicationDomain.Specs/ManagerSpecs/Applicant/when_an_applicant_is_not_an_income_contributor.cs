...
{
    public class when_an_applicant_is_not_an_income_contributor : WithFakes
    {
        ...
        {
            attributes = new OfferRoleAttributeDataModel[] { new OfferRoleAttributeDataModel(12345, applicantRoleKey, (int)OfferRoleAttributeType.ReturningClient) };
