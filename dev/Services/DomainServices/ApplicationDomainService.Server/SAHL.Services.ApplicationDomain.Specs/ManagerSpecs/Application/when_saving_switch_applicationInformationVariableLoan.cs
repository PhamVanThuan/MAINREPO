...
{
    public class when_saving_switch_applicationInformationVariableLoan : WithCoreFakes
    {
        ...
        Establish context = () =>
        {
            ...
            cashOut = 70000;
            loanAmountNoFees = existingLoan + cashOut;
        ...
        Because of = () =>
        {
            applicationManager.SaveSwitchApplicationInformationVariableLoan(offerInformationKey, term, existingLoan, estimatedPropertyValue, cashOut, loanAmountNoFees);
        };
        ...
        It should_ask_the_application_data_manager_to_to_save_the_application_information_variable_loan_model = () =>
        {
            applicationDataManager.WasToldTo(x => x.SaveApplicationInformationVariableLoan(Arg.Is<OfferInformationVariableLoanDataModel>(
                    y => y.OfferInformationKey == offerInformationKey &&
                         y.Term == term &&
                         y.ExistingLoan == (double)existingLoan &&
