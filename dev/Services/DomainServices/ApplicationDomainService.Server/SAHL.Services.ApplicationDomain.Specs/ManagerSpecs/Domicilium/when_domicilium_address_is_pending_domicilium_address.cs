...
{
    public class when_domicilium_address_is_pending_domicilium_address : WithFakes
    {
        ...
        It should_confirm_that_domcilium_address_is_pending_domicilium_address = () =>
        {
