...
{
    internal class when_the_client_is_not_an_applicant_on_the_application : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            dbFactory.FakedDb.DbReadOnlyContext.WhenToldTo(x => x.SelectOne<int>(Param.IsAny<CheckClientIsAnApplicantOnTheApplicationStatement>())).Return(() => { return 0; });
        };
