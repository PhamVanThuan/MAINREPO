...
{
    public class when_updating_an_affordability_assessment_income_contributors : WithFakes
    {
        ...
        private Because of = () =>
        {
            affordabilityAssessmentManager.UpdateAffordabilityAssessmentAndIncomeContributors(affordabilityAssessment, 0);
        };
        ...
        private It should_delete_removed_income_contributors = () =>
        {
            affordabilityAssessmentDataManager.WasToldTo(x => x.DeleteAffordabilityAssessmentLegalEntity(Param.IsAny<int>(), Param.IsAny<int>()));
        };

        private It should_insert_added_income_contributors = () =>
        {
