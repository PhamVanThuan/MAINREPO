...
{
    public class when_copying_an_affordability_assessment_items : WithFakes
    {
        ...
        private Because of = () =>
        {
            affordabilityAssessmentManager.CopyAndArchiveAffordabilityAssessmentWithNewAffordabilityAssessmentItems(affordabilityAssessment, 0);
        };
