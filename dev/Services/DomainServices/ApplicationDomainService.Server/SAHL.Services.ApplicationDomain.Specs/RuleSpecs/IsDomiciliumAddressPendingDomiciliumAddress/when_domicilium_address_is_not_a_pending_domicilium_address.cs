...
{
    public class when_domicilium_address_is_not_a_pending_domicilium_address : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            domiciliumDataManager.WhenToldTo(x => x.IsDomiciliumAddressPendingDomiciliumAddress(clientDomiciliumKey)).Return(false);
        };
        ...
        {
            systemMessageCollection.ErrorMessages().First().Message.ShouldEqual("An applicant can only be linked to a domicilium address that is marked as pending.");
        };
    }
}