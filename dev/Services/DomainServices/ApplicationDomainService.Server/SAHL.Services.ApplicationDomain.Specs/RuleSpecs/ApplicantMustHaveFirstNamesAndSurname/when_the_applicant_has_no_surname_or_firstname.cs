...
{
    public class when_the_applicant_has_no_surname_or_firstname : WithFakes
    {
        ...
        private It should_return_a_message_for_the_surname = () =>
        {
            messages.ErrorMessages().Last().Message.ShouldEqual("A natural person applicant must have a surname.");
        };
