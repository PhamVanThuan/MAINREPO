...
{
    public class when_client_has_a_pending_domicilium : WithFakes
    {
        ...
        Establish context = () =>
        {
            ...
            applicantDataManager.WhenToldTo(x => x.DoesApplicantHavePendingDomiciliumOnApplication(ruleModel.ClientKey, ruleModel.ApplicationNumber)).Return(true);
        };
        ...
        {
            systemMessageCollection.ErrorMessages().Count().ShouldNotEqual(0);
        };
    }
}
