...
{
    public class when_answer_is_yes_and_no_arrangement_is_setwhen_answer_is_yes_and_arrangement_is_set : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ruleModel = new ApplicantDeclarationsModel(1, 2, DateTime.Now,
                ...
                new CurrentlyUnderDebtCounsellingReviewDeclarationModel(OfferDeclarationAnswer.Yes, false),
