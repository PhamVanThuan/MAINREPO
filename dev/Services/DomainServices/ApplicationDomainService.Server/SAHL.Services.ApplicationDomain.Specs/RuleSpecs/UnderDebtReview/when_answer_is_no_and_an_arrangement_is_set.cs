...
{
    public class when_answer_is_no_and_an_arrangement_is_set : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ruleModel = new ApplicantDeclarationsModel(1, 2, DateTime.Now,
                ...
                new CurrentlyUnderDebtCounsellingReviewDeclarationModel(OfferDeclarationAnswer.No, true),
