...
{
    public class when_the_client_has_provided_declarations_for_the_application : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            existingDeclarations = new OfferDeclarationDataModel[] { new OfferDeclarationDataModel(1, 2, 1, 1, null) };
        ...
        {
            messages.ErrorMessages().Where(x => x.Message == "Applicant has already provided declarations for this application.").First().ShouldNotBeNull();
        };
    }
}