...
{
    public class when_statement_is_not_required_and_format_is_text : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            model = new ApplicationMailingAddressModel(1, 2, CorrespondenceLanguage.English, OnlineStatementFormat.Text, CorrespondenceMedium.Email,
                1, false);
        };
