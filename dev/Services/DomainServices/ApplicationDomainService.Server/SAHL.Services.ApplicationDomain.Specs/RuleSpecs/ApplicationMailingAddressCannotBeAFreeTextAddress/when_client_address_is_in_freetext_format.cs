...
{
    public class when_client_address_is_in_freetext_format : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            clientQueryMessageCollection = new SystemMessageCollection();
            ...
            domainQueryService.WhenToldTo(c => c.PerformQuery(Param.IsAny<GetClientAddressQuery>())).Return<GetClientAddressQuery>(y =>
            {
                y.Result = new ServiceQueryResult<GetClientAddressQueryResult>(
                        new GetClientAddressQueryResult[] {
                            new GetClientAddressQueryResult{ AddressKey = 1234, AddressFormatKey = (int)AddressFormat.FreeText, ClientKey = 1234 } }
                            );
        ...
        private It should_return_messages = () =>
        {
            messages.ErrorMessages().First().Message
                .ShouldEqual("A Free Text address cannot be used as an Application Mailing Address.");
        };
    }
}