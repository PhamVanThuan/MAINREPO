...
{
    public class when_the_client_exists_as_an_applicant : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            command = new AddLeadApplicantToApplicationCommand(CombGuid.Instance.Generate(), clientKey, applicationNumber, LeadApplicantOfferRoleTypeEnum.Lead_Suretor);
        ...
        {
            messages.ErrorMessages().First().Message.ShouldEqual("The client provided is already an active applicant on this application.");
        };
    }
}