...
{
    public class when_the_loan_amount_is_above_the_required_for_a_new_purchase_loan : WithFakes
    {
        ...
        {
            ruleModel = new NewPurchaseApplicationModel(OfferStatus.Open, 1, OriginationSource.Comcorp, 2, 20000000, 0, 240, Product.NewVariableLoan, "reference1", 1, null);
