...
{
    public class when_the_loan_amount_is_above_the_required_for_a_refinance : WithFakes
    {
        ...
        {
            ruleModel = new RefinanceApplicationModel(OfferStatus.Open, 1, OriginationSource.Comcorp, 200000,240, 2000000, Product.NewVariableLoan, "reference1", 1);
