...
{
    public class when_client_is_not_an_applicant_on_the_application : WithFakes
    {
        ...
        Establish context = () =>
        {
            ...
            applicantDataManager.WhenToldTo(x => x.CheckClientIsAnApplicantOnTheApplication(Param.IsAny<int>(), Param.IsAny<int>())).Return(false);
        };
