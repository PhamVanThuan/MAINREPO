...
{
    public class CopyAffordabilityAssessmentCommandHandler : IServiceCommandHandler<CopyAffordabilityAssessmentCommand>
    {
        private IADUserManager adUserManager;
        private IAffordabilityAssessmentManager affordabilityAssessmentManager;

        public CopyAffordabilityAssessmentCommandHandler(IADUserManager adUserManager, IAffordabilityAssessmentManager affordabilityAssessmentManager)
        {
            this.adUserManager = adUserManager;
            this.affordabilityAssessmentManager = affordabilityAssessmentManager;
        }

        public ISystemMessageCollection HandleCommand(CopyAffordabilityAssessmentCommand command, IServiceRequestMetadata metadata)
        {
            ...
            affordabilityAssessmentManager.CopyAndArchiveAffordabilityAssessmentWithNewAffordabilityAssessmentItems(command.AffordabilityAssessment, _ADUserKey.Value);
