...
{
    internal class when_firstname_is_null : WithFakes
    {
        ...
        private Because of = () =>
        {
            ex = Catch.Exception(() =>
            {
                model = new NaturalPersonClientModel(idNumber, passportNumber, salutationTypeKey, 
                                                     firstName, surname, "i", preferredName, genderKey, 
                                                     maritalStatusKey, populationGroupKey, citizenshipTypeKey, 
                                                     dateOfBirth, homeLanguageKey, correspondenceLanguageKey, 
                                                     education, homePhoneCode, homePhone, workPhoneCode, workPhone, 
                                                     faxCode, faxNumber, cellphone, emailAddress);
            });
        };
