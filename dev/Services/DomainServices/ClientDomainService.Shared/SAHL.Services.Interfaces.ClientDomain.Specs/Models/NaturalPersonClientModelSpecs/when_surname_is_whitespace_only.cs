...
{
    class when_surname_is_whitespace_only : WithFakes
    {
        ...
        private Because of = () =>
        {
            ex = Catch.Exception(() =>
            {
                model = new NaturalPersonClientModel(idNumber, passportNumber, salutationTypeKey, firstName, surname, "i"
                                                    ,preferredName, genderKey, maritalStatusKey, populationGroupKey
                                                    ,citizenshipTypeKey, dateOfBirth, homeLanguageKey, correspondenceLanguageKey
                                                    ,education, homePhoneCode, homePhone, workPhoneCode, workPhone, faxCode, faxNumber
        ...
        {
            ex.Message.ShouldEqual("The Surname field is required.");
        };
    }
}
