...
{
    public class UnconfirmedSalaryDeductionEmploymentAddedToClientEvent : Event
    {
        public UnconfirmedSalaryDeductionEmploymentAddedToClientEvent(DateTime date, int clientKey, double housingAllowance, SalaryDeductionRemunerationType remunerationType,
            double basicIncome, DateTime startDate, EmploymentStatus EmploymentStatus, int salaryPaymentDay, string employerName, string employerPhoneCode, string employerPhone,
            string employerContactPerson, string employerContactEmail, EmployerBusinessType employerBusinessType, EmploymentSector employmentSector, int employmentKey)
            : base(date)
        {
            this.ClientKey = clientKey;
            this.HousingAllowance = housingAllowance;
            this.RemunerationType = remunerationType;
            this.EmploymentType = EmploymentType.SalariedwithDeduction;
