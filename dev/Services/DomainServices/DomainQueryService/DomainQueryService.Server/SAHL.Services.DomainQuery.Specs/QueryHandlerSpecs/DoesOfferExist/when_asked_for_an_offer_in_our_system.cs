...
{
    public class when_asked_for_an_offer_in_our_system : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            dataManager.WhenToldTo(x => x.DoesOfferExist(offerKey)).Return(true);
        };
        ...
        private It should_set_the_query_result = () =>
        {
            ...
            query.Result.Results.First().OfferExist.ShouldBeTrue();
        };
