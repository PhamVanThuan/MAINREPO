...
{
    public class when_terminating_a_disability_claim : WithCoreFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            lifeDomainDataManager.WhenToldTo(x => x.TerminateDisabilityClaimPaymentSchedule(disabilityClaimKey, "")).Return(String.Empty);
        };
        ...
        {
            eventRaiser.WasToldTo(x => x.RaiseEvent(Param.IsAny<DateTime>(), Param.IsAny<DisabilityClaimTerminatedEvent>(),
