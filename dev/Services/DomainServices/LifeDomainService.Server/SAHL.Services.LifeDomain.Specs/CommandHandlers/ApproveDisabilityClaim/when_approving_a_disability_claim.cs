...
{
    public class when_approving_a_disability_claim : WithCoreFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            lifeDomainDataManager.WhenToldTo(x => x.CreateDisabilityClaimPaymentSchedule(disabilityClaimKey, adUserName)).Return(String.Empty);
        };
        ...
        {
            lifeDomainDataManager.WasToldTo(x => x.UpdateDisabilityClaimStatus(disabilityClaimKey, DisabilityClaimStatus.Approved));
        };
        ...
        private It should_call_the_halo_api_to_create_the_payment_schedule = () =>
        {
        ...
        {
            eventRaiser.WasToldTo(x => x.RaiseEvent(Param.IsAny<DateTime>(), Param.IsAny<DisabilityClaimApprovedEvent>(),
