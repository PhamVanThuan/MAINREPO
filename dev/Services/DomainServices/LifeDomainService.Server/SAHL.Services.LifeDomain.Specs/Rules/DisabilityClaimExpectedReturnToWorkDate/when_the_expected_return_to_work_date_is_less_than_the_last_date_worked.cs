...
{
    public class when_the_expected_return_to_work_date_is_less_than_the_last_date_worked : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            expectedReturnToWorkDate = lastDateWorked.AddMonths(-1);
        ...
        {
            messages.ErrorMessages().Where(x => x.Message == "Expected Return to Work Date cannot be before Claimant's Last Date Worked.").First().ShouldNotBeNull();
        };
    }
}