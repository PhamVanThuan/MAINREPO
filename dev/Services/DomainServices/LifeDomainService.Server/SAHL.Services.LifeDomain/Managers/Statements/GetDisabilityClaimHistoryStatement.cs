...
{
    public class GetDisabilityClaimHistoryStatement : ISqlStatement<DisabilityClaimDetailModel>
    {
        public int AccountNumber { get; protected set; }

        public GetDisabilityClaimHistoryStatement(int accountNumber)
        {
        ...
        public string GetStatement()
        {
            return @"select dc.[DisabilityClaimKey]
                    ...
                    where dc.[AccountKey] = @AccountNumber";
        }
    }
}