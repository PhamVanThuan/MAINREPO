...
{
    public class CreateApplicationDeclinedLegacyEventQuery : ServiceQuery<ApplicationDeclinedLegacyEvent>, ILegacyEventGeneratorQuery
    {
        public int StageDefinitionStageDefinitionGroupKey { get { return 111; } }
