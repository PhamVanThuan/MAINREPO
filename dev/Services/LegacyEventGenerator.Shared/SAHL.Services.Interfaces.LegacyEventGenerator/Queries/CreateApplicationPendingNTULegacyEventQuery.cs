...
{
    public class CreateApplicationPendingNTULegacyEventQuery : ServiceQuery<ApplicationNTUPendedLegacyEvent>, ILegacyEventGeneratorQuery
    {
        public int StageDefinitionStageDefinitionGroupKey { get { return 4651; } }
