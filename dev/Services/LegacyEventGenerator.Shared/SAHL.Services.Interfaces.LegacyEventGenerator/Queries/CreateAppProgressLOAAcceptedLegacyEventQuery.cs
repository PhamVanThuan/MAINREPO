...
{
    public class CreateAppProgressLOAAcceptedLegacyEventQuery : ServiceQuery<AppProgressLOAAcceptedLegacyEvent>, ILegacyEventGeneratorQuery
    {
        public int StageDefinitionStageDefinitionGroupKey { get { return 1624; } }
