...
{
    public class CreateAppProgressInValuationLegacyEventQuery : ServiceQuery<AppProgressInValuationLegacyEvent>, ILegacyEventGeneratorQuery
    {
        public int StageDefinitionStageDefinitionGroupKey { get { return 77; } }
