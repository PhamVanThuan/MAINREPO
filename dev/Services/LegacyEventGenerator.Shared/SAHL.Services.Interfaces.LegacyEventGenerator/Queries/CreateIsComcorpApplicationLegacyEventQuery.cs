...
{
    public class CreateIsComcorpApplicationLegacyEventQuery : ServiceQuery<IsComcorpApplicationLegacyEvent>, ILegacyEventGeneratorQuery
    {
        public int StageDefinitionStageDefinitionGroupKey
        {
            get { return 4642; } // Application Lead - Is Comcorp
        }
