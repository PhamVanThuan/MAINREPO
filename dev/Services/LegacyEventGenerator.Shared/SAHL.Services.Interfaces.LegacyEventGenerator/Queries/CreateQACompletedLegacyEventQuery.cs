...
{
    public class CreateQACompletedLegacyEventQuery : ServiceQuery<QACompletedLegacyEvent>, ILegacyEventGeneratorQuery
    {
        public int StageDefinitionStageDefinitionGroupKey { get { return 1398; } }
