...
{
    public class CreateAppProgressInLOALegacyEventQuery : ServiceQuery<AppProgressInLOALegacyEvent>, ILegacyEventGeneratorQuery
    {
        public int StageDefinitionStageDefinitionGroupKey { get { return 72; } }
