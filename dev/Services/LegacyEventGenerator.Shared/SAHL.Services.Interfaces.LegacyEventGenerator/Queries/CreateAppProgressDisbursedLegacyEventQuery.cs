...
{
    public class CreateAppProgressDisbursedLegacyEventQuery : ServiceQuery<AppProgressDisbursedLegacyEvent>, ILegacyEventGeneratorQuery
    {
        public int StageDefinitionStageDefinitionGroupKey { get { return 76; } }
