...
{
    public class CreateApplicationNTUFinalizedLegacyEventQuery : ServiceQuery<ApplicationNTUFinalizedLegacyEvent>, ILegacyEventGeneratorQuery
    {
        public int StageDefinitionStageDefinitionGroupKey { get { return 110; } }
