...
{
    public class CreateApplicationPendingDeclineLegacyEventQuery : ServiceQuery<ApplicationDeclinePendedLegacyEvent>, ILegacyEventGeneratorQuery
    {
        public int StageDefinitionStageDefinitionGroupKey { get { return 4650; } }
