...
{
    /**************************************************************
    * StageDefinitionStageDefinitionGroupKey : 4651
    */

    public class ApplicationNTUPendedLegacyEvent : LegacyEvent
    {
        public ApplicationNTUPendedLegacyEvent(Guid id, DateTime date, int adUserKey, string aduserName, int applicationKey, 
