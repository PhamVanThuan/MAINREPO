...
{
    /**************************************************************
    * StageDefinitionStageDefinitionGroupKey : 77
    */

    public class AppProgressInValuationLegacyEvent : LegacyEvent
    {
        public AppProgressInValuationLegacyEvent(Guid id, DateTime date, int adUserKey, string aduserName, int applicationKey,
