...
{
    /**************************************************************
    * StageDefinitionStageDefinitionGroupKey : 76
    */

    public class AppProgressDisbursedLegacyEvent : LegacyEvent
    {
        public AppProgressDisbursedLegacyEvent(Guid id, DateTime date, int adUserKey, string aduserName,
