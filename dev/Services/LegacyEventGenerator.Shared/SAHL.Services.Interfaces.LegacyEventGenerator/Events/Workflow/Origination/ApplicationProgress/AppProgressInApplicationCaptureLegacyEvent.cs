...
{
    /**************************************************************
    * StageDefinitionStageDefinitionGroupKey : 68
    */

    public class AppProgressInApplicationCaptureLegacyEvent : LegacyEvent
    {
        public AppProgressInApplicationCaptureLegacyEvent(Guid id, DateTime date, int adUserKey, string aduserName, int applicationKey, 
