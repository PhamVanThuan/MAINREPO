...
{
    /**************************************************************
    * StageDefinitionStageDefinitionGroupKey : 78
    */

    public class AppProgressReturnToManageAppFromValuationLegacyEvent : LegacyEvent
    {
        public AppProgressReturnToManageAppFromValuationLegacyEvent(Guid id, DateTime date, int adUserKey, string aduserName, 
            int applicationKey, int applicationInformationKey, string assignedADUser, string commissionableADUser, 
            AppProgressEnum previousAppProgress) : base(id, date, adUserKey, aduserName)
        {
