...
{
    /**************************************************************
    * StageDefinitionStageDefinitionGroupKey : 1624
    */

    public class AppProgressLOAAcceptedLegacyEvent : LegacyEvent
    {
        public AppProgressLOAAcceptedLegacyEvent(Guid id, DateTime date, int adUserKey, string aduserName, int applicationKey,
