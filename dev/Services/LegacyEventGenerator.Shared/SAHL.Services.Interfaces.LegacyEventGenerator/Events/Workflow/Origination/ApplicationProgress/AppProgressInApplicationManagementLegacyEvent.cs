...
{
    /**************************************************************
    * StageDefinitionStageDefinitionGroupKey : 70
    */

    public class AppProgressInApplicationManagementLegacyEvent : LegacyEvent
    {
        public AppProgressInApplicationManagementLegacyEvent(Guid id, DateTime date, int adUserKey, string aduserName, int applicationKey, 
