...
{
    public class RegistrationsLoanRegisteredLegacyEvent : LegacyEvent
    {
        public RegistrationsLoanRegisteredLegacyEvent(Guid id, DateTime date, int adUserKey, string aduserName, int applicationKey,
