...
{
    public class RegistrationsInstructAttorneyLegacyEvent : LegacyEvent
    {
        public RegistrationsInstructAttorneyLegacyEvent(Guid id, DateTime date, int adUserKey, string aduserName, 
