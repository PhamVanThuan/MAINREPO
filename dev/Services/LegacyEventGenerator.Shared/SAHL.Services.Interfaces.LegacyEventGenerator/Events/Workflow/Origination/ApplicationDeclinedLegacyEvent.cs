...
{
    /**************************************************************
    * StageDefinitionStageDefinitionGroupKey : 111
    */

    public class ApplicationDeclinedLegacyEvent : LegacyEvent
    {
        public ApplicationDeclinedLegacyEvent(Guid id, DateTime date, int adUserKey, string aduserName, int applicationKey, 
            int applicationInformationKey, string declineReason, string performedByADUser)
