...
{
    public class ActivityByActivityNameAndInstanceIdSqlStatement : ISqlStatement<Activity>
    {
        public string ActivityName { get; protected set; }

        public long InstanceId { get; protected set; }

        public ActivityByActivityNameAndInstanceIdSqlStatement(long instanceId, string activityName)
        {
        ...
        public string GetStatement()
        {
            string sql = @"select top 1 a.ID as ActivityID, a.Name as ActivityName,
                            ...
                            where a.Name=@ActivityName and i.id=@InstanceId and ((i.StateID is NOT null and a.StateID = i.stateID) or (i.StateID is null and a.Name=@ActivityName) or (a.Type=10))
                            order by 1 desc";
            return sql;
        }
    }
