...
{
    public class when_handling_an_x2_response : WithFakes
    {
        ...
        private static X2Response response = new X2Response(correlationId, "message", 1);
        ...
        It should_handle_the_response_correctly = () =>
        {
            requestMonitorCallback.WasToldTo(x => x.RequestCompleted(Param<X2Response>.Matches(y => y.RequestID == correlationId)));
        };
    }
}
