...
namespace SAHL.X2Engine2.Specs.CommandHandlerSpecs.CheckInstanceIsLockedForUserCommandHandlerSpecs
{
    public class when_checking_an_instance_is_locked_for_a_user_and_it_is : WithFakes
    {
        private static AutoMocker<CheckInstanceIsLockedForUserCommandHandler> autoMocker;
        private static IReadWriteSqlRepository readWriteSqlRepository;
        private static CheckInstanceIsLockedForUserCommand command;
        ...
        {
            instanceDataModel = new InstanceDataModel(1, null, "name", "subject", "", 1, "creator", System.DateTime.Now, null, null, DateTime.Now, userName, 1, 1, null, null);
            ...
            command = new CheckInstanceIsLockedForUserCommand(instance.ID, activity.ActivityID, userName);
            ...
            autoMocker = new NSubstituteAutoMocker<CheckInstanceIsLockedForUserCommandHandler>();
        };
