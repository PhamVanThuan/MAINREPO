...
{
    public class when_checking_creation_access_for_originator : WithFakes
    {
        ...
        static Core.Services.ServiceRequestMetadata metadata;

        Establish context = () =>
        {
            securityGroup = new SecurityGroupDataModel(false, "Originator", "", 1, 1);
