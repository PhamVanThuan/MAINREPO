...
{
    public class when_completing_an_activity_and_the_map_complete_activity_returns_false : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            x2Map.WhenToldTo(x => x.CompleteActivity(Param.IsAny<InstanceDataModel>(), Param.IsAny<IX2ContextualDataProvider>(), Param.IsAny<IX2Params>(), Param.IsAny<ISystemMessageCollection>(), ref activityMessage)).Return(false);
            handleMapReturnCommand = new HandleMapReturnCommand(instance.ID, false, Param.IsAny<ISystemMessageCollection>(), activity.ActivityName, WorkflowMapCodeSectionEnum.OnComplete);
        ...
        private It should_not_exit_the_current_state = () =>
        {
