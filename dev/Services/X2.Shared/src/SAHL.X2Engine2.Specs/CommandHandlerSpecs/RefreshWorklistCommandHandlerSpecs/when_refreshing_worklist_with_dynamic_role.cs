...
{
    public class when_refreshing_worklist_with_dynamic_role : WithFakes
    {
        ...
        static WorkFlowDataModel workflowDataModel;
        static IX2Map map;
        ...
        It should_resolve_the_dynamic_role = () =>
            {
                map.WasToldTo(x => x.GetDynamicRole(instance, contextualDataProvider, "RoleName", Arg.Any<IX2Params>(), Param.IsAny<ISystemMessageCollection>()));
            };
