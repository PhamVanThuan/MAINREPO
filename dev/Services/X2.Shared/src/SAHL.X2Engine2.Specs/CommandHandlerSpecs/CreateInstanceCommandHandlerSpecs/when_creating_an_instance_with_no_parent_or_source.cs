...
{
    public class when_creating_an_instance_with_no_parent_or_source : WithFakes
    {
        ...
        private Establish context = () =>
            {
                ...
                command = new CreateInstanceCommand(processName, workflowName, activityName, userName, workflowProviderName, null);
        ...
        private It should_create_an_instance_record = () =>
            {
