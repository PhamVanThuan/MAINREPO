...
{
    public class when_checking_an_instance_is_not_already_locked_and_it_isnt : WithFakes
    {
        ...
        {
            instanceDataModel = new InstanceDataModel(1, null, "name", "subject", "", 1, "creator", System.DateTime.Now, null, null, null, null, 1, 1, null, null);
