...
{
    public class when_recording_a_stage_transition_for_legacy : WithFakes
    {
        ...
        private static ProcessDataModel legacyProcessDataModel;
        ...
        private Establish context = () =>
        {
            ...
            legacyProcessDataModel = new ProcessDataModel(1, processName, "version", null, activityDate, null, null, null, true);
            ...
            activity = new Activity(1, workflowActivity, 1, fromStateName, 2, toStateName, 1, false);
        ...
        private It should_create_an_xml_result = () =>
        {
            command.XmlResult.ShouldNotBeEmpty();
        };
    }
}