...
{
    public class when_handling_for_an_existing_instance_request_that_is_not_a_split : WithFakes
    {
        ...
        Establish context = () =>
        {
            ...
            activity = new Activity(activityID, activityName, 1, "fromState", 2, "toState", WorkFlowID, false);
            activityDataModel = new ActivityDataModel(activityID, WorkFlowID, activityName, 3, 1, 2, false, 9, null, "", null, 2, 1, "", 1, Guid.NewGuid());
        ...
        {
            autoMocker.Get<IX2ServiceCommandRouter>().WasToldTo(x => x.HandleCommand(Arg.Is<UserRequestStartActivityWithoutSplitCommand>(y => y.Activity.ActivityID == activityID), metadata));
        };
