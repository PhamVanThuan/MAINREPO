...
{
    public class when_handling_a_system_request_and_the_state_on_exit_code_returns_false : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            x2Map.WhenToldTo(x => x.ExitState(Param.IsAny<InstanceDataModel>(), Param.IsAny<IX2ContextualDataProvider>(), Param.IsAny<IX2Params>(), Param.IsAny<ISystemMessageCollection>()))
                .Return(false);
            handleMapReturnCommand = new HandleMapReturnCommand(instance.ID, false, systemMessageCollection, activity.ActivityName, WorkflowMapCodeSectionEnum.OnExit);
        ...
        It should_not_enter_the_following_state_in_the_map = () =>
        {
