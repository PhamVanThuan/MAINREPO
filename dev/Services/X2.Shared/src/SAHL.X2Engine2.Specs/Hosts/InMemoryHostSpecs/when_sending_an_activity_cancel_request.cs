...
{
    public class when_sending_an_activity_cancel_request : WithFakes
    {
        ...
        Establish context = () =>
        {
            ...
            request = new X2RequestForExistingInstance(Guid.NewGuid(), 1234567L, X2RequestType.UserCancel, serviceRequestMetadata, "ActivityName", false, null);
        };

        Because of = () =>
        {
            autoMocker.ClassUnderTest.SendActivityCancelRequest(request);
        };
