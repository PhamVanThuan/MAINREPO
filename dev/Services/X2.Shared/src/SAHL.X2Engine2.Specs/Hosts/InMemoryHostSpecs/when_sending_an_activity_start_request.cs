...
{
    public class when_sending_an_activity_start_request : WithFakes
    {
        ...
        Establish context = () =>
        {
            ...
            request = new X2RequestForExistingInstance(Guid.NewGuid(), 1234567L, X2RequestType.UserStart, serviceRequestMetadata, "ActivityName", false, null);
        };

        Because of = () =>
        {
            autoMocker.ClassUnderTest.SendActivityStartRequest(request);
        };
