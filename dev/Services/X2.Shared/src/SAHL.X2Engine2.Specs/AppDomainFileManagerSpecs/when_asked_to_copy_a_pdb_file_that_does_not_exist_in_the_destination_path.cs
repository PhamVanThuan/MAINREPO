...
{
    public class when_asked_to_copy_a_pdb_file_that_does_not_exist_in_the_destination_path : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            autoMocker.Get<IFileSystem>().Path.WhenToldTo(x => x.GetExtension(destinationPath)).Return(".pdb");
