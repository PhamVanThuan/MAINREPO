...
{
    public class when_asked_to_copy_a_file_that_has_an_invalid_extension : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            autoMocker.Get<IFileSystem>().Path.WhenToldTo(x => x.GetExtension(destinationPath)).Return(".mp3");
        ...
        {
            autoMocker.Get<IFileSystem>().File.WasNotToldTo(x => x.Copy(destinationPath, sourcePath));
        };
    }
}