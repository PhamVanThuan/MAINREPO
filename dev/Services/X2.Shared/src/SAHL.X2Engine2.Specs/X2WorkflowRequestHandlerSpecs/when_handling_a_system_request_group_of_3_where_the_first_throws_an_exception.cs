...
{
    public class when_handling_a_system_request_group_of_3_where_the_first_throws_an_exception : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            commandHandler.WhenToldTo(x => x.HandleCommand<HandleSystemRequestWithNoSplitNoWorkflowActivitiesCommand>(Arg.Is<HandleSystemRequestWithNoSplitNoWorkflowActivitiesCommand>(y => y.Activity.ActivityName == "one"), metadata)).Throw(new Exception("something bad"));
        ...
        private It should_not_execute_the_second_command = () =>
        {
            commandHandler.WasNotToldTo(x => x.HandleCommand(Arg.Is<HandleSystemRequestWithNoSplitNoWorkflowActivitiesCommand>(y => y.Activity.ActivityName == "two"), metadata));
        };
