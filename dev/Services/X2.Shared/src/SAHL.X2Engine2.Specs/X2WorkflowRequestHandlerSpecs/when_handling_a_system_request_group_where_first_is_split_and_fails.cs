...
{
    public class when_handling_a_system_request_group_where_first_is_split_and_fails : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            var failedMessages = new SystemMessageCollection();
            failedMessages.AddMessage(new SystemMessage("failed message", SystemMessageSeverityEnum.Error));
            ...
            commandHandler
                .WhenToldTo(x => x.HandleCommand<HandleSystemRequestWithSplitWithNoWorkflowActivitiesCommand>(Arg.Is<HandleSystemRequestWithSplitWithNoWorkflowActivitiesCommand>(y =>
                    y.Activity.ActivityName == "one"), serviceRequestMetadata))
                .Throw(new MapReturnedFalseException(failedMessages));
