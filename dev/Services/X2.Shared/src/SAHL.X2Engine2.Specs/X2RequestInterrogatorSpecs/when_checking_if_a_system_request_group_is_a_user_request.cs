...
{
    public class when_checking_if_a_system_request_group_is_a_user_request : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            request = new X2Request(Guid.NewGuid(), X2RequestType.SystemRequestGroup, null, false, null);
        };
