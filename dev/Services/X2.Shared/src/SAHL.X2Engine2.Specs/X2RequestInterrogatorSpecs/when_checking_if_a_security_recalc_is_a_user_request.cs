...
{
    //public class when_checking_if_a_security_recalc_is_a_user_request : WithFakes
    //{
    ...
    //        request = new X2Request(Guid.NewGuid(), X2RequestType.SecurityRecalc, null, false, "userName");
    //    };
