...
{
    public class when_checking_if_a_bundled_request_is_a_user_request : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            request = new X2Request(Guid.NewGuid(), X2RequestType.BundledRequest, null, false, null);
        };
