...
{
    public class when_updating_a_request_to_timedout : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            serializationProvider = An<ISerializationProvider>();
        ...
        private Because of = () =>
        {
            autoMocker.ClassUnderTest.UpdateReceivedRequestAsTimedoutAndWaiting(createInstanceRequest);
        };
        ...
        {
            requestFromDatabase.RequestStatusID.ShouldEqual((int)SAHL.X2Engine2.Enumerations.RequestStatus.TimedOut);
        };
