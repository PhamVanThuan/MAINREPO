...
{
    public class when_updating_request_as_timedout_and_not_servicable : WithFakes
    {
        ...
        private Because of = () =>
        {
            autoMocker.ClassUnderTest.UpdateReceivedRequestAsTimedoutAndNotServicable(createInstanceRequest);
        };
        ...
        private It should_set_the_request_to_be_timeout_and_not_servicable = () =>
        {
            requestFromDatabase.RequestStatusID.ShouldEqual((int)SAHL.X2Engine2.Enumerations.RequestStatus.TimedOutAndNotServicable);
        };
