...
{
    public class when_asked_to_check_exchange_given_no_active_consumer_attached : WithFakes
    {
        ...
        Establish context = () =>
        {
            ...
            autoMocker.Get<IMessageBusManagementClient>().WhenToldTo(x => x.GetQueuesWithConsumers()).Return(new List<string>() { "process.workflow_2.user" });
        };
