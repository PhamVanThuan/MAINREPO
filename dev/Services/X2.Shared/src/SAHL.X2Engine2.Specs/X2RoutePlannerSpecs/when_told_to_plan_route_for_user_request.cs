...
{
    public class when_told_to_plan_route_for_user_request : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            autoMocker.Get<IX2ConsumerMonitor>().WhenToldTo(x => x.IsExchangeActive(exchange, workflow)).Return(true);
        };
