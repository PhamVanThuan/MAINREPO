...
{
    public class when_handling_cancel_activity_request_for_create : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            instance.StateID = Constants.NewlyCreatedInstanceStateID;
        ...
        {
            autoMocker.Get<IX2ServiceCommandRouter>().WasToldTo(x => x.HandleCommand(Arg.Is<DeleteInstanceCommand>(command => command.InstanceID == userRequestCancelActivityCommand.InstanceId), metadata));
        };
    }
}