...
{
    public class when_creating_commands_for_user_complete_request : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            request = new X2RequestForExistingInstance(Guid.NewGuid(), instanceId, X2RequestType.UserComplete, serviceRequestMetadata, activityName, false);
        };
        ...
        private It should_return_a_userrequestcompleteactivitycommand = () =>
        {
            commands.First().ShouldBe(typeof(UserRequestCompleteActivityCommand));
        };
    }
}