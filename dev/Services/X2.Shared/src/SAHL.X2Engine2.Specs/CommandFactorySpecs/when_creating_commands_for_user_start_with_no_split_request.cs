...
{
    public class when_creating_commands_for_user_start_with_no_split_request : WithFakes
    {
        ...
        private It should_return_a_userrequeststartactivitywithoutsplitcommand = () =>
        {
            commands.First().ShouldBe(typeof(UserRequestStartActivityWithoutSplitCommand));
        };
    }
}