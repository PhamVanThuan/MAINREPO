...
{
    public class when_creating_commands_for_system_request_group_with_a_decision : WithFakes
    {
        ...
        private static string activityName1 = "Decision1";
        ...
        {
            activity = new Activity(1, activityName1, 1, "FromState", 2, "ToState", 1, false);
