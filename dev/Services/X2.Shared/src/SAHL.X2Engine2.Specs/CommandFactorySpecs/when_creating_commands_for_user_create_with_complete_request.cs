...
{
    public class when_creating_commands_for_user_create_with_complete_request : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            request = new X2CreateInstanceWithCompleteRequest(Guid.NewGuid(), activityName, "Process", workflowName, serviceRequestMetadata, false);
        ...
        {
            commands.First().ShouldBeOfExactType(typeof(UserRequestCreateInstanceWithCompleteCommand));
        };
    }
}