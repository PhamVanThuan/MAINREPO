...
{
    public class when_getting_commands_for_user_cancel_and_the_request_is_not_for_an_existing_instance : WithFakes
    {
        ...
        Because of = () =>
        {
            ...
            {
                commands = automocker.ClassUnderTest.GetUserCancel(request);
            });
        };
