...
{
    public class when_handling_a_bundled_request_given_a_new_system_request_group_activity : WithFakes
    {
        ...
        {
            request = new X2SystemRequestGroup(Guid.NewGuid(), null, X2RequestType.SystemRequestGroup, instanceId, actvityNames, DateTime.MinValue);
