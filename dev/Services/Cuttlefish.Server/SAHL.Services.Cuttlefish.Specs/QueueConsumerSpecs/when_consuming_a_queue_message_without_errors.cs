...
{
    public class when_consuming_a_queue_message_without_errors : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            workAction = (message) => { workWasActioned = true;  processedMessage = message; };
        ...
        private It should_process_the_message = () =>
            {
                ...
                processedMessage.ShouldEqual("Some Message Body");
            };

        private It should_send_an_ack = () =>
            {
                ((FakeConnection)connection).AckWasCalled.ShouldBeTrue();
            };
    }
}