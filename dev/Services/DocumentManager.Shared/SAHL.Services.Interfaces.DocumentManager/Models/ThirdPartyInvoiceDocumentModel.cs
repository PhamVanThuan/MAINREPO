...
{
    public class ThirdPartyInvoiceDocumentModel : ValidatableModel
    {
        ...
        public ThirdPartyInvoiceDocumentModel(string loanNumber, DateTime dateReceived, DateTime dateProcessed, string fromEmailAddress, string emailSubject,
            string invoiceFileName, string invoiceFileExtension, string category, string fileContentAsBase64)
        {
