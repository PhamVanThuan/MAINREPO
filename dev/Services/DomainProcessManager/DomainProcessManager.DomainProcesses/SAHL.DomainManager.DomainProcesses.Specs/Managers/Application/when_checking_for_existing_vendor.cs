...
{
    public class when_checking_for_existing_vendor : WithCoreFakes
    {
        private static ApplicationDataManager manager;
        private static FakeDbFactory dbFactory;
        private static string vendorcode = "SAHL1";
        ...
        private Establish context = () =>
        {
            ...
            dbFactory.FakedDb.InReadOnlyAppContext().WhenToldTo(x => x.SelectOne(Param<DoesSuppliedVendorExistStatement>.Matches(m =>
                m.VendorCode == vendorcode))).Return(1);
        };
        ...
        private It should_confirm_that_vendor_exists = () =>
        {
            result.ShouldBeTrue();
        };
    }
