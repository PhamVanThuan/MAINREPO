...
{
    internal class when_checking_if_comcorp_app_exists_and_it_does : WithCoreFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            dbFactory.FakedDb.InReadOnlyAppContext().WhenToldTo(x => x.SelectOne(Param<DoesOpenAppExistForComcorpPropertyAndClientStatement>.Matches(m =>
                m.ClientIdNumber == clientIdNumber))).Return(1);
        };
        ...
        private It should_return_that_the_offer_exists = () =>
        {
            result.ShouldBeTrue();
        };
    }
