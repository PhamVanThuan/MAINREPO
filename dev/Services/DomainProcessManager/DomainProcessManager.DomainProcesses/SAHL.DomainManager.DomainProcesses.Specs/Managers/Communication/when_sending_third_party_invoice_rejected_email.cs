...
{
    public class when_sending_third_party_invoice_rejected_email : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            var rejectionReasons = new string[] {"Account does not exist"};
            model = new UnSuccessfulInvoiceSubmissionEmailModel(mailTo, "subjective", System.Net.Mail.MailPriority.Normal, rejectionReasons);
