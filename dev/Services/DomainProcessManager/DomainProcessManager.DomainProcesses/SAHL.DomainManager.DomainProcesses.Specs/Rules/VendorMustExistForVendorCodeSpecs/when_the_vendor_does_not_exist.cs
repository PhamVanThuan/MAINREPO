...
{
    public class when_the_vendor_does_not_exist : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            applicationDataManager.WhenToldTo(x => x.DoesSuppliedVendorExist(applicationCreationModel.VendorCode)).Return(false);
        ...
        {
            messages.ErrorMessages().First().Message.ShouldEqual(string.Format("A vendor with code: {0} does not exist in SA Home Loans database.", applicationCreationModel.VendorCode));
        };
    }
}