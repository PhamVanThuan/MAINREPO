...
{
    public class when_adding_all_invoices_to_payment_batch_fails : PayThirdPartyInvoiceProcessSpec
    {
        ...
        private Establish context = () =>
        {
            ...
            financeDomainService.PerformCommand(Arg.Any<AddThirdPartyInvoiceToPaymentBatchCommand>()
