...
{
    public class when_some_invoice_workflow_cases_fail_to_move_to_ready_for_processing : PayThirdPartyInvoiceProcessSpec
    {
        ...
        private Establish context = () =>
        {
            ...
            catsService.PerformQuery(Arg.Do<GetNewThirdPartyPaymentBatchReferenceQuery>(query => query.Result = serviceQueryResult)).Returns(SystemMessageCollection.Empty());
