...
{
    public class when_not_all_applicants_added : WithNewPurchaseDomainProcess
    {
        ...
        private It should_not_add_client_employments = () =>
        {
            clientDomainService.WasNotToldTo(x => x.PerformCommand(
                Param.IsAny<AddUnconfirmedSalariedEmploymentToClientCommand>(),
                Param.IsAny<IServiceRequestMetadata>()));
        };
    }
}