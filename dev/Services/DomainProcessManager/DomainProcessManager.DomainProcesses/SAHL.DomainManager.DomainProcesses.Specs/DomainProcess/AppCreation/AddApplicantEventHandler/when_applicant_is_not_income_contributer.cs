...
{
    public class when_applicant_is_not_income_contributer : WithNewPurchaseDomainProcess
    {
        ...
        private Establish context = () =>
        {
            ...
            applicant.IncomeContributor = false;
        ...
        private It should_not_make_the_applicant_an_income_contributor = () =>
        {
            applicationDomainService.WasNotToldTo(x => x.PerformCommand(
                Param.IsAny<MakeApplicantAnIncomeContributorCommand>(),
                Param.IsAny<IServiceRequestMetadata>()));
        };

        private It should_add_client_employments = () =>
        {
            clientDomainService.WasToldTo(x => x.PerformCommand(Param<AddUnconfirmedSalariedEmploymentToClientCommand>.Matches(m => true), Param.IsAny<IServiceRequestMetadata>()));
        };
    }
}