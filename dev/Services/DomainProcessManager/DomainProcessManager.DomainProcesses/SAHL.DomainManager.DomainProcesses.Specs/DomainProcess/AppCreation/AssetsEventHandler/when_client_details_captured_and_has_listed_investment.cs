...
{
    public class when_client_details_captured_and_has_listed_investment : WithNewPurchaseDomainProcess
    {
        private static ApplicantListedInvestmentAssetModel listedInvestment;
        ...
        {
            listedInvestment = new ApplicantListedInvestmentAssetModel(500000, "ACME co");
            applicantAssetLiabilities = new List<ApplicantAssetLiabilityModel> { listedInvestment };
