...
{
    public class when_client_has_postal_fixedProperty_with_no_linked_address : WithNewPurchaseDomainProcess
    {
        ...
        private Establish context = () =>
        {
            ...
            var queryResult = new ServiceQueryResult<GetClientFreeTextAddressQueryResult>(
            ...
            addressDomainService
                ...
                .Return<GetClientFreeTextAddressQuery>(rqst => { rqst.Result = queryResult; return new SystemMessageCollection(); });
        };
        ...
        private It should_find_cleint_address = () =>
        {
