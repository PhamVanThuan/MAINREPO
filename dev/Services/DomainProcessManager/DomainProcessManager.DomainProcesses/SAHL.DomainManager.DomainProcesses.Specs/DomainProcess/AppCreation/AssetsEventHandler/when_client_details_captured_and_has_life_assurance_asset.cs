...
{
    public class when_client_details_captured_and_has_life_assurance_asset : WithNewPurchaseDomainProcess
    {
        private static ApplicantLifeAssuranceAssetModel applicantLifeAssuranceAssetModel;
        ...
        {
            applicantLifeAssuranceAssetModel = new ApplicantLifeAssuranceAssetModel(2000000, "ACME Life co.");
            applicantAssetLiabilities = new List<ApplicantAssetLiabilityModel> { applicantLifeAssuranceAssetModel };
        ...
        private It should_add_the_life_assurance_asset_to_the_client = () =>
        {
            clientDomainService.WasToldTo(x => x.PerformCommand(Param<AddLifeAssuranceAssetToClientCommand>.Matches(m =>
                m.LifeAssuranceAsset.CompanyName == applicantLifeAssuranceAssetModel.CompanyName &&
                m.LifeAssuranceAsset.SurrenderValue == applicantLifeAssuranceAssetModel.AssetValue
