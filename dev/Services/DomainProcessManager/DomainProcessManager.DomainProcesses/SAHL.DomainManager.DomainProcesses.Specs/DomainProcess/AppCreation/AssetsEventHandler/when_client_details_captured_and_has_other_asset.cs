...
{
    public class when_client_details_captured_and_has_other_asset : WithNewPurchaseDomainProcess
    {
        private static ApplicantOtherAssetModel applicantOtherAsset;
        ...
        {
            applicantOtherAsset = new ApplicantOtherAssetModel(50000, 5000, "Other asset");
            applicantAssetLiabilities = new List<ApplicantAssetLiabilityModel> { applicantOtherAsset };
        ...
        private It should_add_the_other_investment_to_client = () =>
        {
            clientDomainService.WasToldTo(x => x.PerformCommand(Param<AddOtherAssetToClientCommand>.Matches(m =>
                m.OtherAsset.AssetValue == applicantOtherAsset.AssetValue &&
                m.OtherAsset.Description == applicantOtherAsset.Description &&
                m.OtherAsset.LiabilityValue == applicantOtherAsset.LiabilityValue
