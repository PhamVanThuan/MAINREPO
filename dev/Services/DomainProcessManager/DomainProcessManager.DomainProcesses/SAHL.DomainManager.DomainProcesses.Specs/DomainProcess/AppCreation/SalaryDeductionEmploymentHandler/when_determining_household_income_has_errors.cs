...
{
    public class when_determining_household_income_has_errors : WithNewPurchaseDomainProcess
    {
        ...
        private Establish context = () =>
        {
            ...
            applicationDomainService.WhenToldTo(
                x => x.PerformCommand(Param.IsAny<DetermineApplicationHouseholdIncomeCommand>(), Param.IsAny<IServiceRequestMetadata>()))
