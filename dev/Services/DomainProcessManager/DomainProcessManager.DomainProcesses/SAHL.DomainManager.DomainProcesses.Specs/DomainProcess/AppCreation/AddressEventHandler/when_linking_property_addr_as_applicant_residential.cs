...
{
    public class when_linking_property_addr_as_non_lead_applicant_residential : WithNewPurchaseDomainProcess
    {
        ...
        private static string nonleadMainApplicantIdNumber;
        ...
        private Establish context = () =>
        {
            ...
            nonleadMainApplicantIdNumber = applicationCreationModel.Applicants.First().IDNumber;

            applicationCreationModel.Applicants.First().ApplicantRoleType = LeadApplicantOfferRoleTypeEnum.Lead_Suretor;

            DomainModelMapper mapper = new DomainModelMapper();
            mapper.CreateMap<AddressModel, SAHL.Services.Interfaces.AddressDomain.Model.StreetAddressModel>();
            ...
            clientCollection.Add(nonleadMainApplicantIdNumber, clientKey);
        ...
        private It should_not_set_the_application_mailing_address_client_address_key = () =>
        {
            applicationStateMachine.MailingClientAddressKey.ShouldNotEqual(clientAddressKey);
        };
    }
}