...
{
    public class when_linking_property_addr_as_residential_mailing_addr_set : WithNewPurchaseDomainProcess
    {
        ...
        private Establish context = () =>
        {
            ...
            int? mailingAddressKey = -1;
            applicationStateMachine.WhenToldTo(asm => asm.MailingClientAddressKey).Return(mailingAddressKey);
        };
