...
{
    public class when_adding_salary_with_deduction_employment : WithNewPurchaseDomainProcess
    {
        ...
        {
            applicationCreationModel = ApplicationCreationTestHelper.PopulateApplicationCreationModel(OfferType.NewPurchaseLoan, EmploymentType.SalariedwithDeduction)
                                as NewPurchaseApplicationCreationModel;
            ...
            employerKey = 13;
            employer = new Services.Interfaces.ClientDomain.Models.EmployerModel(null, "Employer Name", "031", "11224455", "", "", EmployerBusinessType.CloseCorporation, 
            ...
            clientDataManager.WhenToldTo(x => x.GetEmployerKey(employer.EmployerName)).Return(employerKey);
        };
        ...
        private It should_find_the_corrent_employee_for_added_employment = () =>
        {
            clientCollection.AssertWasCalled(d => d[clientIdNumber]);
        };

        private It should_add_correct_unconfirmed_salary_deduction_employment_for_specific_applicant = () =>
        {
            clientDomainService.WasToldTo(c => c.PerformCommand(
                  Param<AddUnconfirmedSalaryDeductionEmploymentToClientCommand>.Matches(e => e.ClientKey == clientKey
                      && e.SalaryDeductionEmploymentModel.Employer.EmployerName == employer.EmployerName
                      && e.SalaryDeductionEmploymentModel.Employer.EmployerKey == employerKey)
