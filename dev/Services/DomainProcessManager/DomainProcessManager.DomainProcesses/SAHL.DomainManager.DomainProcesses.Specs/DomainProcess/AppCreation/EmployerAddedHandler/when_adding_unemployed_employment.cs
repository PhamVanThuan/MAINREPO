...
{
    public class when_adding_unemployed_employment : WithNewPurchaseDomainProcess
    {
        ...
        {
            applicationCreationModel = ApplicationCreationTestHelper.PopulateApplicationCreationModel(OfferType.NewPurchaseLoan, EmploymentType.Unemployed) as NewPurchaseApplicationCreationModel;
            ...
            employer = new Services.Interfaces.ClientDomain.Models.EmployerModel(null, employerName, "031", "11224455", "", "", EmployerBusinessType.Unknown, EmploymentSector.Manufacturing);
        ...
        private It should_add_correct_unconfirmed_unemployed_employment = () =>
        {
            clientDomainService.WasToldTo(c => c.PerformCommand(
                  Param<AddUnconfirmedUnemployedEmploymentToClientCommand>.Matches(e => e.ClientKey == clientKey
                      && e.UnemployedEmployment.Employer.EmployerName == employer.EmployerName
                      && e.UnemployedEmployment.Employer.EmployerKey == employerKey)
