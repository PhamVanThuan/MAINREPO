...
namespace SAHL.DomainProcessManager.DomainProcesses.Specs.DomainProcess.AppCreation.UnemployedEmploymentHandler
{
    public class when_determining_app_employment_and_service_errors : WithNewPurchaseDomainProcess
    {
        ...
        private Establish context = () =>
        {
            ...
            applicationDomainService.WhenToldTo(x => x.PerformCommand(Param.IsAny<SetApplicationEmploymentTypeCommand>(), Param.IsAny<IServiceRequestMetadata>())).Return(errorMessages);
