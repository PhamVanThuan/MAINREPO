...
{
    public class when_in_domicilium_address_captured_state : WithFakes
    {
        ...
        {
            state = ApplicationState.DomiciliumAddressCaptured;
        ...
        private It should_be_in_domicilium_address_captured_state = () =>
        {
            machine.IsInState(ApplicationState.DomiciliumAddressCaptured).ShouldBeTrue();
        };
