...
{
    public class when_in_asset_liability_detail_captured_state : WithFakes
    {
        ...
        {
            state = ApplicationState.AssetLiabilityDetailCaptured;
        ...
        private It should_be_in_asset_liability_detail_captured_state = () =>
        {
            machine.IsInState(ApplicationState.AssetLiabilityDetailCaptured).ShouldBeTrue();
        };
