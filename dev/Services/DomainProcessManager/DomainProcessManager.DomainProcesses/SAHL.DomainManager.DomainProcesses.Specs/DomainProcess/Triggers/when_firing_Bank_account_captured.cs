...
{
    public class when_firing_Bank_account_captured : WithFakes
    {
        ...
        private It should_transition_state_to_bank_accounts_captured_state = () =>
        {
            applicationStateMachine.IsInState(ApplicationState.BankAccountCaptured).ShouldBeTrue();
        };
    }
}