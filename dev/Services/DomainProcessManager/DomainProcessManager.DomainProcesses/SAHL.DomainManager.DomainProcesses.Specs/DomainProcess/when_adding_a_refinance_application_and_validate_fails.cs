...
{
    public class when_adding_a_refinance_and_validate_fails : WithDomainServiceMocks
    {
        ...
        private Establish context = () =>
        {
            ...
            domainRuleManager.WhenToldTo(x => x.ExecuteRulesForContext(Param.IsAny<ISystemMessageCollection>(), refinanceCreationModel, refinanceCreationModel.OriginationSource))
        ...
        {
            applicationDomainService.WasNotToldTo(x => x.PerformCommand(Param.IsAny<AddRefinanceApplicationCommand>(), Param.IsAny<IServiceRequestMetadata>()));
        };
