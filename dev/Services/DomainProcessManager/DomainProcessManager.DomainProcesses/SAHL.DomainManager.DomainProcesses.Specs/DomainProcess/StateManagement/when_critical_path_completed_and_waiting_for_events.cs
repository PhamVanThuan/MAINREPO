...
{
    public class when_critical_path_completed_and_waiting_for_events : WithFakes
    {
        ...
        private Establish coxtext = () =>
        {
            ...
            applicationStateMachine.RecordCommandSent(typeof(LinkBankAccountToClientCommand), Guid.NewGuid());
        };
