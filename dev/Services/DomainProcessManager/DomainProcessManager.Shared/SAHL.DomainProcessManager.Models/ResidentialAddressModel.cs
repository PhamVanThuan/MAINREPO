...
namespace SAHL.DomainProcessManager.Models
{
    [Serializable]
    [DataContract]
    public class ResidentialAddressModel : AddressModel
    {
        public ResidentialAddressModel(string streetNumber, string streetName, string unitNumber, string buildingNumber, string buildingName, string suburb, 
