...
{
    public class polled_event_handles_a_mail_with_missing_loan_number : WithFakes
    {
        ...
        private static List<string> incorrectSubjectErrorMessages;
        ...
        private Establish context = () =>
        {
            ...
            incorrectSubjectErrorMessages = new List<string> { "Incorrect subject line format" };
            ...
            lossControlMailValidator.WhenToldTo(y => y.Errors).Return(incorrectSubjectErrorMessages);
        ...
        private It should_log_the_error = () =>
        {
            logger.WasToldTo(l => l.LogError(
                ...
                Param<string>.Matches(m => m.Equals(incorrectSubjectErrorMessages.First(), StringComparison.Ordinal)),
                null));
        };
        ...
        private It should_not_get_the_account_number_from_email_subject = () =>
        {
            lossControlAccountHelper.WasNotToldTo(x => x.StripAccountNumber(Param.IsAny<char>(), Param.IsAny<string>()));
        };

        private It should_not_start_the_third_party_invoice_processor = () =>
        {
            domainProcessManagerService.WasNotToldTo(x => x.StartDomainProcess(Param.IsAny<StartDomainProcessCommand>()));
        };
    }
}
