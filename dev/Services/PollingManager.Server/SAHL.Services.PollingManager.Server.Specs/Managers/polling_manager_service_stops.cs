...
{
    public class polling_manager_service_stops : WithFakes
    {
        ...
        private Because of = () =>
        {
            pollingManagerService.Stop();
        };

        private It should_call_stop_for_the_polledHandler = () =>
        {
            polledHandlers.FirstOrDefault().WasToldTo(x => x.Stop());
        };
    }
}