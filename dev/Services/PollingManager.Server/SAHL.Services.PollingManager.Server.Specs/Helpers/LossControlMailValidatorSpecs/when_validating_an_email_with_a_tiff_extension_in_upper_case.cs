...
{
    public class when_validating_an_email_with_a_tiff_extension_in_upper_case : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            mail = FakeMailMessageFactory.GetMailMessageWithSingleValidAttachment(pdf: false, upperCaseAttachmentType: true);
            result = false;
        };
