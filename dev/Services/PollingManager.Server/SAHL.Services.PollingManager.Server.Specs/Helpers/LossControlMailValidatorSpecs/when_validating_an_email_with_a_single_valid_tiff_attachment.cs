...
{
    public class when_validating_an_email_with_a_single_valid_tiff_attachment : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            mail = FakeMailMessageFactory.GetMailMessageWithSingleValidAttachment(false, true);
            result = false;
        };
