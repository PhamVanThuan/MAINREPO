...
{
    public class when_validating_an_email_with_a_pdf_extension_in_upper_case : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            mail = FakeMailMessageFactory.GetMailMessageWithSingleValidAttachment(true, true);
            result = false;
        };
