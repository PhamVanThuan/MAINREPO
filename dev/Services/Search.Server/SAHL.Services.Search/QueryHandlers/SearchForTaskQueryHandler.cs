...
{
    public class SearchForTaskQueryHandler : IServiceQueryHandler<SearchForTaskQuery>, IServiceQueryPaginationHandler
    {
        private int currentPage;
        private int pageSize;
        private IFreeTextSearchProvider<SearchForTaskQueryResult> freeTextSearchProvider;

        public SearchForTaskQueryHandler(IFreeTextSearchProvider<SearchForTaskQueryResult> freeTextSearchProvider)
        {
            this.freeTextSearchProvider = freeTextSearchProvider;
        }

        public Core.SystemMessages.ISystemMessageCollection HandleQuery(SearchForTaskQuery query)
        {
            ...
            query.Result = new ServiceQueryResult<SearchForTaskQueryResult>(results.Results);
