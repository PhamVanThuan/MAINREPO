...
{
    public class when_creating_an_itc_request_for_a_client_with_no_address : WithITCManager
    {
        ...
        {
            clientAddressList = new List<GetClientStreetAddressByClientKeyQueryResult> { };
