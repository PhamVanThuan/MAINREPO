...
{
    public class when_saving_a_document : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            jsonDocumentDataManager.WhenToldTo(x => x.DoesDocumentExist(expectedId)).Return(true);
        ...
        {
            jsonDocumentDataManager.WasToldTo(x => x.SaveJsonDocument(expectedId, expectedName, expectedDescription, expectedVersion, expectedDocumentFormatVersion, expectedDocumentType, expectedData));
        };
    }
}