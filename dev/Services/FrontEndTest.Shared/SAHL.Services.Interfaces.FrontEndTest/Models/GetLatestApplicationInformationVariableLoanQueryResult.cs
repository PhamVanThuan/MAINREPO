...
{
    public class GetLatestApplicationInformationVariableLoanQueryResult
    {
        public GetLatestApplicationInformationVariableLoanQueryResult(int offerKey, int productKey, int offerInformationTypeKey, int offerInformationKey, int? categoryKey,
            int? term, double? existingLoan, double? cashDeposit, double? propertyValuation, double? householdIncome, double? feesTotal, double? interimInterest,
            double? monthlyInstalment, double? lifePremium, double? hOCPremium, double? minLoanRequired, double? minBondRequired, double? preApprovedAmount,
            double? minCashAllowed, double? maxCashAllowed, double? loanAmountNoFees, double? requestedCashAmount, double? loanAgreementAmount,
            double? bondToRegister, double? lTV, double? pTI, double? marketRate, int? sPVKey, int? employmentTypeKey, int? rateConfigurationKey,
