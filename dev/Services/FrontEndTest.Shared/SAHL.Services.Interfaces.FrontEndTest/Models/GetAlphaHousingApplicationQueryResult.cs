...
{
    public class GetAlphaHousingApplicationQueryResult
    {
        public GetAlphaHousingApplicationQueryResult(int offerKey, int offerTypeKey, int offerStatusKey, DateTime? offerStartDate, DateTime? offerEndDate,
                                                     int? accountKey, string reference, int? offerCampaignKey, int? offerSourceKey, int reservedAccountKey,
                                                     int originationSourceKey, int? estimateNumberApplicants)
        {
