...
{
    public class SearchForThirdPartyQuery : ServiceQuery<SearchForThirdPartyQueryResult>, ISearchServiceQuery
    {
        public SearchForThirdPartyQuery(string queryText, IEnumerable<SearchFilter> filters, string indexName)
        {
