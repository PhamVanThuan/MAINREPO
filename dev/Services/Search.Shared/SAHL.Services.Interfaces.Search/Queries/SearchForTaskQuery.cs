...
{
    public class SearchForTaskQuery : ServiceQuery<SearchForTaskQueryResult>, ISearchServiceQuery
    {
        public SearchForTaskQuery(string queryText, IEnumerable<SearchFilter> filters, string indexName)
        {
