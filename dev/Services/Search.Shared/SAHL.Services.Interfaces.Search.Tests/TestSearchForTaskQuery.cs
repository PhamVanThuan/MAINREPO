...
{
    [TestFixture]
    public class TestSearchForTaskQuery
    {
        [Test]
        public void Constructor()
        {
            ...
            //---------------Assert Precondition----------------
            //---------------Execute Test ----------------------
            var query = new SearchForTaskQuery("test", searchFilters, "test");
            //---------------Test Result -----------------------
        ...
        public void Constructor_ShouldSetProperties()
        {
            ...
            //---------------Assert Precondition----------------
            //---------------Execute Test ----------------------
            var query = new SearchForTaskQuery(queryText, searchFilters, indexName);
            //---------------Test Result -----------------------
