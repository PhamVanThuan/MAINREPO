...
{
    public class CreateApplicationPendingNTULegacyEventQueryHandler : IServiceQueryHandler<CreateApplicationPendingNTULegacyEventQuery>
    {
        private ILegacyEventDataService legacyEventDataService;
        
        public CreateApplicationPendingNTULegacyEventQueryHandler(ILegacyEventDataService legacyEventDataService)
        {
            this.legacyEventDataService = legacyEventDataService;
        }

        public ISystemMessageCollection HandleQuery(CreateApplicationPendingNTULegacyEventQuery query)
        {
            ...
            query.Result = new ServiceQueryResult<ApplicationNTUPendedLegacyEvent>(
                new List<ApplicationNTUPendedLegacyEvent>() {
                    new ApplicationNTUPendedLegacyEvent(CombGuid.Instance.Generate(),query.Date, query.ADUserKey, query.ADUserName, 
