...
{
    public class when_told_to_create_legacy_event_from_composite_with_invalid_result : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            serviceQueryRouter.WhenToldTo(x => x.HandleQuery(Param.IsAny<object>())).Return(messages);
        };
        ...
        {
            messages.AllMessages.Contains<ISystemMessage>(new SystemMessage("Could not get legacy event query result", SystemMessageSeverityEnum.Warning));
        };
    }
}