...
namespace SAHL.Services.LegacyEventGenerator.Specs.QueryHandlerSpecs.CreateRegistrationsLodgeDocumentsLegacyEventQueryHandlerSpecs
{
    public class when_told_to_handle_lodge_documents_query : WithFakes
    {
        private static ISystemMessageCollection messages;
        private static CreateRegistrationsLodgeDocumentsLegacyEventQuery query;
        private static CreateRegistrationsLodgeDocumentsLegacyEventQueryHandler handler;
        ...
        private Establish context = () =>
        {
            ...
            handler = new CreateRegistrationsLodgeDocumentsLegacyEventQueryHandler(legacyEventDataService);

            applicationKey = 144;
            query = new CreateRegistrationsLodgeDocumentsLegacyEventQuery();
        ...
        private It should_return_an_AppProgressDisbursedLegacyEvent = () =>
        {
            ...
            fullName.ShouldEqual(typeof(RegistrationsLodgeDocumentsLegacyEvent).FullName);
        };
