...
namespace SAHL.Services.LegacyEventGenerator.Specs.QueryHandlerSpecs.CreateAppProgressDisbursedLegacyEventQueryHandlerSpecs
{
    public class when_told_to_handle_disbursed_query : WithFakes
    {
        private static ISystemMessageCollection messages;
        private static CreateAppProgressDisbursedLegacyEventQuery query;
        private static CreateAppProgressDisbursedLegacyEventQueryHandler handler;
        ...
        private Establish context = () =>
        {
            ...
            handler = new CreateAppProgressDisbursedLegacyEventQueryHandler(legacyEventDataService);

            applicationKey = 144;
            query = new CreateAppProgressDisbursedLegacyEventQuery();
        ...
        private It should_return_an_AppProgressDisbursedLegacyEvent = () =>
        {
            ...
            fullName.ShouldEqual(typeof(AppProgressDisbursedLegacyEvent).FullName);
