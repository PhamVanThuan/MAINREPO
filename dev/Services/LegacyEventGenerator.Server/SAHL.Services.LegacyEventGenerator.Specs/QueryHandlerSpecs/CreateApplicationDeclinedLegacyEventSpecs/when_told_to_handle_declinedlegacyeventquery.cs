...
namespace SAHL.Services.LegacyEventGenerator.Specs.QueryHandlerSpecs.CreateApplicationDeclinedLegacyEventQueryHandlerSpecs
{
    public class when_told_to_handle_declinedlegacyeventquery : WithFakes
    {
        private static ISystemMessageCollection messages;
        private static CreateApplicationDeclinedLegacyEventQuery query;
        private static CreateApplicationDeclinedLegacyEventQueryHandler handler;
        ...
        private Establish context = () =>
        {
            ...
            handler = new CreateApplicationDeclinedLegacyEventQueryHandler(legacyEventDataService);
