...
namespace SAHL.Services.LegacyEventGenerator.Specs.QueryHandlerSpecs.CreateAppProgressRegistrationStartedLegacyEventQueryHandlerSpecs
{
    public class when_told_to_handle_registration_started_query : WithFakes
    {
        private static ISystemMessageCollection messages;
        private static CreateAppProgressRegistrationStartedLegacyEventQuery query;
        private static CreateAppProgressRegistrationStartedLegacyEventQueryHandler handler;
        ...
        private Establish context = () =>
        {
            ...
            handler = new CreateAppProgressRegistrationStartedLegacyEventQueryHandler(legacyEventDataService);

            applicationKey = 144;
            query = new CreateAppProgressRegistrationStartedLegacyEventQuery();
        ...
        private It should_return_an_AppProgressDisbursedLegacyEvent = () =>
        {
            ...
            fullName.ShouldEqual(typeof(AppProgressRegistrationStartedLegacyEvent).FullName);
        };
