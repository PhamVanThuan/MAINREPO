...
namespace SAHL.Services.Capitec.QueryStatements
{
    ...
    public class GetSuburbProvinceQueryStatement : IServiceQuerySqlStatement<GetSuburbProvinceQuery, GetSuburbProvinceQueryResult>
    {
        public string GetStatement()
        {
            return @"SELECT sub.Id,sub.SAHLSuburbKey,sub.SuburbName,sub.PostalCode,sub.CityId,CityName + CASE WHEN prov.ProvinceName IS NOT NULL THEN  ' ('+prov.ProvinceName+')' ELSE '' END as CityName, prov.ProvinceName
