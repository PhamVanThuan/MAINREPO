...
{
    public class when_checking_if_an_applicant_answered_yes_to_a_declaration_and_the_answer_is_no : WithFakes
    {
        ...
        {
            declarationType = new DeclarationTypeEnumDataModel(Enumerations.DeclarationTypeEnums.No.ToString(), true);
