...
{
    public class when_creating_a_capitec_app_given_switch_and_commission_applicant : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            applicantStubs.GrossMonthlyIncome = 4000;
            applicantStubs.ThreeMonthAverageCommission = 10000;
        ...
        private Because of = () =>
        {
            capitecApplication = capitecApplicationRepository.CreateCapitecApplicationFromSwitchLoanApplication(applicationNumber, applicationStatusEnum, switchLoanApplication, messages, applicationId);
        };
        ...
        {
            capitecApplication.Applicants.FirstOrDefault().EmploymentDetails.Employment.ShouldBeOfExactType(typeof(SAHL.Services.Capitec.Models.Shared.SalariedWithCommissionDetails));
        };
    }
}