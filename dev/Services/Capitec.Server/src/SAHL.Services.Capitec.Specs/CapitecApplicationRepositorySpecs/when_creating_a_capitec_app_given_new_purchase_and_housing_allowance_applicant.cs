...
{
    public class when_creating_a_capitec_app_given_new_purchase_and_housing_allowance_applicant : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            applicantStubs.HousingAllowance = 1500;
        ...
        {
            capitecApplication.Applicants.FirstOrDefault().EmploymentDetails.Employment.ShouldBeOfExactType(typeof(SAHL.Services.Capitec.Models.Shared.SalariedWithHousingAllowanceDetails));
        };
    }
}