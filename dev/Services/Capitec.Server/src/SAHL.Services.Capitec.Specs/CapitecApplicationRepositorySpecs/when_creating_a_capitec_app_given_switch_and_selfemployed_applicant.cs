...
{
    public class when_creating_a_capitec_app_given_switch_and_selfemployed_applicant : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            applicantStubs.SelfEmployedGrossMonthlyIncome = 10000;
        ...
        private Because of = () =>
        {
            capitecApplication = capitecApplicationRepository.CreateCapitecApplicationFromSwitchLoanApplication(applicationNumber, applicationStatusEnum, switchLoanApplication
        ...
        {
            capitecApplication.Applicants.FirstOrDefault().EmploymentDetails.Employment.ShouldBeOfExactType(typeof(SAHL.Services.Capitec.Models.Shared.SelfEmployedDetails));
        };
    }
}