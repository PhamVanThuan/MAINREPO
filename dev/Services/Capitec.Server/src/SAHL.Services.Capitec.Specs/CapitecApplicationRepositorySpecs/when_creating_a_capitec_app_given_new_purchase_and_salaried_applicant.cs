...
{
    public class when_creating_a_capitec_app_given_new_purchase_and_salaried_applicant : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            lookupService.WhenToldTo(x => x.GetSahlKeyByCapitecGuid(Param.IsAny<Guid>())).Return(1);
            applicants = new List<Applicant>();

            applicantStubs.GrossMonthlyIncome = 10000;
            var applicant = applicantStubs.GetApplicant;
            applicant.ITCResponse = XDocument.Parse("<Response></Response>");
        ...
        private It should_add_the_applicants_ITC_from_capitec = () =>
        {
            capitecApplication.Applicants.First().ITC.ShouldNotBeNull();
        };
    }
}