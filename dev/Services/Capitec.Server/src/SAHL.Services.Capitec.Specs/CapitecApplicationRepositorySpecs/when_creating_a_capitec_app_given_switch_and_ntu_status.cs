...
{
    public class when_creating_a_capitec_app_given_switch_and_ntu_status : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            switchLoanApplication = new SwitchLoanApplication(new SwitchLoanDetails(Guid.NewGuid(), Guid.NewGuid(), 0, 0, 0, 0, 0, 0, 240, false)
                , applicants, Guid.NewGuid(), "1184050800000-0700");
