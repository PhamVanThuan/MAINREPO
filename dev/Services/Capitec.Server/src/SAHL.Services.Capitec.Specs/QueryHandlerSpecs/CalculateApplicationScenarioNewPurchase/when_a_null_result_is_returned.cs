...
namespace SAHL.Services.Capitec.Specs.QueryHandlerSpecs.CalculateApplicationScenarioNewPurchase
{
    public class when_a_null_result_is_returned : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            loanDetails = new NewPurchaseLoanDetails(occupancyType, incomeType, Param<decimal>.IsAnything, Param<decimal>.IsAnything, Param<decimal>.IsAnything, Param<decimal>.IsAnything, 240, false);
