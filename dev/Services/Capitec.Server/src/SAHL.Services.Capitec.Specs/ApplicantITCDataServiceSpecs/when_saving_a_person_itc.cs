...
{
    public class when_saving_a_person_itc : WithCoreFakes
    {
        ...
        private Because of = () =>
        {
            dataManager.SavePersonItc(personID, itcID, itcDate);
        };

        private It should_insert_the_person_itc = () =>
        {
            fakeDbFactory.FakedDb.InAppContext().WasToldTo(x => x.Insert(Param<PersonITCDataModel>.Matches(m =>
