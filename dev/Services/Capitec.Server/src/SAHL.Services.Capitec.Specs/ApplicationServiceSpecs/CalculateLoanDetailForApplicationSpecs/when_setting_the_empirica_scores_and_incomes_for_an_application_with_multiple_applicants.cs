...
{
    internal class when_setting_the_empirica_scores_and_incomes_for_an_application_with_multiple_applicants : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            applicants.Last().EmpiricaScore = 580;
        ...
        private It should_set_the_empirica_score_for_the_second_applicant = () =>
        {
            decisionTreeService.WasToldTo(x => x.PerformQuery(Arg.Is<CapitecOriginationCreditPricing_Query>(y => y.SecondIncomeContributorApplicantEmpirica == applicants.Last().EmpiricaScore)));
        };
        ...
        private It should_set_the_income_for_the_second_applicant = () =>
        {
            decisionTreeService.WasToldTo(x => x.PerformQuery(Arg.Is<CapitecOriginationCreditPricing_Query>(
                y => y.SecondIncomeContributorApplicantIncome == (double)applicants.Last().EmploymentDetails.CalculateGrossMonthlyIncome()
            )));
        };
