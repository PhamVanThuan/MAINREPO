...
{
    public class when_the_household_income_type_is_salaried_with_commission : WithFakes
    {
        ...
        {
            employmentType = Guid.Parse(EmploymentTypeEnumDataModel.SALARIED_WITH_COMMISSION);
