...
{
    public class when_the_household_income_type_is_self_employed : WithFakes
    {
        ...
        {
            employmentType = Guid.Parse(EmploymentTypeEnumDataModel.SELF_EMPLOYED);
            dbFactory = new FakeDbFactory();
            lookupService = new LookupManager(dbFactory);
            expectedDecisionTreeType = new Enumerations.SAHomeLoans.HouseholdIncomeType().SelfEmployed;
        };
        ...
        private It should_return_the_self_employed_type_for_the_decision_tree = () =>
        {
