...
{
    public class when_getting_the_SAHL_key_for_a_capitec_guid_and_the_value_does_not_exist : WithFakes
    {
        ...
        private Because of = () =>
        {
            result = lookupService.GetSahlKeyByCapitecGuid(Guid.NewGuid());
        };
