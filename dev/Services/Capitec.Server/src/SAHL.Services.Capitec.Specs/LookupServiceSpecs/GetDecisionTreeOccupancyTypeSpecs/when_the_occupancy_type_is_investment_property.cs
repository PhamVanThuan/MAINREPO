...
{
    public class when_the_occupancy_type_is_investment_property : WithFakes
    {
        ...
        {
            expectedDecisionTreeType = new Enumerations.SAHomeLoans.PropertyOccupancyType().InvestmentProperty;
            occupancyType = Guid.Parse(OccupancyTypeEnumDataModel.INVESTMENT_PROPERTY);
