...
namespace SAHL.Services.Capitec.Specs.GeoManagerSpecs
{
    ...
    public class when_changing_province_details_where_sahlkey_invalid : WithFakes
    {
        ...
        public Establish context = () =>
        {
            ...
            geoDataServices.WhenToldTo(x => x.DoesSAHLProvinceKeyExist(sahlProvinceKey)).Return(true);
