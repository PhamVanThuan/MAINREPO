...
namespace SAHL.Services.Capitec.Specs.GeoManagerSpecs
{
    ...
    public class when_changing_city_details_where_provinceid_invalid : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            geoDataServices.WhenToldTo(x => x.DoesProvinceIdExist(provinceId)).Return(false);
        ...
        private It should_not_change_city_details = () =>
        {
