...
namespace SAHL.Services.Capitec.Specs.SecurityManagerSpecs
{
    ...
    public class when_adding_a_branch : WithFakes
    {
        ...
        private Because of = () =>
        {
            securityManager.AddBranch(branchName, isActive, suburbId, branchCode);
        };
        ...
        private It should_add_branch = () =>
        {
            securityDataServices.WasToldTo(x => x.AddBranch(branchName, isActive, suburbId, branchCode));
        };
    }
}