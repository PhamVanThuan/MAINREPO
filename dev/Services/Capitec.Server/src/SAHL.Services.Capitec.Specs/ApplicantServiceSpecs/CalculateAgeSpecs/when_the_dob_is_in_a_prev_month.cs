...
{
    public class when_the_dob_is_in_a_prev_month : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            birthDate = DateTime.ParseExact("19800509", "yyyyMMdd", CultureInfo.InvariantCulture, DateTimeStyles.None);
