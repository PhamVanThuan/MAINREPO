...
{
    public class when_the_dob_is_in_a_future_month : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            birthDate = DateTime.ParseExact("19800715", "yyyyMMdd", CultureInfo.InvariantCulture, DateTimeStyles.None);
            now = DateTime.ParseExact("20140609", "yyyyMMdd", CultureInfo.InvariantCulture, DateTimeStyles.None);
