...
{
    public class when_handling_query_given_IDNumberList_and_multiple_results : WithFakes
    {
        ...
        static string IDNumberList2;

        Establish context = () =>
        {
            IDNumberList = "8001015000219,8001015000219";
            IDNumberList2 = "8001015000441,8001015000276";
            ...
            List<ApplicationStatusQueryResult> mockresults = new List<ApplicationStatusQueryResult>() 
                        {
                            ...
                            new ApplicationStatusQueryResult()
                            {
                                IdentityNumberList = IDNumberList2
                            },
                        };
        ...
        {
            messages.AllMessages.Count().ShouldBeGreaterThan(0);
        };
    }
}
