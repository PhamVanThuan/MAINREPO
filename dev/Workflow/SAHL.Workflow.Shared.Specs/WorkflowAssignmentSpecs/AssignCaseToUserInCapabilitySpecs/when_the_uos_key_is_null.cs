...
{
    public class when_the_uos_key_is_null : WithFakes
    {
        ...
        private Establish that = () =>
        {
            ...
            genericKey = 2;
            instanceId = 3L;
            userOrganisationStructureKey = null;
        ...
        {
            serviceClient
                .WasToldTo(a => a.PerformCommand(Param<AssignWorkflowCaseCommand>.Matches(b =>
                    b.GenericKeyTypeKey == genericKeyType
                    && b.GenericKey == genericKey
                    && b.InstanceId == instanceId
                    && b.UserOrganisationStructureKey == 0
