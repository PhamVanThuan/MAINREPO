...
{
    public class when_the_query_result_results_first_result_is_null : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            query.Result = new ServiceQueryResult<GetUserCurrentlyAssignedInCapabilityQueryResult>(new GetUserCurrentlyAssignedInCapabilityQueryResult[] { null });
