...
namespace SAHL.Workflow.ThirdPartyInvoice.Specs.ThirdPartyInvoiceWorkflowProcessSpecs
{
    ...
    public class when_rejecting_a_third_party_invoice_with_no_errors : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            returnMessages.AddMessage(new SystemMessage("message", SystemMessageSeverityEnum.Info));
            financeDomainServiceClient.WhenToldTo(x => x.PerformCommand(Param.IsAny<RejectThirdPartyInvoiceCommand>(), Param.IsAny<ServiceRequestMetadata>())).Return(returnMessages);
        };
