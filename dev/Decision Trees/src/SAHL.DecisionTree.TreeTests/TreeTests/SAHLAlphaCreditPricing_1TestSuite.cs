...
{
    public class SAHLAlphaCreditPricing_1TestSuite : ITestSuite
    {
        public IEnumerable<ITestCase> TestCases { get; set; }
    
        public SAHLAlphaCreditPricing_1TestSuite()
        {
            this.TestCases = new List<ITestCase> 
            {
                    ...
                    new List<IScenario> {
                        new Scenario("given a switch application",
                            ...
                            new List<ITestOutput> {
                                ...
                                new TestOutput("Payment to Income as Percent", "to equal", "string", "19.1%"),
 
                                new TestOutput("Payment to Income", "to equal", "float", "0.191")
                            },
                            new List<IOutputMessage> {
                                new OutputMessage("", "should be empty", "Error Messages")
                            },
                    ...
                    new List<IScenario> {
                        new Scenario("given a switch application",
                            ...
                            new List<ITestOutput> {
                                ...
                                new TestOutput("Installment in Rands", "to equal", "string", "2875.21")
                            },
                            new List<IOutputMessage> {
                                new OutputMessage("", "should be empty", "Error Messages")
                            },
                ...
                new TestCase("when an application falls into category 6", 
                    new List<ITestInput> { 
                        ...
                        new TestInput ("Property Occupancy Type", "SAHomeLoans::PropertyOccupancyType", "Enumerations::sAHomeLoans::propertyOccupancyType.OwnerOccupied"),
                        new TestInput ("Household Income Type", "SAHomeLoans::HouseholdIncomeType", "Enumerations::sAHomeLoans::householdIncomeType.Salaried"),
                        new TestInput ("Household Income", "float", "8712"),
                        new TestInput ("Property Purchase Price", "float", "400000"),
                    ...
                    new List<IScenario> {
                        new Scenario("given an application with PTI ratio of 33.0% and a 10% variance on the 30% limit",
                            ...
                            new List<ITestOutput> {
                                ...
                                new TestOutput("Instalment", "to equal", "float", "2875.21")
                            },
                            new List<IOutputMessage> {
                                new OutputMessage("", "should be empty", "Error Messages"),
                                new OutputMessage("Your repayment as a percentage of household income (PTI) would be 33.0% and is greater than or equal to the maximum of 33.0%, which is the maximum per responsible affordability guidelines. In order to reduce your PTI, the loan amount would need to reduce to no more than R299972 or alternatively additional income so that total income is at least R8714.", "should contain", "Warning Messages")
                            },
                            new List<ISubtreeExpectation> {
                        ...
                        new Scenario("given an application with PTI ratio of 32.9% and a 10% variance on the 30% limit",
                            new List<ITestInput> { 
                                new TestInput("Household Income", "float", "8739")
                            },
                            new List<ITestOutput> {
                        ...
                        new Scenario("given an application with PTI ratio of 33.1% and a 10% variance on the 30% limit",
                            new List<ITestInput> { 
                                new TestInput("Household Income", "float", "8686")
                            },
                            new List<ITestOutput> {
                            ...
                            new List<IOutputMessage> {
                                new OutputMessage("", "should be empty", "Error Messages"),
                                new OutputMessage("Your repayment as a percentage of household income (PTI) would be 33.1% and is greater than or equal to the maximum of 33.0%, which is the maximum per responsible affordability guidelines. In order to reduce your PTI, the loan amount would need to reduce to no more than R299077 or alternatively additional income so that total income is at least R8714.", "should contain", "Warning Messages")
                            },
                            new List<ISubtreeExpectation> {
                ...
                new TestCase("when an application falls into category 7", 
                    ...
                    new List<IScenario> {
                        new Scenario("given an application with PTI ratio of 33.0% and a 10% variance on the 30% limit",
                            new List<ITestInput> { 
                                new TestInput("Household Income", "float", "9015")
                            },
                            new List<ITestOutput> {
                            ...
                            new List<IOutputMessage> {
                                new OutputMessage("", "should be empty", "Error Messages"),
                                new OutputMessage("Your repayment as a percentage of household income (PTI) would be 33.0% and is greater than or equal to the maximum of 33.0%, which is the maximum per responsible affordability guidelines. In order to reduce your PTI, the loan amount would need to reduce to no more than R299992 or alternatively additional income so that total income is at least R9016.", "should contain", "Warning Messages")
                            },
                            new List<ISubtreeExpectation> {
                        ...
                        new Scenario("given an application with PTI ratio of 33.1% and a 10% variance on the 30% limit",
                            new List<ITestInput> { 
                                new TestInput("Household Income", "float", "8987")
                            },
                            new List<ITestOutput> {
                            ...
                            new List<IOutputMessage> {
                                new OutputMessage("", "should be empty", "Error Messages"),
                                new OutputMessage("Your repayment as a percentage of household income (PTI) would be 33.1% and is greater than or equal to the maximum of 33.0%, which is the maximum per responsible affordability guidelines. In order to reduce your PTI, the loan amount would need to reduce to no more than R299061 or alternatively additional income so that total income is at least R9016.", "should contain", "Warning Messages")
                            },
                            new List<ISubtreeExpectation> {
                        ...
                        new Scenario("given an application with PTI ratio of 32.9% and a 10% variance on the 30% limit",
                            new List<ITestInput> { 
                                new TestInput("Household Income", "float", "9042")
                            },
                            new List<ITestOutput> {
                        ...
                        new Scenario("given a qualifying salaried application",
                            ...
                            new List<ITestOutput> {
                                ...
                                new TestOutput("Link Rate", "to equal", "float", "0.044")
                            },
                            new List<IOutputMessage> {
                                new OutputMessage("", "should be empty", "Error Messages")
                            },
                ...
                new TestCase("when an application falls into category 8", 
                    ...
                    new List<IScenario> {
                        new Scenario("given an application with PTI ratio of 32.9% and a 10% variance on the 30% limit",
                            new List<ITestInput> { 
                                new TestInput("Household Income", "float", "9288")
                            },
                            new List<ITestOutput> {
                        ...
                        new Scenario("given an application with PTI ratio of 33.00% and a 10% variance on the 30% limit",
                            new List<ITestInput> { 
                                new TestInput("Household Income", "float", "9260")
                            },
                            new List<ITestOutput> {
                            ...
                            new List<IOutputMessage> {
                                new OutputMessage("", "should be empty", "Error Messages"),
                                new OutputMessage("Your repayment as a percentage of household income (PTI) would be 33.0% and is greater than or equal to the maximum of 33.0%, which is the maximum per responsible affordability guidelines. In order to reduce your PTI, the loan amount would need to reduce to no more than R299995 or alternatively additional income so that total income is at least R9261.", "should contain", "Warning Messages")
                            },
                            new List<ISubtreeExpectation> {
                        ...
                        new Scenario("given an application with PTI ratio of 33.1% and a 10% variance on the 30% limit",
                            new List<ITestInput> { 
                                new TestInput("Household Income", "float", "9232")
                            },
                            new List<ITestOutput> {
                            ...
                            new List<IOutputMessage> {
                                new OutputMessage("", "should be empty", "Error Messages"),
                                new OutputMessage("Your repayment as a percentage of household income (PTI) would be 33.1% and is greater than or equal to the maximum of 33.0%, which is the maximum per responsible affordability guidelines. In order to reduce your PTI, the loan amount would need to reduce to no more than R299088 or alternatively additional income so that total income is at least R9261.", "should contain", "Warning Messages")
                            },
                            new List<ISubtreeExpectation> {
                        ...
                        new Scenario("given a qualifying salaried application",
                            ...
                            new List<ITestOutput> {
                                ...
                                new TestOutput("Link Rate", "to equal", "float", "0.048")
                            },
                            new List<IOutputMessage> {
                                new OutputMessage("", "should be empty", "Error Messages")
                            },
                ...
                new TestCase("when an application falls into category 9", 
                    ...
                    new List<IScenario> {
                        new Scenario("given an application with PTI ratio of 32.9% and a 1% variance on the 30% limit",
                            new List<ITestInput> { 
                                new TestInput("Household Income", "float", "12319"),
                                new TestInput("Cash Amount Required", "float", "100000"),
                                new TestInput("Current Mortgage Loan Balance", "float", "290094.900619586"),
                                new TestInput("Estimated Market Value of Property", "float", "400000")
                            },
                        ...
                        new Scenario("given an application with PTI ratio of 33.0% and a 1% variance on the 30% limit",
                            new List<ITestInput> { 
                                new TestInput("Household Income", "float", "12282")
                            },
                            new List<ITestOutput> {
                            ...
                            new List<IOutputMessage> {
                                new OutputMessage("", "should be empty", "Error Messages"),
                                new OutputMessage("Your repayment as a percentage of household income (PTI) would be 33.0% and is greater than or equal to the maximum of 33.0%, which is the maximum per responsible affordability guidelines. In order to reduce your PTI, the loan amount would need to reduce to no more than R390090 or alternatively additional income so that total income is at least R12283.", "should contain", "Warning Messages")
                            },
                            new List<ISubtreeExpectation> {
                        ...
                        new Scenario("given an application with PTI ratio of 33.1% and a 1% variance on the 30% limit",
                            new List<ITestInput> { 
                                new TestInput("Household Income", "float", "12244")
                            },
                            new List<ITestOutput> {
                            ...
                            new List<IOutputMessage> {
                                new OutputMessage("", "should be empty", "Error Messages"),
                                new OutputMessage("Your repayment as a percentage of household income (PTI) would be 33.1% and is greater than or equal to the maximum of 33.0%, which is the maximum per responsible affordability guidelines. In order to reduce your PTI, the loan amount would need to reduce to no more than R388884 or alternatively additional income so that total income is at least R12283.", "should contain", "Warning Messages")
                            },
                            new List<ISubtreeExpectation> {
                        ...
                        new Scenario("given a qualifying salaried application",
                            ...
                            new List<ITestOutput> {
                                ...
                                new TestOutput("Link Rate", "to equal", "float", "0.051")
                            },
                            new List<IOutputMessage> {
                                new OutputMessage("", "should be empty", "Error Messages")
                            },
