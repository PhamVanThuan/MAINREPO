namespace SAHL.DecisionTree.Shared.Globals
{
    public class Enumerations_2
    {
		public class SAHomeLoans
		{
			...
			public class MortgageLoanProductType
			{
				 public string NewVariable { get { return "Globals.Enumerations.sAHomeLoans.mortgageLoanProductType.NewVariable"; } }
				 public string Variable { get { return "Globals.Enumerations.sAHomeLoans.mortgageLoanProductType.Variable"; } }
				 public string Edge { get { return "Globals.Enumerations.sAHomeLoans.mortgageLoanProductType.Edge"; } }
				 public string SuperLo { get { return "Globals.Enumerations.sAHomeLoans.mortgageLoanProductType.SuperLo"; } }
			}
			...
			public MortgageLoanProductType mortgageLoanProductType = new MortgageLoanProductType();
		}
