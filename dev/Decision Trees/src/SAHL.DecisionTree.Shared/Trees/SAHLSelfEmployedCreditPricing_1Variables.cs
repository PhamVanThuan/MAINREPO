...
{
    public class SAHLSelfEmployedCreditPricing_1Variables
    {
        public SAHLSelfEmployedCreditPricing_1Inputs inputs = new SAHLSelfEmployedCreditPricing_1Inputs();
        public SAHLSelfEmployedCreditPricing_1Outputs outputs;

        private dynamic Enumerations;
        public SAHLSelfEmployedCreditPricing_1Variables(dynamic enumerations)
        {
            Enumerations = enumerations;
            outputs  = new SAHLSelfEmployedCreditPricing_1Outputs(Enumerations);
        }

        public class SAHLSelfEmployedCreditPricing_1Inputs
        {
...
public bool CapitaliseFees { get; set; }
        ...
        public class SAHLSelfEmployedCreditPricing_1Outputs
        {
...
public double LinkRate { get; set; }
            ...
            public SAHLSelfEmployedCreditPricing_1Outputs(dynamic enumerations)
            {
                Enumerations = enumerations;
