...
{
    public class SAHLOriginationCreditPricing_1Variables
    {
        public SAHLOriginationCreditPricing_1Inputs inputs = new SAHLOriginationCreditPricing_1Inputs();
        public SAHLOriginationCreditPricing_1Outputs outputs;

        private dynamic Enumerations;
        public SAHLOriginationCreditPricing_1Variables(dynamic enumerations)
        {
            Enumerations = enumerations;
            outputs  = new SAHLOriginationCreditPricing_1Outputs(Enumerations);
        }

        public class SAHLOriginationCreditPricing_1Inputs
        {
...
public bool CapitaliseFees { get; set; }
        ...
        public class SAHLOriginationCreditPricing_1Outputs
        {
...
public double LinkRateAdjustment { get; set; }
            ...
            public SAHLOriginationCreditPricing_1Outputs(dynamic enumerations)
            {
                Enumerations = enumerations;
