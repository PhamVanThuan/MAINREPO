...
{
    public class SAHLSalariedwithDeductionCreditPricing_1Variables
    {
        public SAHLSalariedwithDeductionCreditPricing_1Inputs inputs = new SAHLSalariedwithDeductionCreditPricing_1Inputs();
        public SAHLSalariedwithDeductionCreditPricing_1Outputs outputs;

        private dynamic Enumerations;
        public SAHLSalariedwithDeductionCreditPricing_1Variables(dynamic enumerations)
        {
            Enumerations = enumerations;
            outputs  = new SAHLSalariedwithDeductionCreditPricing_1Outputs(Enumerations);
        }

        public class SAHLSalariedwithDeductionCreditPricing_1Inputs
        {
...
public bool CapitaliseFees { get; set; }
        ...
        public class SAHLSalariedwithDeductionCreditPricing_1Outputs
        {
...
public double LinkRate { get; set; }
            ...
            public SAHLSalariedwithDeductionCreditPricing_1Outputs(dynamic enumerations)
            {
                Enumerations = enumerations;
