...
{
    public class CapitecSelfEmployedCreditPricing_1Variables
    {
        public CapitecSelfEmployedCreditPricing_1Inputs inputs = new CapitecSelfEmployedCreditPricing_1Inputs();
        public CapitecSelfEmployedCreditPricing_1Outputs outputs;

        private dynamic Enumerations;
        public CapitecSelfEmployedCreditPricing_1Variables(dynamic enumerations)
        {
            Enumerations = enumerations;
            outputs  = new CapitecSelfEmployedCreditPricing_1Outputs(Enumerations);
        }

        public class CapitecSelfEmployedCreditPricing_1Inputs
        {
...
public bool CapitaliseFees { get; set; }
        ...
        public class CapitecSelfEmployedCreditPricing_1Outputs
        {
...
public double LinkRate { get; set; }
            ...
            public CapitecSelfEmployedCreditPricing_1Outputs(dynamic enumerations)
            {
                Enumerations = enumerations;
