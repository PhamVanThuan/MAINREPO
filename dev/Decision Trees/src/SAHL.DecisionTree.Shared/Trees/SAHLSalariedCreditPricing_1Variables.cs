...
{
    public class SAHLSalariedCreditPricing_1Variables
    {
        public SAHLSalariedCreditPricing_1Inputs inputs = new SAHLSalariedCreditPricing_1Inputs();
        public SAHLSalariedCreditPricing_1Outputs outputs;

        private dynamic Enumerations;
        public SAHLSalariedCreditPricing_1Variables(dynamic enumerations)
        {
            Enumerations = enumerations;
            outputs  = new SAHLSalariedCreditPricing_1Outputs(Enumerations);
        }

        public class SAHLSalariedCreditPricing_1Inputs
        {
...
public bool CapitaliseFees { get; set; }
        ...
        public class SAHLSalariedCreditPricing_1Outputs
        {
...
public double LinkRate { get; set; }
            ...
            public SAHLSalariedCreditPricing_1Outputs(dynamic enumerations)
            {
                Enumerations = enumerations;
