...
{
    public class CapitecSalariedwithDeductionCreditPricing_1Variables
    {
        public CapitecSalariedwithDeductionCreditPricing_1Inputs inputs = new CapitecSalariedwithDeductionCreditPricing_1Inputs();
        public CapitecSalariedwithDeductionCreditPricing_1Outputs outputs;

        private dynamic Enumerations;
        public CapitecSalariedwithDeductionCreditPricing_1Variables(dynamic enumerations)
        {
            Enumerations = enumerations;
            outputs  = new CapitecSalariedwithDeductionCreditPricing_1Outputs(Enumerations);
        }

        public class CapitecSalariedwithDeductionCreditPricing_1Inputs
        {
...
public bool CapitaliseFees { get; set; }
        ...
        public class CapitecSalariedwithDeductionCreditPricing_1Outputs
        {
...
public double LinkRate { get; set; }
            ...
            public CapitecSalariedwithDeductionCreditPricing_1Outputs(dynamic enumerations)
            {
                Enumerations = enumerations;
