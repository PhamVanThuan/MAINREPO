...
{
    public class SAHLAlphaCreditPricing_1Variables
    {
        public SAHLAlphaCreditPricing_1Inputs inputs = new SAHLAlphaCreditPricing_1Inputs();
        public SAHLAlphaCreditPricing_1Outputs outputs;

        private dynamic Enumerations;
        public SAHLAlphaCreditPricing_1Variables(dynamic enumerations)
        {
            Enumerations = enumerations;
            outputs  = new SAHLAlphaCreditPricing_1Outputs(Enumerations);
        }

        public class SAHLAlphaCreditPricing_1Inputs
        {
...
public bool CapitaliseFees { get; set; }
        ...
        public class SAHLAlphaCreditPricing_1Outputs
        {
...
public double LinkRate { get; set; }
            ...
            public SAHLAlphaCreditPricing_1Outputs(dynamic enumerations)
            {
                Enumerations = enumerations;
