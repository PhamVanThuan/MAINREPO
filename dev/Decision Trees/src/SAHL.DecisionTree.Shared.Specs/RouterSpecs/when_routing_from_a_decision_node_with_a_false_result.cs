...
{
    public class when_routing_from_a_decision_node_with_a_true_result : WithFakes
    {
        ...
        private Because of = () =>
        {
            decisionNode.ExecutionResult = true; 
            nextNode = routingEngine.MoveNext();
        };

        private It should_move_to_the_true_node_after_a_true_decision = () =>
        {
