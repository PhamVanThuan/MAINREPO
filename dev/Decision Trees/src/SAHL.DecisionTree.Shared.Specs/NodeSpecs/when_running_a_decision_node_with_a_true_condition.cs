...
{
    public class when_running_a_decision_node_with_a_true_condition : WithFakes
    {
        ...
        private It should_return_true_after_processing_the_decision = () =>
        {
            result.ShouldEqual(true);           
        };

        private It should_return_true_after_processing_the_decision_and_route_to_the_correct_node = () =>
        {
            //TODO should exist in a router spec
        };
