...
{
    public class when_building_a_url_with_multiple_terms : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            expectedUrl = "http://someserver/solr/clients/select?q=John+Smith&start=0&rows=10&wt=json&defType=edismax";
        };
