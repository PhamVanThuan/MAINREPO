...
{
    public class when_logging_formattederror_with_exception_and_rawlog_throws : WithFakes
    {
        ...
        private Because of = () =>
        {
            exception2 = Catch.Exception(() => logger.LogFormattedErrorWithException(loggerSource, user, method, formattedmessage, exception, parameters, formattingArgs));
        };
