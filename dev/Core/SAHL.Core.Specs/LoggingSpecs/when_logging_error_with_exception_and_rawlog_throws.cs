...
{
    public class when_logging_error_with_exception_and_rawlog_throws : WithFakes
    {
        ...
        private Establish context = () =>
            {
                ...
                rawLogger.WhenToldTo(x => x.LogErrorWithException(loggerSource.LogLevel, loggerSource.Name, loggerAppSource.ApplicationName, user, method, message, exception, parameters))
                    .Throw(new Exception());
        ...
        private Because of = () =>
        {
            exception2 = Catch.Exception(() => logger.LogErrorWithException(loggerSource, user, method, message, exception, parameters));
        };
