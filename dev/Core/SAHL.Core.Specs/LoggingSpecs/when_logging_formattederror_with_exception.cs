...
{
    public class when_logging_formattederror_with_exception : WithFakes
    {
        ...
        private Because of = () =>
        {
            logger.LogFormattedErrorWithException(loggerSource, user, method, formattedmessage, exception, parameters, formattingArgs);
        };
