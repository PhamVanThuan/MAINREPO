...
{
    public class when_logging_formattederror_no_parameters_with_exception : WithFakes
    {
        ...
        private Because of = () =>
        {
            logger.LogFormattedErrorWithException(loggerSource, user, method, formattedmessage, exception, formattingArgs);
        };
