...
{
    public class when_logging_formattedinfo_no_parameters_and_rawlog_throws : WithFakes
    {
        ...
        private Establish context = () =>
            {
                ...
                rawLogger.WhenToldTo(x => x.LogFormattedInfo(loggerSource.LogLevel, loggerSource.Name, loggerAppSource.ApplicationName, user, method, formattedmessage, formattingArgs))
                    .Throw(new Exception());
        ...
        private Because of = () =>
        {
            logger.LogFormattedInfo(loggerSource, user, method, formattedmessage, formattingArgs);
        };

        private It should_call_the_corresponding_rawlogger_method = () =>
        {
            rawLogger.WasToldTo(x => x.LogFormattedInfo(loggerSource.LogLevel, loggerSource.Name, loggerAppSource.ApplicationName, user, method, formattedmessage, formattingArgs));
        };
