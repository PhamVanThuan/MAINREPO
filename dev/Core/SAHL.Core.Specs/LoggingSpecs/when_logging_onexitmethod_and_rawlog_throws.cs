...
{
    public class when_logging_onexitmethod_and_rawlog_throws : WithFakes
    {
        ...
        private Establish context = () =>
            {
                ...
                rawLogger.WhenToldTo(x => x.LogOnExitMethod(loggerSource.LogLevel, loggerSource.Name, loggerAppSource.ApplicationName, user, method, parameters))
                    .Throw(new Exception());
        ...
        private Because of = () =>
        {
            exception = Catch.Exception(() => logger.LogOnExitMethod(loggerSource, user, method, parameters));
        };
