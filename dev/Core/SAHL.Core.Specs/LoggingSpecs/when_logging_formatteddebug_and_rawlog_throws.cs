...
{
    public class when_logging_formatteddebug_and_rawlog_throws : WithFakes
    {
        ...
        private Establish context = () =>
            {
                ...
                rawLogger.WhenToldTo(x => x.LogFormattedDebug(loggerSource.LogLevel, loggerSource.Name, loggerAppSource.ApplicationName, user, method, formattedmessage, parameters, formattingArgs))
                    .Throw(new Exception());
        ...
        private Because of = () =>
        {
            exception = Catch.Exception(() => logger.LogFormattedDebug(loggerSource, user, method, formattedmessage, parameters, formattingArgs));
        };
