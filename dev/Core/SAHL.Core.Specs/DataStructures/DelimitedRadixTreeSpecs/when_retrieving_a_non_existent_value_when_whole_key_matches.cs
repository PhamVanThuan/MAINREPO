...
{
    public class when_retrieving_a_non_existent_value_when_whole_key_matches : WithFakes
    {
        Establish that = () =>
        {
            ...
            second.Children.Add(thirdKey, third);
        ...
        private Because of = () =>
        {
            value = tree.GetValue("first.second.third");
        };
