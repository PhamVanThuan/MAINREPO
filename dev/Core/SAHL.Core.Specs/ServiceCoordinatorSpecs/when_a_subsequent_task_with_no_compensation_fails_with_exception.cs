...
{
    public class when_a_subsequent_task_with_no_compensation_fails_with_exception : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            executor = coordinator.StartSequence(() => { work["1"] = "done"; return SystemMessageCollection.Empty(); },
                ...
                // add the third task with compensation with exception
                Then(() => { work["3"] = "in-progress"; throw new Exception(); },
