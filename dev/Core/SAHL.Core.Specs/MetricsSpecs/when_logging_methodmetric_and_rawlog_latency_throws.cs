...
{
    public class when_logging_methodmetric_and_rawlog_throughput_throws : WithFakes
    {
        ...
        private Establish context = () =>
            {
                ...
                rawMetricsLogger.WhenToldTo(x => x.LogThroughputMetric(loggerSource.Name, loggerAppSource.ApplicationName, user, method, parameters))
                    .Throw(new Exception());
