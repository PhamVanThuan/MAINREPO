...
{
    public class when_logging_latencymetric_and_rawlog_throws : WithFakes
    {
        ...
        private Because of = () =>
        {
            exception = Catch.Exception(() => logger.LogLatencyMetric(loggerSource, user, method, startTime, duration, parameters));
        };
