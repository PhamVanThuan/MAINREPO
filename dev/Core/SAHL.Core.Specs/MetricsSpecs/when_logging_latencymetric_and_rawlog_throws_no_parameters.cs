...
{
    public class when_logging_latencymetric_and_rawlog_throws_no_parameters : WithFakes
    {
        ...
        private Because of = () =>
        {
            exception = Catch.Exception(() => logger.LogLatencyMetric(loggerSource, user, method, startTime, duration));
        };
