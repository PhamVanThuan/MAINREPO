...
{
    public class when_logging_methodmetric_and_rawlog_latency_throws : WithFakes
    {
        ...
        private Establish context = () =>
            {
                ...
                rawMetricsLogger.WhenToldTo(x => x.LogLatencyMetric(loggerSource.Name, loggerAppSource.ApplicationName, user, method, startTime, duration, parameters))
                    .Throw(new Exception());
        ...
        private Because of = () =>
        {
            exception = Catch.Exception(() => logger.LogMethodMetric(loggerSource, user, method, () => { }, parameters));
        };

        private It should_call_the_corresponding_latency_rawlogger_methods = () =>
        {
        ...
        private It should_call_the_corresponding_throughput_rawlogger_methods = () =>
        {
