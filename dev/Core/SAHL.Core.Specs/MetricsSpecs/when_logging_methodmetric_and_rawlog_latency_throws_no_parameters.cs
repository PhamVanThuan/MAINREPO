...
{
    public class when_logging_methodmetric_and_rawlog_latency_throws_no_parameters : WithFakes
    {
        ...
        private Establish context = () =>
            {
                ...
                rawMetricsLogger.WhenToldTo(x => x.LogLatencyMetric(loggerSource.Name, loggerAppSource.ApplicationName, user, method, startTime, duration))
                    .Throw(new Exception());
        ...
        private Because of = () =>
        {
            exception = Catch.Exception(() => logger.LogMethodMetric(loggerSource, user, method, () => { }));
        };

        private It should_call_the_corresponding_rawlogger_methods = () =>
        {
            ...
            rawMetricsLogger.WasToldTo(x => x.LogThroughputMetric(loggerSource.Name, loggerAppSource.ApplicationName, user, method));
        };
