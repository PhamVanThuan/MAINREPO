...
{
    public class when_logging_throughputmetric_and_rawlog_throws_no_parameters : WithFakes
    {
        ...
        private Because of = () =>
        {
            exception = Catch.Exception(() => logger.LogThroughputMetric(loggerSource, user, method));
        };
