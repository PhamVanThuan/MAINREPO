...
{
    public class when_logging_in_with_invalid_password_credentials : WithFakes
    {
        ...
        It should_throw_a_password_does_not_exist_exception = () =>
        {
            exception.ShouldBeOfExactType<PasswordDoesNotMatchException>();
        };
