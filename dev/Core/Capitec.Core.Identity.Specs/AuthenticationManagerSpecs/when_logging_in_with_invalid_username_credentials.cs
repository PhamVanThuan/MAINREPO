...
{
    public class when_logging_in_with_invalid_username_credentials : WithFakes
    {
        ...
        It should_throw_a_username_does_not_exist_exception = () =>
        {
            exception.ShouldBeOfExactType<UsernameDoesNotExistException>();
        };
