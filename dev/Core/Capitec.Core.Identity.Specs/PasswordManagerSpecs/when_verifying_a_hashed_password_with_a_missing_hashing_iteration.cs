...
{
    public class when_verifying_a_hashed_password_with_a_missing_hashing_iteration : WithFakes
    {
        ...
        Establish context = () =>
        {
            ...
            hashedPassword = ".ACD1M0GA90CFyB6H82d1lVhIeD3s4IdUC3XBibekwTI9tRYYvoaBkSXlv0SVq9MFFQ==";
        };
