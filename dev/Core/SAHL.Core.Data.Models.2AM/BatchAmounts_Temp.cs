...
{
    [Serializable]
    public partial class BatchAmounts_TempDataModel :  IDataModel
    {
        public BatchAmounts_TempDataModel(DateTime dateToday, int financialServiceKey, double? installmentAmount, double? fixedDebitOrderAmount, double? hOC, double? proRataHOC, double? regent, double? life, double? other, double? currentBalance, string underCancellation, DateTime? loanOpendate, string badBankDetail)
        {
