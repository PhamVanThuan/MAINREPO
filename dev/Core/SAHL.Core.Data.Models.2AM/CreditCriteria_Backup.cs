...
{
    [Serializable]
    public partial class CreditCriteria_BackupDataModel :  IDataModel
    {
        public CreditCriteria_BackupDataModel(int creditCriteriaKey, int creditMatrixKey, int marginKey, int categoryKey, int employmentTypeKey, int mortgageLoanPurposeKey, double? minLoanAmount, double? maxLoanAmount, double? minPropertyValue, double? maxPropertyValue, double? lTV, double? pTI, double? minIncomeAmount, bool? exceptionCriteria)
        {
