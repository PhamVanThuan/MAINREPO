...
{
    public class when_accessing_latency_for_last_hour : WithFakes
    {
        ...
        private Because of = () =>
        {
            metrics = commandServiceRequestMetrics.CommandLatencyForLastHour;
        };

        private It should_contain_only_the_daily_metric = () =>
        {
            metrics.First().Key.ShouldEqual(FakeMetricsFactory.hourlyMetricDescription);
        };
