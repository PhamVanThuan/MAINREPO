...
{
    public class when_authorising_a_command_with_required_roles_for_a_user_without_the_roles : WithFakes
    {
        ...
        private Establish context = () =>
        {
            ...
            currentUser = new GenericPrincipal(new AuthenticatedIdentity(), new string[] { "him", "her" });
        ...
        private It should_not_authorise_the_command = () =>
        {
            authToken.IsAuthorised().ShouldBeFalse();
        };
    }
}