...
namespace SAHL.Core.Web.Specs.QueryHttpHandlerBaseControllerSpecs
{
    ...
    public class when_order_by_is_set_for_valid_query : WithFakes
    {
        ...
        private static string orderBy = "test";
        private static string direction = "Ascending";
        ...
        Because of = async () =>
        {
            result = await queryController.PerformHttpQuery(pageSizeValue, currentPageValue, filterOnValue, filterValue, orderBy, direction);
        };
        ...
        It should_order_by_on_queryParameterManager = () =>
        {
            queryParameterManager.WasToldTo(y => y.SetParameter<SortQueryParameter>(Param<Action<SortQueryParameter>>.IsAnything));
        };
