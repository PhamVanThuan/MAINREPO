...
namespace SAHL.Core.Web.Specs.QueryHttpHandlerBaseControllerSpecs
{
    ...
    public class when_json_activator_throws_error : WithFakes
    {
        ...
        Establish context = () =>
        {
            ...
            jsonActivator.WhenToldTo(x => x.DeserializeQuery(contentString)).Throw(new Exception());
        ...
        It should_not_authorise_query = () =>
        {
            commandAuthoriser.WasNotToldTo(x => x.AuthoriseCommand(query));
        };
