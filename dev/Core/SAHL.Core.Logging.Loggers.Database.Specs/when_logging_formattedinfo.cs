...
{
    public class when_logging_formattedinfo : WithFakes
    {
        ...
        private Because of = () =>
        {
            databaseLogger.LogFormattedInfo(logLevel, source, application, user, method, formattedmessage, parameters, formattingArgs);
        };
